...
void CreateCharacters()
{
	...
	globalCharacters = n; //eddy. если лодочник выведен из конкурса, то и инкремент не нужен. иначе болтаетс€ левый нпс
	MAX_CHARACTERS = globalCharacters;
	
    trace("¬—≈√ќ Ќѕ— ¬ »√–≈ (статиков) = " + MAX_CHARACTERS);
	...
	for(n=0; n<TOTAL_CHARACTERS; n++) // 1
	{
		...
		if (rCharacter.model.animation == "")
        {
			...
			if(rCharacter.sex == "Orc")
			{
				rCharacter.model.animation = "Orc";
				rCharacter.model.height = 1.8;
			}

			if(rCharacter.sex == "VaterSkeleton")
			{
				rCharacter.model.animation = "Zombie";
				rCharacter.model.height = 1.8;
			}

			if(rCharacter.sex == "Zombie")
			{
				rCharacter.model.animation = "Zombie";
				rCharacter.model.height = 1.8;
			}
	...
	// boal -->
	initStartState2Character(pchar); // заполнение вс€ких инитов
	...
	NullCharacter.SalayPayMonth = STARTGAME_MONTH; //мес€ц когда «ѕ уже плотили
    ...
    NullCharacter.GenQuestFort.Roseau.how        = 3;
    NullCharacter.GenQuestFort.Roseau.howSolder  = 3;
    NullCharacter.GenQuestFort.Roseau.next0  = "Roseau_town";
    NullCharacter.GenQuestFort.Roseau.next1  = "Roseau_townhall";
    NullCharacter.GenQuestFort.Roseau.next2  = "Roseau_ExitTown";

    NullCharacter.GenQuestFort.VillaAlegria.how        = 3;
    NullCharacter.GenQuestFort.VillaAlegria.howSolder  = 3;
	NullCharacter.GenQuestFort.VillaAlegria.next0  = "VillaAlegria_town";
    NullCharacter.GenQuestFort.VillaAlegria.next1  = "VillaAlegria_townhall";
    NullCharacter.GenQuestFort.VillaAlegria.next2  = "VillaAlegria_ExitTown";

NullCharacter.GenQuestFort.PortAntonio.how        = 4;
    NullCharacter.GenQuestFort.PortAntonio.howSolder  = 4;
	NullCharacter.GenQuestFort.PortAntonio.next3  = "PortAntonio_Rudnik";
	NullCharacter.GenQuestFort.PortAntonio.next0  = "PortAntonio_town";
    NullCharacter.GenQuestFort.PortAntonio.next1  = "PortAntonio_townhall";
    NullCharacter.GenQuestFort.PortAntonio.next2  = "PortAntonio_ExitTown";


    NullCharacter.GenQuestFort.Vestpunt.how        = 3;
    NullCharacter.GenQuestFort.Vestpunt.howSolder  = 3;
	NullCharacter.GenQuestFort.Vestpunt.next0  = "Vestpunt_town";
    NullCharacter.GenQuestFort.Vestpunt.next1  = "Vestpunt_townhall";
    NullCharacter.GenQuestFort.Vestpunt.next2  = "Vestpunt_ExitTown";

	NullCharacter.GenQuestFort.LeKe.how        = 3;
    NullCharacter.GenQuestFort.LeKe.howSolder  = 3;
    NullCharacter.GenQuestFort.LeKe.next0  = "LeKe_town";
    NullCharacter.GenQuestFort.LeKe.next1  = "LeKe_townhall";
    NullCharacter.GenQuestFort.LeKe.next2  = "LeKe_ExitTown";

    NullCharacter.GenQuestFort.SantLous.how        = 3;
    NullCharacter.GenQuestFort.SantLous.howSolder  = 3;
	NullCharacter.GenQuestFort.SantLous.next0  = "SantLous_town";
    NullCharacter.GenQuestFort.SantLous.next1  = "SantLous_townhall";
    NullCharacter.GenQuestFort.SantLous.next2  = "SantLous_ExitTown";
