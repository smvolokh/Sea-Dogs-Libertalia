...
{ 
	...
	Address_Form.Fra.Title1 = "Флибустьер";
	Address_Form.Eng.Title1 = "Приватир";
	Address_Form.Hol.Title1 = "Капер";
...
string NationKingsCrown(ref Character)
{
    switch(sti(Character.nation))
	{
		...
		break;
		case HOLLAND:
			return "Республике Соединённых Провинций";
		break;
		case PIRATE:
...
string NationKingsName(ref NPChar)
{
    switch(sti(NPChar.nation))
	{
		...
		break;
		case HOLLAND:
			return "Республики Соединённых Провинций";
		break;
		case PIRATE:
...
string GetPortByCityName(string city) // имена портов по городов по аттрибуту char.city
{
    switch(city)
	{
		...
		break;
		case "Providence":
            return "SanAndres_town";
		break;
		case "Roseau":
            return "Roseau_town";
		break;
		case "VillaAlegria":
            return "VillaAlegria_town";
		break;
		case "Vespunt":
            return "Vestpunt_Port";
		break;
		case "SantLous":
            return "SantLous_Port";
		break;
		case "PortAntonio":
            return "PortAntonio_town";
		break;
		case "LeKe":
            return "LeKe_town";
		break;
...
string GetIslandByArealName(string areal)
{
	...
	if(areal == "PortoBello" || areal == "Panama" || areal == "Cartahena" || 
		...
		areal == "Beliz" || areal == "Tenotchitlan" || areal == "Tenotchitlan_1")
	{
		sAreal = "Mein";
	}
	return sAreal;
