...
void StoreInit()
{
	...
	// PortAntonio (Jamaica)
	Stores[PortAntonio_STORE].Colony	= "PortAntonio";
	Stores[PortAntonio_STORE].group	= "PortAntonio";
	Stores[PortAntonio_STORE].StoreSize = "medium";
	...
	//LeKe
	Stores[LeKe_STORE].Colony	= "LeKe";
	Stores[LeKe_STORE].group	= "LeKe";
	Stores[LeKe_STORE].StoreSize = "medium";
	...
	//Roseau
	Stores[Roseau_STORE].Colony	= "Roseau";
	Stores[Roseau_STORE].group	= "Roseau";
	Stores[Roseau_STORE].StoreSize = "small";

	//VillaAlegria
	Stores[VillaAlegria_STORE].Colony	= "VillaAlegria";
	Stores[VillaAlegria_STORE].group	 = "VillaAlegria";
	Stores[VillaAlegria_STORE].StoreSize = "medium";

	//Vestpunt
	Stores[Vestpunt_STORE].Colony	= "Vestpunt";
	Stores[Vestpunt_STORE].group	= "Vestpunt";
	Stores[Vestpunt_STORE].StoreSize = "medium";

	// SantLous(Guadeloupe)
	Stores[SantLous_STORE].Colony	= "SantLous";
	Stores[SantLous_STORE].group	= "SantLous";
	Stores[SantLous_STORE].StoreSize = "small";
