...
void LAi_NPC_Equip(ref chr, int rank, bool isWeapons, bool isGun)
{
	...
	if(isGun)
	{
		...
		if(rand(100) < MOD_SKILL_ENEMY_RATE * sti(chr.rank) * 8)
		{
			int iRnd = rand(1);
			if(sti(chr.rank) > 6) iRnd = rand(2) + 2;
			if(sti(chr.rank) > 13) iRnd = rand(4) + 5;
			if(sti(chr.rank) > 20) iRnd = rand(9) + 4;
			...
			switch(iRnd)
			{
				case 0:
					if(rand(100) < 50)
					{
						GiveItem2Character(chr, "pistol_01");
						EquipCharacterByItem(chr, "pistol_01");
						sBullet = "bullet";
					}	
				break;
				...
				case 3:
					if(rand(100) < 60)
					{
						GiveItem2Character(chr, "pistol_02");
						EquipCharacterByItem(chr, "pistol_02");
						sBullet = "bullet";
					}	
				break;
				...
				case 4:
					if(rand(100) < 65)
					{
						GiveItem2Character(chr, "pistol_03");
						EquipCharacterByItem(chr, "pistol_03");
						sBullet = "grapeshot";
					}	
				break;
				...
				case 5:
					if(rand(100) < 70)
					{
						GiveItem2Character(chr, "pistol11");
						EquipCharacterByItem(chr, "pistol11");				
						sBullet = "bullet";
					}	
				break;
				...
				case 6:
					if(rand(100) < 70)
					{
						GiveItem2Character(chr, "pistol_08");
						EquipCharacterByItem(chr, "pistol_08");				
						sBullet = "grapeshot";
					}	
				break;
				...
				case 8:
					if(rand(100) < 75)
					{
						GiveItem2Character(chr, "pistol_06");
						EquipCharacterByItem(chr, "pistol_06");				
						sBullet = "bullet";
					}	
				break;
				...
				case 10:
					if(rand(100) < 80)
					{
						GiveItem2Character(chr, "pistol02");
						EquipCharacterByItem(chr, "pistol02");
						sBullet = "grapeshot";
					}	
				break;
				...
				case 12:
					if(rand(100) < 90)
					{
						GiveItem2Character(chr, "pistol_04");
						EquipCharacterByItem(chr, "pistol_04");
						sBullet = "bullet";
					}	
				break;
...
void LAi_NPC_MushketerEquip(ref chr)
{
	...
	else
	{
		if(CheckAttribute(chr, "model"))
		{
			...
			if(HasSubStr(chr.model, "mush_fra_")) 
			{
				if(rand(1) == 0) sMush = "mushket1";
				else			 sMush = "mushket_01";
			}	
			if(HasSubStr(chr.model, "shturm_mush_fra_")) 
			{
				if(rand(1) == 0) sMush = "mushket1";
				else			 sMush = "mushket1";
			}	
			if(HasSubStr(chr.model, "guard_mush_fra_")) 
			{
				if(rand(1) == 0) sMush = "mushket1";
				else			 sMush = "mushket2";
			}	
			if(HasSubStr(chr.model, "mush_spa_")) 
			{
				if(rand(1) == 0) sMush = "mushket3";
				else			 sMush = "mushket_01";
			}	
			if(HasSubStr(chr.model, "shturm_mush_spa_")) 
			{
				if(rand(1) == 0) sMush = "mushket3";
				else			 sMush = "mushket3";
			}	
			if(HasSubStr(chr.model, "guard_mush_spa_")) 
			{
				if(rand(1) == 0) sMush = "mushket3";
				else			 sMush = "mushket2";
			}	
			if(HasSubStr(chr.model, "mush_eng_")) 
			{
				if(rand(1) == 0) sMush = "mushket2";
				else			 sMush = "mushket_01";
			}
			if(HasSubStr(chr.model, "shturm_mush_eng_")) 
			{
				if(rand(1) == 0) sMush = "mushket2";
				else			 sMush = "mushket2";
			}
			if(HasSubStr(chr.model, "guard_mush_eng_")) 
			{
				if(rand(1) == 0) sMush = "mushket2";
				else			 sMush = "Mushket_8";
			}
			if(HasSubStr(chr.model, "mush_hol_")) 
			{
				if(rand(1) == 0) sMush = "Mushket_8";
				else			 sMush = "mushket_01";
			}
			if(HasSubStr(chr.model, "shturm_mush_hol_")) 
			{
				if(rand(1) == 0) sMush = "Mushket_8";
				else			 sMush = "Mushket_8";
			}
			if(HasSubStr(chr.model, "guard_mush_hol_")) 
			{
				if(rand(1) == 0) sMush = "Mushket_8";
				else			 sMush = "mushket2";
			}
			if(HasSubStr(chr.model, "mush_ctz_")) 
			{
				if(rand(1) == 0) sMush = "Mushket_9";
				else			 sMush = "mushket1";
			}
...
if(HasSubStr(chr.model, "Bandit_mush_")) sMush = "grape_mushket";
		}
	}
...
string LAi_NPC_EquipBladeSelection(ref chr)
{
	...
	if(CheckAttribute(chr, "PhantomType"))
	{
		...
		if(blade == "") SelectGeneratedItem(TGT_NATIVE, B_ORDINARY, "");
			break;
			case "marginal" 	:
		...
		if(blade == "") SelectGeneratedItem(TGT_OFFICER, B_EXCELLENT, "");
			break;
			case "itza" 		:
				blade = SelectGeneratedItem(TGT_NATIVE, "", "");
		if(blade == "") SelectGeneratedItem(TGT_NATIVE, B_GOOD, "");
			break;
			case "quest" 		:
				blade = SelectGeneratedItem(TGT_SOLDIER, "", "");
		if(blade == "") SelectGeneratedItem(TGT_SOLDIER, B_ORDINARY, "");
			break;
			case "pofficer" 	:
				blade = SelectGeneratedItem(TGT_MARGINAL, "", "");
		if(blade == "") SelectGeneratedItem(TGT_MARGINAL, B_ORDINARY, "");
			break;
			case "officer" 		:
				if(rand(1) == 0 ) blade = SelectGeneratedItem(TGT_OFFICER, "", "");
...
void LAi_NPC_EquipPerk(ref chr, string kind)
{
	...
	NumPerks[PERK_TEMPLATE_MELEE]       = 13;
	...
	if (PerkTemplates[PERK_TEMPLATE_MELEE] >= 1)
	{
		...
		if (PerkTemplates[PERK_TEMPLATE_MELEE] >= 2)
		{
			...
			{
			chr.perks.list.ProfessionalDefense = "1";
			}
...
void LAi_NPC_Mining(ref chr)
{
	string sPick 	= "topor_015";
	GiveItem2Character(chr, sPick);
}