...
int LocationInitBoarding(int n)
{
	...
	Locations[n].image = "loading\FortShturm_" + rand(5) + ".tga";
	...
	//Info
	Locations[n].image = "loading\fort_eng_" + rand(3) + ".tga";
	...
	//Info
	Locations[n].image = "loading\fort_hol_" + rand(3) + ".tga";
	...
	//Info
	Locations[n].image = "loading\fort_fra_" + rand(3) + ".tga";
	...
	//Info
	Locations[n].image = "loading\fort_spa_" + rand(3) + ".tga";
	...
	locations[n].reload.l3.go = "SanAndres_ammo";
	locations[n].reload.l3.emerge = "reload3";
	locations[n].reload.l3.autoreload = "0";

	locations[n].reload.l4.name = "reload3";
	locations[n].reload.l4.go = "SanAndres_fort";
	locations[n].reload.l4.emerge = "reload2";
	locations[n].reload.l4.autoreload = "0";
	locations[n].reload.l4.label = "PortPax Fort";

	Locations[n].reload.l5.name = "reload8";
	Locations[n].reload.l5.go = "SanAndres_ammo";
	Locations[n].reload.l5.emerge = "reload1";
	Locations[n].reload.l5.autoreload = "0";

	locations[n].reload.l6.name = "reload7";
	locations[n].reload.l6.go = "SanAndres_ammo";
	...
	//Models
	//Always
	Locations[n].filespath.models = "locations\Gothic\ammo2";
	locations[n].models.always.ammo2 = "ammo2";
	locations[n].models.always.locators = "ammo2_locators";
	Locations[n].models.always.light = "ammo2_light";	
	//Day
	locations[n].models.day.charactersPatch = "ammo2_path";
	Locations[n].models.day.ammo2FonarsDay = "ammo2_fd";
	//Night
	locations[n].models.night.charactersPatch = "ammo2_path";
	Locations[n].models.night.ammo2BigNight= "ammo2_fn";	
	//Environment
	locations[n].environment.weather = "true";
	Locations[n].lockWeather = "Inside";
	Locations[n].QuestlockWeather = "23 Hour";
	...
	locations[n].image = "loading\Capdeck_" + rand(9) + ".tga";
	//Sound
	...
	//абордажная каюта ЧЖ
  	Locations[n].id = "CabineHG"; 
                   locations[n].id.label = "cabine2";
	locations[n].filespath.models = "locations\inside\cabin03";
	locations[n].image = "loading\Capdeck_" + rand(9) + ".tga";
	//Sound
	locations[n].type = "boarding_cabine";
	//Models
	...
	locations[n].models.always.l1.level = 65538;
	locations[n].models.always.locators = "cabin03_locators";
	locations[n].models.always.window = "cabin03_fonar";
	Locations[n].models.always.window.tech = "LocationWindows";
	locations[n].models.always.window.level = 65539;
	...
	Locations[n].id.label = "cabine";
Locations[n].filespath.models = "locations\inside\nc_cabin1";
    locations[n].image = "loading\Capdeck_" + rand(9) + ".tga";
	//Sound
	locations[n].type = "boarding_cabine";
	...
	//Старая Малая каюта
	Locations[n].id = "Old_Cabin_Small";
	Locations[n].id.label = "cabine";
	Locations[n].filespath.models = "locations\inside\capsm";
    locations[n].image = "loading\Capdeck_" + rand(9) + ".tga";
	//Sound
	locations[n].type = "boarding_cabine";
	//Models
	...
	//Старая Средняя каюта
	Locations[n].id = "Old_Cabin_Medium";
	Locations[n].id.label = "cabine";
	Locations[n].filespath.models = "locations\inside\capmd";
    locations[n].image = "loading\Capdeck_" + rand(9) + ".tga";
	//Sound
	locations[n].type = "boarding_cabine";
	//Models
	...
	//Старая Средняя каюта
	Locations[n].id = "New_Cabin_Medium";
	Locations[n].id.label = "cabine";
	Locations[n].filespath.models = "locations\inside\capmd";
    locations[n].image = "loading\Capdeck_" + rand(9) + ".tga";
	//Sound
	...
	//абордажная каюта Зебры
  	Locations[n].id = "CabineHZ"; 
                   locations[n].id.label = "cabine2";
	locations[n].image = "loading\Capdeck_" + rand(9) + ".tga";
	//Sound
	locations[n].type = "boarding_cabine";
	//Models
	//Always
	locations[n].filespath.models = "locations\inside\cabin04";
	Locations[n].models.always.locators = "cabin04b_locators";
	Locations[n].models.always.l1 = "cabin04b";
	//Day
	Locations[n].models.day.window = "cabin04b_wd";
	Locations[n].models.day.window.tech = "LocationWindows";
	Locations[n].models.day.window.level = 65538;
	Locations[n].models.day.charactersPatch = "cabin04b_pd";
	//Night
	Locations[n].models.night.window = "cabin04b_wn";
	Locations[n].models.night.window.tech = "LocationWindows";
	Locations[n].models.night.window.level = 65539;
	Locations[n].models.night.charactersPatch = "cabin04b_pn";
	Locations[n].models.night.fonar = "cabin04b_fn";
	//Environment
	locations[n].environment.weather = "true";
	locations[n].environment.sea = "true";
	...
	Locations[n].locators_radius.box.box5 = 0.75;
	...
	n = n + 1;
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// КАЮТА НА ЧЕРНОЙ ЖЕМЧУЖИНЕ	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  	Locations[n].id = "My_CabineHG"; 
                   locations[n].id.label = "cabine2";
	locations[n].filespath.models = "locations\inside\cabin03";
	locations[n].image = "loading\Capdeck_" + rand(9) + ".tga";
	//Sound
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//Always
	locations[n].filespath.models = "locations\inside\cabin04";
	Locations[n].models.always.locators = "cabin04_locators";
	Locations[n].models.always.l1 = "cabin04";
	//Day
	Locations[n].models.day.window = "cabin04_wd";
	Locations[n].models.day.window.tech = "LocationWindows";
	Locations[n].models.day.window.level = 65538;
	Locations[n].models.day.charactersPatch = "cabin04_pd";
	Locations[n].models.day.fonar = "cabin04_fd";
	//Night
	Locations[n].models.night.window = "cabin04_wn";
	Locations[n].models.night.window.tech = "LocationWindows";
	Locations[n].models.night.window.level = 65539;
	Locations[n].models.night.charactersPatch = "cabin04_pn";
	Locations[n].models.night.fonar = "cabin04_fn";
	//Environment
	locations[n].environment.weather = "true";
	locations[n].environment.sea = "true";
	...
	locations[n].box2 = Items_MakeTime(0, 1, 1, 2013);
	locations[n].box3 = Items_MakeTime(0, 1, 1, 2013);
	locations[n].box4 = Items_MakeTime(0, 1, 1, 2017);
	locations[n].box5 = Items_MakeTime(0, 1, 1, 2017);
...
//Старая Малая Каюта
Locations[n].id = "My_Old_Cabin_Small";
	Locations[n].id.label = "cabine";
	Locations[n].filespath.models = "locations\inside\capsm";
    locations[n].image = "loading\Capdeck_" + rand(9) + ".tga";
	//Sound
	...
	//Старая Средняя Каюта
	Locations[n].id = "My_Old_Cabin_Medium";
	Locations[n].id.label = "cabine";
	Locations[n].filespath.models = "locations\inside\capmd";
    locations[n].image = "loading\Capdeck_" + rand(9) + ".tga";
	//Sound
	...
	//Старая Средняя Каюта
	Locations[n].id = "My_New_Cabin_Medium";
	Locations[n].id.label = "cabine";
	Locations[n].filespath.models = "locations\inside\capmd";
    locations[n].image = "loading\Capdeck_" + rand(9) + ".tga";
	//Sound
	...
	//Sound
	Locations[n].type = "Cannon";
	locations[n].LoadCabinType.Type = "Cannon";
	//Models
	//Always
	...
	Locations[n].image = "loading\Hold_" + rand(3) + ".tga";
	//Sound
	Locations[n].type = "Hold";
	locations[n].LoadCabinType.Type = "Hold";
	//Models
	//Always
	...
	//Info
	Locations[n].image = "loading\Quarter_" + rand(3) + ".tga";
	//Sound
	Locations[n].type = "residence";
	Locations[n].boarding = "true";
	...
	Locations[n].image = "loading\Boarding_A" + rand(5) + ".tga";
	...
	Locations[n].image = "loading\Boarding_B" + rand(4) + ".tga";
	//Sound
	Locations[n].type = "deck_fight";
	...
	// Каюта для шара!
    	Locations[n].id = "BalloonCabine";   // каюта большая
    	locations[n].id.label = "cabine";
	locations[n].filespath.models = "Ships\Balloon1";
	locations[n].image = "loading\capdeck.tga";
	//Sound
	locations[n].type = "boarding_cabine";
	//Models
	//Always
	locations[n].models.always.l1 = "Balloon1";
	locations[n].models.always.l1.level = 65538;
	locations[n].models.always.locators = "Balloon1_locators";

	//Day
	locations[n].models.day.charactersPatch = "Balloon1_path";

	//Night
	locations[n].models.night.charactersPatch = "Balloon1_path";
	...
	locations[n].environment.weather.rain = false;
	Locations[n].boarding.Loc.Hero = "loc0";
    	Locations[n].boarding.Loc.Capt = "aloc0";
	n = n + 1;
	...
	// Каюта для шара!
    	Locations[n].id = "My_BalloonCabine";   // каюта большая
    	locations[n].id.label = "cabine";
	locations[n].filespath.models = "Ships\Balloon1";
	locations[n].image = "loading\capdeck.tga";
	//Sound
