...
int LocationInitSantaCatalina(int n)
{
	...
	locations[n].reload.l13.go = "SantaCatalina_house";
	locations[n].reload.l13.emerge = "reload1";
	locations[n].reload.l13.autoreload = "0";
	locations[n].reload.l13.label = "House";

	locations[n].reload.l14.name = "houseF1";
	locations[n].reload.l14.go = "SantaCatalina_PirateHouse";
	locations[n].reload.l14.emerge = "reload1";
	locations[n].reload.l14.autoreload = "0";
	locations[n].reload.l14.label = "PirateHouse";
	...
	locations[n].reload.l21.name = "houseS3";
	...
	locations[n].reload.l24.go = "CommonDoubleflourHouse_2";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	locations[n].reload.l2.name = "reload2";
	locations[n].reload.l2.go = "SantaCatalina_houseS1_bedroom";
	locations[n].reload.l2.emerge = "reload1";
	locations[n].reload.l2.autoreload = "0";
	locations[n].reload.l2.label = "Bedroom";
	...
	n = n + 1;
	///////спальня
	locations[n].id = "SantaCatalina_houseS1_bedroom";
	...
	//Reload map
	locations[n].reload.l1.name = "reload1";
	locations[n].reload.l1.go = "SantaCatalina_houseS1_residence";
	locations[n].reload.l1.emerge = "reload2";
	locations[n].reload.l1.autoreload = "0";
	locations[n].reload.l1.label = "Cabinet";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// ПИРАТСКИЙ ДОМ	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "SantaCatalina_PirateHouse";
	locations[n].id.label = "House";
	...
	locations[n].type = "residence";
	locations[n].fastreload = "SantaCatalina";
	locations[n].islandId = "SantaCatalina";
	//Models
	//Always
	...
	locations[n].reload.l2.name = "reload2";
	locations[n].reload.l2.go = "SantaCatalinaPirateResidence";
	locations[n].reload.l2.emerge = "reload1";
	locations[n].reload.l2.autoreload = "0";
	locations[n].reload.l2.label = "Room";
	LAi_LocationFightDisable(&locations[n], true);
	locations[n].reload.l2.disable  = true; //кабинет закрыт до нужного момента
	n = n + 1;
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// кабинет	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "SantaCatalinaPirateResidence";
	locations[n].id.label = "House";
	locations[n].image = "loading\inside\smallresidence_1.tga";
	//Town sack
	locations[n].townsack = "SantaCatalina";
	...
	//Reload map
	locations[n].reload.l1.name = "reload1";
	locations[n].reload.l1.go = "SantaCatalina_PirateHouse";
	locations[n].reload.l1.emerge = "reload2";
	locations[n].reload.l1.autoreload = "0";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Дом 	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "SantaCatalina_House";
	locations[n].id.label = "House";
	...
	locations[n].reload.l4.name = "reload2";
	locations[n].reload.l4.go = "SantaCatalina_Graveyard_Dungeon";
	locations[n].reload.l4.emerge = "reload1";
	locations[n].reload.l4.autoreload = "0";
...
//////////////////////////////////////////////////////////////////////////////////////////	//Подземелье
//////////////////////////////////////////////////////////////////////////////////////////
	Locations[n].id = "SantaCatalina_Graveyard_Dungeon";
	...
	//Reload map
	Locations[n].reload.l1.name = "reload1";
	Locations[n].reload.l1.go = "SantaCatalina_House";
	Locations[n].reload.l1.emerge = "reload2";
	locations[n].reload.l1.label = "House";
	Locations[n].locators_radius.reload.reload1 = 0.8;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Бухта Грей	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Shore116";
	locations[n].id.label = "Shore116";
	locations[n].image = "loading\outside\harbor_" + rand(5) + ".tga";
	locations[n].worldmap = "Shore116";
	//Sound
	locations[n].type = "seashore";
	locations[n].islandId = "Mein";
	locations[n].islandIdAreal = "DestinyGiftPearl";
	//Models
	//Always
	...
	//Reload map
	locations[n].reload.l1.name = "reload1_back";
	locations[n].reload.l1.go = "DestinyGiftPearl_Jungle_01";
	locations[n].reload.l1.emerge = "reload3";
	locations[n].reload.l1.autoreload = "1";
	locations[n].reload.l1.label = "Jungle";
	locations[n].locators_radius.reload.reload1_back = 2;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Джунгли	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "DestinyGiftPearl_Jungle_01";
	locations[n].id.label = "Jungle";
	locations[n].image = "loading\outside\jungle_" + rand(9) + ".tga";
	locations[n].DisableEncounters = true;
	//Sound
	...
	//Reload map
	locations[n].reload.l1.name = "reload1_back";
	locations[n].reload.l1.go = "DestinyGiftPearl_town_1"; 
	locations[n].reload.l1.emerge = "reload1";
	locations[n].reload.l1.autoreload = "1";
	locations[n].reload.l1.label = "Jungle";
	...
	locations[n].reload.l2.name = "reload2_back";
	locations[n].reload.l2.go = "Common_jungle_01"; //на зачарованный город
	locations[n].reload.l2.emerge = "reload1";
	locations[n].reload.l2.autoreload = "1";
	locations[n].reload.l2.label = "Jungle";
                     locations[n].locators_radius.reload.reload1_back = 2;
	...
	locations[n].reload.l3.name = "reload3_back";
	locations[n].reload.l3.go = "Shore116";
	locations[n].reload.l3.emerge = "reload1";
	locations[n].reload.l3.autoreload = "1";
	locations[n].reload.l3.label = "Shore116";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      Locations[n].id = "DestinyGiftPearl_town_1";
	locations[n].id.label = "Village";
	locations[n].image = "loading\inside\Town_0.tga";
	locations[n].DestinyGiftpearlVillage = true;
	//Sound
	locations[n].type = "jungle";
	locations[n].islandId = "Mein";
	...
	Locations[n].reload.l3.name = "reload3";
	Locations[n].reload.l3.go = "DestinyGiftPearlTown1_House6";
	Locations[n].reload.l3.emerge = "reload1";
	...
	Locations[n].reload.l6.go = "DestinyGiftPearlTown1_Townhall";
	Locations[n].reload.l6.emerge = "reload1";
	Locations[n].reload.l6.label = "house";

	Locations[n].reload.l7.name = "reload7";
	Locations[n].reload.l7.go = "church IM";
	Locations[n].reload.l7.emerge = "reload1";
	Locations[n].reload.l7.autoreload = "0";
	n = n + 1;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// Резиденция
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "DestinyGiftPearlTown1_Townhall";
	locations[n].id.label = "House";
	locations[n].image = "loading\inside\mediumhouse_" + rand(2) + ".tga";
	//Town sack
	locations[n].townsack = "DestinyGiftPearl_town_1";
	locations[n].lockWeather = "Inside";
	//Sound
	locations[n].type = "house";
	locations[n].islandId = "Mein";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Дом Остина
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "DestinyGiftPearlTown1_House6";
	locations[n].id.label = "Room";
	locations[n].image = "loading\inside\mediumhouse_" + rand(2) + ".tga";
	//Town sack
	locations[n].townsack = "DestinyGiftPearl_town_1";
