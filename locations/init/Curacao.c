...
int LocationInitCuracao(int n)
{
	...
	locations[n].reload.l21.go = "Villemstad_houseSp5";
	...
	locations[n].private1.items.blade_19 = 1;
	locations[n].private1.items.topor_05 = 1;
	locations[n].private1.items.potion1 = 10;
	locations[n].private1.items.potion3 = 2;
	locations[n].private2.key = "keyQuestLSCC";
	locations[n].private2.key.delItem = true;
	locations[n].private2.items.letter_LSCC = 1;
	locations[n].private2.items.icollection = 1;
	locations[n].private2.items.Chest = 1;
	locations[n].private2.items.gold_dublon = 555;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	locations[n].box1.key = "key1";
	locations[n].box1.skel = true;
	n = n + 1;
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Выход из города
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	locations[n].reload.l3.label = "Churchh";
...
//////////////////////////////////////////////////////////////////////////////////////////
	...
	Locations[n].image = "loading\Cemetery_0.tga";
	//Town sack
	locations[n].townsack = "Villemstad";
	//Sound
	...
	Locations[n].reload.l2.autoreload = "0";
	locations[n].reload.l2.label = "Shore24";
	locations[n].locators_radius.reload.reload1_back = 2;

	Locations[n].reload.l3.name = "reload6";
	Locations[n].reload.l3.go = "Villemstad_Chapel";
	Locations[n].reload.l3.emerge = "reload1";
	Locations[n].reload.l3.autoreload = "0";

	Locations[n].reload.l4.name = "reload5";
	Locations[n].reload.l4.go = "Common_Crypt";
	Locations[n].reload.l4.emerge = "reload1";
	Locations[n].reload.l4.autoreload = "0";

	Locations[n].reload.l5.name = "reload4";
	Locations[n].reload.l5.go = "Villemstad_CryptBig1";
	Locations[n].reload.l5.emerge = "reload1";
	Locations[n].reload.l5.autoreload = "0";

	Locations[n].reload.l6.name = "reload3";
	Locations[n].reload.l6.go = "Villemstad_KeepersHouse";
	Locations[n].reload.l6.emerge = "reload1";
	Locations[n].reload.l6.autoreload = "0";
	n = n + 1; 
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//Reload map
	Locations[n].reload.l1.name = "reload1";
	Locations[n].reload.l1.go = "Villemstad_graveyard";//Mosh
	Locations[n].reload.l1.emerge = "reload4";
	Locations[n].reload.l2.autoreload = "1";
...
//////////////////////////////////////////////////////////////////////////////////////////
	...
	Locations[n].id = "Villemstad_church IM";
	...
	Locations[n].reload.l2.name = "reload2_back";
	Locations[n].reload.l2.go = "Villemstad_Graveyard_crypt";
	Locations[n].reload.l2.emerge = "reload1";
	Locations[n].reload.l2.autoreload = "0";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	//Склеп	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Villemstad_Graveyard_crypt";
	locations[n].id.label = "crypt";
	...
	//Reload map
	locations[n].reload.l1.name = "reload1";
	locations[n].reload.l1.go = "Villemstad_church IM";
	locations[n].reload.l1.emerge = "reload2_back";
	locations[n].reload.l1.autoreload = "0";
	locations[n].reload.l1.label = "Graveyard";
	...
	Locations[n].reload.l3.go = "Villemstad_Graveyard_crypt";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	// Джунгли	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	locations[n].reload.l2.name = "reload1_back";
	locations[n].reload.l2.go = "Curacao_jungle_05";
	locations[n].reload.l2.emerge = "reload1";
	locations[n].reload.l2.autoreload = "1";
	locations[n].reload.l2.label = "Jungle";
	locations[n].locators_radius.reload.reload2_back = 2;
	...
	locations[n].reload.l3.name = "reload3_back";
	locations[n].reload.l3.go = "Vestpunt_ExitTown";
	locations[n].reload.l3.emerge = "reload1";
	locations[n].reload.l3.autoreload = "1";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	// Джунгли	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	locations[n].reload.l2.name = "reload2_back";
	locations[n].reload.l2.go = "Shore23";
	locations[n].reload.l2.emerge = "reload1";
	locations[n].reload.l2.autoreload = "1";
	locations[n].reload.l2.label = "Shore23";
	locations[n].locators_radius.reload.reload2_back = 2.0;
	n = n + 1;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	// мыс Санта Мария	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	//Порт Вестпунта
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Vestpunt_Port";
	locations[n].id.label = "Vestpunt Port";
	locations[n].image = "loading\outside\Quebradas Costillas_Port.tga";
	locations[n].worldmap = "Curacao";
	//Town sack
	locations[n].townsack = "Vestpunt";
	//Sound
	locations[n].type = "Port";
	locations[n].fastreload = "Vestpunt";
	locations[n].islandId = "Curacao";
	//Models
	//Always
	...
	//Reload map
	locations[n].reload.l1.name = "reload2_back";
	locations[n].reload.l1.go = "Vestpunt_ExitTown";
	locations[n].reload.l1.emerge = "reload2";
	locations[n].reload.l1.autoreload = "0";
	locations[n].reload.l1.label = "Jungle";
	locations[n].locators_radius.reload.reload1_back = 2;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Выход из города Вестпунт
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	Locations[n].id = "Vestpunt_ExitTown";
	locations[n].id.label = "Street";
	locations[n].image = "loading\Gate" + rand(3) + ".tga";
	locations[n].citizens = true;
	locations[n].soldiers = true;
	...
	locations[n].reload.l2.name = "reload2_back";
	Locations[n].reload.l2.go = "Vestpunt_Port";
	Locations[n].reload.l2.emerge = "reload2_back";
	locations[n].reload.l2.autoreload = "1";
	locations[n].reload.l2.label = "Vestpunt Port";
	locations[n].locators_radius.reload.reload1_back = 2.0;

    	Locations[n].reload.l3.name = "reload3";
	Locations[n].reload.l3.go = "Vestpunt_town";
	Locations[n].reload.l3.emerge = "reload1";
	Locations[n].reload.l3.autoreload = "0";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//Models
	//Always
	Locations[n].filespath.models = "locations\Outside\vestpuntTown";
	Locations[n].models.always.vestpuntTown = "vestpuntTown";	
	Locations[n].models.always.locators = "vestpuntTown_locators";		
	Locations[n].models.always.grassPatch = "vestpuntTown_grass";
	Locations[n].models.always.grassPatch.texture = "grass\grassshore.tga.tx";	
	Locations[n].models.always.l1 = "plan1";
	Locations[n].models.always.l1.level = 9;
	Locations[n].models.always.l1.tech = "LocationModelBlend";
	...
	Locations[n].models.always.l3.tech = "LocationModelBlend";	
	//Day
	locations[n].models.day.charactersPatch = "vestpuntTown_patch";
	locations[n].models.day.fonars = "vestpuntTown_fd";
	//Night
	locations[n].models.night.charactersPatch = "vestpuntTown_patch";
	locations[n].models.night.fonars = "vestpuntTown_fn";	
	//Environment
	locations[n].environment.weather = "true";
	locations[n].environment.sea = "false";
	//Reload map
	...
	Locations[n].reload.l5.go = "Vestpunt_tavern";
	Locations[n].reload.l5.emerge = "reload1";
	Locations[n].reload.l5.autoreload = "0";
	Locations[n].reload.l5.label = "Tavern";

	Locations[n].reload.l6.name = "reload6";
	Locations[n].reload.l6.go = "Vestpunt_townhall";
	Locations[n].reload.l6.emerge = "reload1";
	Locations[n].reload.l6.autoreload = "0";
	...
	Locations[n].reload.l8.go = "Vestpunt_store";
	Locations[n].reload.l8.emerge = "reload1_back";
	Locations[n].reload.l8.autoreload = "0";
	...
	// Таверна Вестпунт
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	Locations[n].id = "Vestpunt_Tavern";
	locations[n].id.label = "Tavern33";
	...
	//Night
	Locations[n].models.night.fonar = "tavern07_fn";
	...
	//Reload map
	Locations[n].reload.l1.name = "reload1_back";
	Locations[n].reload.l1.go = "Vestpunt_town";
	Locations[n].reload.l1.emerge = "reload5";
	Locations[n].reload.l1.autoreload = "0";
	Locations[n].reload.l1.label = "Street";

	Locations[n].reload.l2.name = "reload2_back";
	Locations[n].reload.l2.go = "Vestpunt_tavern_upstairs";
	Locations[n].reload.l2.emerge = "reload1_back";
	Locations[n].reload.l2.autoreload = "0";
    ...
    ////////////////////////==> подсобка таверны
	Locations[n].reload.l3.name = "reload3";
	Locations[n].reload.l3.go = "Vestpunt_Packhouse";
	Locations[n].reload.l3.emerge = "reload1";
	Locations[n].reload.l3.autoreload = "0";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	Locations[n].id = "Vestpunt_tavern_upstairs";
	locations[n].id.label = "Tavern upstairs";
	locations[n].image = "loading\inside\tavern.tga";
	//Town sack
	Locations[n].townsack = "Vestpunt";
	...
	//Reload map
	Locations[n].reload.l1.name = "reload1_back";
	Locations[n].reload.l1.go = "Vestpunt_tavern";
	Locations[n].reload.l1.emerge = "reload2_back";
	Locations[n].reload.l1.autoreload = "0";
	Locations[n].reload.l1.label = "Tavern";
	locations[n].locators_radius.reload.reload1 = 0.8;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// Склад	////////////////////////////////////////////////////////////////////////////////////////////////////////////
	Locations[n].id = "Vestpunt_Packhouse";
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Резиденция Вестпунт	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Vestpunt_townhall";
	locations[n].id.label = "Townhall";
