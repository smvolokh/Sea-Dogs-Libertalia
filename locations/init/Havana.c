...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	locations[n].reload.l6.go = "Havana_Crypt";
	locations[n].reload.l6.emerge = "reload1";
	locations[n].reload.l6.autoreload = "0";
	...
	//Reload map
	locations[n].reload.l1.name = "reload1_back";
	locations[n].reload.l1.go = "Cuba_Jungle_14";
	locations[n].reload.l1.emerge = "reload1";
	locations[n].reload.l1.autoreload = "1";
	locations[n].reload.l1.label = "Jungle";
	locations[n].locators_radius.reload.reload1_back = 2.0;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	locations[n].reload.l2.name = "reload2_back";
	locations[n].reload.l2.go = "Havana_CaveEntrance";
	locations[n].reload.l2.emerge = "reload2";
	locations[n].reload.l2.autoreload = "1";
	...
	locations[n].reload.l3.name = "reload3_back";
	locations[n].reload.l3.go = "Shore15";
	locations[n].reload.l3.emerge = "reload1";
	locations[n].reload.l3.autoreload = "1";
	locations[n].reload.l3.label = "Shore15";
	locations[n].locators_radius.reload.reload3_back = 2.0;
	n = n + 1;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Вход в пещеру
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Havana_CaveEntrance";
	...
	locations[n].reload.l3.go = "Havana_Grot";
	locations[n].reload.l3.emerge = "reload1";
	locations[n].reload.l3.autoreload = "0";
	...
	locations[n].reload.l2.name = "reload2_back";
	locations[n].reload.l2.go = "Cuba_Jungle_14";
	locations[n].reload.l2.emerge = "reload2";
	locations[n].reload.l2.autoreload = "1";
	locations[n].reload.l2.label = "Jungle";
	locations[n].locators_radius.reload.reload2_back = 2.0;
...
*/	
	...
	locations[n].environment.weather.rain = false;
 	//Reload map
	locations[n].reload.l1.name = "reload1_back";
	locations[n].reload.l1.go = "Havana_CaveEntrance";
	locations[n].reload.l1.emerge = "reload1";
	n = n + 1;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	// мыс Пунта-Горда	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Shore123";
	locations[n].id.label = "Shore123";
	locations[n].image = "loading\outside\harbor_" + rand(5) + ".tga";
	locations[n].worldmap = "Shore123";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// бухта Плайя-Хирон	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Shore124";
	locations[n].id.label = "Shore124";
	locations[n].image = "loading\outside\harbor_" + rand(5) + ".tga";
	locations[n].worldmap = "Shore124";
	//Sound
	locations[n].type = "seashore";
	locations[n].islandId = "Cuba";
	locations[n].islandIdAreal = "Cuba2";
