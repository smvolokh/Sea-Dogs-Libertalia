...
int LocationInitNevis(int n)
{
	...
	locations[n].reload.angar.go = "Charles_angar";
	locations[n].reload.angar.emerge = "reload1";
	locations[n].reload.angar.autoreload = "0";
	locations[n].reload.angar.label = "House";
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	locations[n].image = "loading\inside\BigHouse_0.tga";
 	//Town sack
	locations[n].townsack = "Charles";
	locations[n].lockWeather = "Inside";
	//Sound
