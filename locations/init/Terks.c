...
int LocationInitTerks(int n)
{
	...
	locations[n].reload.l1.go = "Terks_Jungle_09";
	locations[n].reload.l1.emerge = "reload1";
	locations[n].reload.l1.autoreload = "1";
	locations[n].reload.l1.label = "Jungle";
	locations[n].locators_radius.reload.reload1_back = 2;
	locations[n].locators_radius.box.box1 = 3;
	...
	locations[n].reload.l2.go = "Terks_Jungle_09";
	...
	locations[n].reload.l3.go = "SeaShore105";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Джунгли
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                locations[n].id = "Terks_Jungle_09";
	locations[n].id.label = "Jungle";
	locations[n].image = "loading\outside\jungle_" + rand(9) + ".tga";
 	//Sound
	locations[n].type = "jungle";
	...
	locations[n].reload.l3.name = "reload3_back";
	locations[n].reload.l3.go = "Terks_Jungle_01";
...
/////////////////////////////////////////////////////////////////////////////
	...
	locations[n].id = "SeaShore105";
	locations[n].id.label = "SeaShore105";
                        Locations[n].image = "loading\outside\Death.tga";
	locations[n].worldmap = "Reefsis";
	//Sound
	locations[n].type = "seashore";
	locations[n].islandId = "Terks";
	//locations[n].onUninhabitedIsland = true;
	...
	locations[n].Chestgennot = false; // генерить сундуки
	//Models
	//Always
