...
int LocationInitLostShipsCityy(int n)
{
	
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// ГОРОД
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "LostShipsCityy_town";
	locations[n].id.label = "LSC Townn";
	locations[n].worldmap = "LostShipsCityy";
	
	locations[n].townsack = "LostShipsCityy";
 	locations[n].islandId = "LostShipsCityy";
	
	locations[n].filespath.models = "locations\Gothic\LostShipsCityy\";
	locations[n].image = "loading\OutsideLSC_0.tga";
	//Sound
	locations[n].type = "LostShipsCityy";

	Locations[n].models.always.LostShipsCity = "LostShipsCityy";	
	Locations[n].models.always.seabed = "LostShipsCityy_seabed";	
	Locations[n].models.always.reflect = "LostShipsCityy_reflect";
	Locations[n].models.always.reflect.sea_reflection = 1;

	Locations[n].models.always.sails = "LostShipsCityy_sails";
	Locations[n].models.always.sails.tech = "LocationWindows";
	Locations[n].models.always.sails.level = 65539;
	
	Locations[n].models.always.plan1 = "LostShipsCityy_plan1";
	...
	Locations[n].models.always.plan2 = "LostShipsCityy_plan2";
	Locations[n].models.always.plan2.tech = "LocationWindows";
	Locations[n].models.always.plan2.level = 65533;

	Locations[n].models.always.plan3 = "LostShipsCityy_plan3";
	Locations[n].models.always.plan3.tech = "LocationWindows";
	Locations[n].models.always.plan3.level = 65532;
	
	Locations[n].models.always.locators = "LostShipsCityy_locators";
	
	Locations[n].models.always.grassPatch = "LostShipsCityy_grass";
	Locations[n].models.always.grassPatch.texture = "grass\algaeU1.tga.tx";	
	//Day
	locations[n].models.day.charactersPatch = "LostShipsCityy_patch_day";
	Locations[n].models.day.jumpPatch = "LostShipsCityy_jump_patch";
	locations[n].models.day.fonar = "LostShipsCityy_fd";	
	//Night
	locations[n].models.night.charactersPatch = "LostShipsCityy_patch_day";	
	Locations[n].models.night.jumpPatch = "LostShipsCityy_jump_patch";
	Locations[n].models.night.fonar = "LostShipsCityy_fn";	
	//Environment
	...
	locations[n].reload.l1.go = "LostShipsCityy";
	...
	locations[n].reload.l2.go = "LostShipsCityy";
	...
	////////  Галеон Эва AvaShipInside33 //////////
	locations[n].reload.l3.name = "reload41";
	locations[n].reload.l3.go = "AvaShipInside33";
	...
	locations[n].reload.l4.go = "AvaShipInside33";
	...
	locations[n].reload.l5.go = "AvaShipInside33";
	...
	locations[n].reload.l8.go = "CarolineBankk";
	...
	locations[n].reload.l11.go = "CeresSmithyy";
	...
	locations[n].reload.l12.go = "CeresSmithyy";
	...
	locations[n].reload.l13.go = "CeresSmithyy";
	...
	locations[n].reload.l14.go = "CeresSmithyy";
	...
	locations[n].reload.l15.go = "CeresSmithyy";
	...
	locations[n].reload.l18.go = "EsmeraldaStoreBigg";
	...
	locations[n].reload.l19.go = "EsmeraldaStoreBigg";
	...
	locations[n].reload.l20.go = "EsmeraldaStoreBigg";
	...
	locations[n].reload.l21.go = "EsmeraldaStoreBigg";
	...
	locations[n].reload.l22.go = "EsmeraldaStoreBigg";
	...
	locations[n].reload.l27.go = "FleuronTavernn";
	...
	locations[n].reload.l28.go = "FleuronTavernn";
	...
	locations[n].reload.l29.go = "FleuronTavernn";
	...
	locations[n].reload.l30.go = "FleuronTavernn";
	...
	locations[n].reload.l33.go = "FurieShipInside22";
	...
	locations[n].reload.l34.go = "FurieShipInside22";
	...
	locations[n].reload.l35.go = "FurieShipInside22";
	...
	locations[n].reload.l36.go = "FurieShipInside22";
	...
	locations[n].reload.l37.go = "FurieShipInside22";
	...
	//////// Галеон Глория  GloriaChurchh ////////
	locations[n].reload.l38.name = "reload15";
	locations[n].reload.l38.go = "GloriaChurchh";
	...
	locations[n].reload.l39.go = "GloriaChurchh";
	...
	locations[n].reload.l40.go = "GloriaChurchh";
	...
	locations[n].reload.l41.go = "GloriaChurchh";
	...
	locations[n].reload.l44.go = "PlutoStoreSmalll";
	...
	locations[n].reload.l45.go = "PlutoStoreSmalll";
	...
	locations[n].reload.l46.go = "PlutoStoreSmalll";
	...
	locations[n].reload.l47.go = "PlutoStoreSmalll";
	...
	//////// Корвет Протектор  ProtectorFisherr ////////
	locations[n].reload.l48.name = "reload33"; // резиденция ривадос
	locations[n].reload.l48.go = "ProtectorFisherr";
	...
	//////// Варшип Сан Августин  SanAugustineResidencee ////////
	locations[n].reload.l49.name = "reload1";
	locations[n].reload.l49.go = "SanAugustineResidencee";
	...
	locations[n].reload.l50.go = "SanAugustineResidencee";
	...
	locations[n].reload.l51.go = "SanAugustineResidencee";
	...
	locations[n].reload.l52.go = "SanAugustineResidencee";
	...
	locations[n].reload.l53.go = "SanAugustineResidencee";
	...
	locations[n].reload.l54.go = "SanAugustineResidencee";
	...
	locations[n].reload.l55.go = "SanAugustineResidencee";
	...
	locations[n].reload.l56.go = "SanAugustineResidencee";
	...
	//////// Барк Сан Габриель   SanGabrielMechanicc ////////
	locations[n].reload.l57.name = "reload55";
	locations[n].reload.l57.go = "SanGabrielMechanicc";
	...
	locations[n].reload.l58.go = "SanGabrielMechanicc";
	...
	locations[n].reload.l59.go = "SanGabrielMechanicc";
	...
	locations[n].reload.l60.go = "SanGabrielMechanicc";
	...
	locations[n].reload.l61.go = "SanGabrielMechanicc";
	...
	locations[n].reload.l62.go = "SanGabrielMechanicc";
	...
	//////// Бриг Санта Флорентина  SantaFlorentinaShipInside44 ////////
	locations[n].reload.l63.name = "reload21";
	locations[n].reload.l63.go = "SantaFlorentinaShipInside44";
	...
	locations[n].reload.l64.go = "SantaFlorentinaShipInside44";
	...
	locations[n].reload.l65.go = "SantaFlorentinaShipInside44";
	...
	locations[n].reload.l66.go = "SantaFlorentinaShipInside44";
	...
	locations[n].reload.l67.go = "SantaFlorentinaShipInside44";
	...
	//////// Бэттлшип Тартарус   TartarusPrisonn ////////
	locations[n].reload.l68.name = "reload51";
	locations[n].reload.l68.go = "TartarusPrisonn";
	...
	locations[n].reload.l69.go = "TartarusPrisonn";
	...
	//////// Галеон Веласко  VelascoShipInside11 ////////
	locations[n].reload.l70.name = "reload68";
	locations[n].reload.l70.go = "VelascoShipInside11";
	...
	locations[n].reload.l71.go = "VelascoShipInside11";
	...
	locations[n].reload.l72.go = "VelascoShipInside11";
	...
	locations[n].reload.l73.go = "VelascoShipInside11";
	...
	locations[n].reload.l74.go = "ExternalRingInsidee";
	locations[n].reload.l74.emerge = "reload1";
	locations[n].reload.l74.autoreload = "0";
	locations[n].reload.l74.disable = 0;  //закрыто до поры
	...
	locations[n].private8.key = "key2"; // тут лежит винтовальный штуцер
	...
	locations[n].private10.items.gold_dublon = 1500;
	locations[n].private10.items.keys_skel = 1;
	locations[n].private10.items.indian010 = 1;
	locations[n].private10.items.indian011 = 2;
	locations[n].private10.items.indian012 = 1;
	locations[n].private10.items.indian013 = 1;
	locations[n].private10.items.indian014 = 2;
	locations[n].private10.items.indian015 = 1;
	locations[n].private10.items.indian016 = 1;
	locations[n].private10.items.indian017 = 2;
	locations[n].private10.items.indian018 = 1;
	locations[n].private10.items.indian019 = 3;
	locations[n].private10.items.indian020 = 1;
	locations[n].private10.items.indian021 = 1;
	locations[n].private10.items.indian022 = 1;
	...
	locations[n].private10.items.spyglass7 = 1;
	locations[n].private10.items.knife_01 = 1;
	//locations[n].private10.items.sextant3 = 1;
	locations[n].private10.items.talisman9 = 1;
	locations[n].private10.items.pistol11 = 1;
	locations[n].private10.items.pistol10 = 1;
	locations[n].private10.items.pistol7 = 1;
	locations[n].private10.items.blade_28 = 1;
	locations[n].private10.items.blade_32 = 1;
	locations[n].private10.items.blade_33 = 1;

	locations[n].private11.key = "keyQuestLSCC"; //внутри Диффиндура
	locations[n].private11.key.delItem = true;
	locations[n].private11.money = 1210;
	locations[n].private11.items.gold_dublon = 131;
	locations[n].private11.items.blade_31 = 1;
	locations[n].private11.items.pistol4 = 1;
	locations[n].private11.items.bullet = 30;
	locations[n].private11.items.GunPowder = 35;
	...
	// Галеон Эва   AvaShipInside33
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "AvaShipInside33";
	locations[n].id.label = "Ava Cabin";
	locations[n].filespath.models = "locations\Gothic\LostShipsCityyInsides\AvaShipInside33";
	locations[n].image = "loading\IntsideLSC_" + rand(6) + ".tga";
	//Town sack
	locations[n].townsack = "LostShipsCityy";
	locations[n].lockWeather = "Insidee";
	//Sound
	locations[n].type = "LSCС_insidee";
	locations[n].islandId = "LostShipsCityy";	
	//Models
	//Always	
	...
	locations[n].reload.l1.go = "LostShipsCityy_town";
	locations[n].reload.l1.emerge = "reload41";
	locations[n].reload.l1.autoreload = "0";
	locations[n].reload.l1.label = "LSC Townn";

	locations[n].reload.l2.name = "reload2";
	locations[n].reload.l2.go = "LostShipsCityy_town";
	locations[n].reload.l2.emerge = "reload43";
	locations[n].reload.l2.autoreload = "0";
	locations[n].reload.l2.label = "LSC Townn";

	locations[n].reload.l3.name = "reload3";
	locations[n].reload.l3.go = "LostShipsCityy_town";
	locations[n].reload.l3.emerge = "reload44";
	locations[n].reload.l3.autoreload = "0";
	locations[n].reload.l3.label = "LSC Townn";

	locations[n].reload.l4.name = "reload4";
	locations[n].reload.l4.go = "LostShipsCityy_town";
	locations[n].reload.l4.emerge = "reload42";
	locations[n].reload.l4.autoreload = "0";
	locations[n].reload.l4.label = "LSC Townn";

	//ключи для сундуков и предметы внутри. Отмычки открывают все. 
	locations[n].private1.key = "key3";
	locations[n].private1.skel = true;
	locations[n].private1.money = 252500;
	locations[n].private1.items.gold_dublon = 120;
	...
	locations[n].private1.items.indian002 = 1;
	locations[n].private1.items.indian010 = 1;
	...
	locations[n].private3.skel = true;
	locations[n].private3.items.gold_dublon = 70;
	...
	// Фрегат Каролина   CarolineBankk
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "CarolineBankk";
	locations[n].id.label = "Caroline cabin";
	locations[n].filespath.models = "locations\Gothic\LostShipsCityyInsides\CarolineBankk";
	locations[n].image = "loading\IntsideLSC_" + rand(6) + ".tga";
	//Town sack
	locations[n].townsack = "LostShipsCityy";
	locations[n].lockWeather = "Insidee";
	...
	locations[n].private1.money = 25000;
	locations[n].private1.items.gold_dublon = 50;

	locations[n].private2.key = "keys_skel"; // квестовый
	locations[n].private2.money = 280000;
	...
	// Флейт Церес Смити   CeresSmithyy
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "CeresSmithyy";
	locations[n].id.label = "CeresSmithy cabin";
	locations[n].filespath.models = "locations\Gothic\LostShipsCityyInsides\CeresSmithyy";
	locations[n].image = "loading\IntsideLSC_" + rand(6) + ".tga";
	//Town sack
	locations[n].townsack = "LostShipsCityy";
	locations[n].lockWeather = "Insidee";
	...
	locations[n].reload.l5.go = "LostShipsCityy_town";
	locations[n].reload.l5.emerge = "reload59";
	locations[n].reload.l5.autoreload = "0";
	locations[n].reload.l5.label = "LSC Townn";

	locations[n].reload.l6.name = "reload6";
	locations[n].reload.l6.go = "LostShipsCityy_town";
	locations[n].reload.l6.emerge = "reload60";
	locations[n].reload.l6.autoreload = "0";
	locations[n].reload.l6.label = "LSC Townn";

	locations[n].reload.l7.name = "reload7";
	locations[n].reload.l7.go = "LostShipsCityy_town";
	locations[n].reload.l7.emerge = "reload61";
	locations[n].reload.l7.autoreload = "0";
	locations[n].reload.l7.label = "LSC Townn";

	//ключи для сундуков и предметы внутри
	locations[n].private1.key = "keys_skel"; // у Юргена - не взламывается
	...
	locations[n].private3.key = "keys_skel";
	locations[n].private3.money = 128341;
		
	n = n + 1;
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Галеон Эсмеральда   EsmeraldaStoreBigg
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "EsmeraldaStoreBigg";
	locations[n].id.label = "EsmeraldaStoreBig cabin";
	locations[n].filespath.models = "locations\Gothic\LostShipsCityyInsides\EsmeraldaStoreBigg";
	locations[n].image = "loading\IntsideLSC_" + rand(6) + ".tga";
	//Town sack
	locations[n].townsack = "LostShipsCityy";
	locations[n].lockWeather = "Insidee";
	...
	//ключи для сундуков и предметы внутри
	locations[n].private1.key = "keys_skel"; // у торговца
	locations[n].private1.skel = true;
	locations[n].private1.items.tigel = 1; // тигель
	locations[n].private1.items.mineral5 = 1;
	locations[n].private1.items.mineral23 = 45;
	locations[n].private1.items.mineral3 = 405;
	locations[n].private1.items.indian010 = 1;
	locations[n].private1.items.GunEchin = 20;

	locations[n].private2.key = "keys_skel";	// в зале
	locations[n].private2.skel = true;
	locations[n].private2.money = 35200;
	...
	locations[n].private3.money = 470824;
	...
	//Платформа Феникс    FenixPlatformm
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "FenixPlatformm";
	locations[n].id.label = "FenixPlatform cabin";
	locations[n].filespath.models = "locations\Gothic\LostShipsCityyInsides\FenixPlatformm";
	locations[n].image = "loading\IntsideLSC_" + rand(6) + ".tga";
	//Town sack
	locations[n].townsack = "LostShipsCityy";
	locations[n].lockWeather = "Insidee";
	...
	//Models
	//Always	
	Locations[n].models.always.inside = "FenixPlatformm";
	Locations[n].models.always.inside.level = 65538;
	Locations[n].models.always.outdoor = "FenixPlatformm_outdoor";		
	Locations[n].models.always.reflect = "FenixPlatformm_reflect";
	Locations[n].models.always.reflect.level = 65531;
	Locations[n].models.always.reflect.sea_reflection = 1;	
	Locations[n].models.always.windows = "FenixPlatformm_windows";
	Locations[n].models.always.windows.tech = "LocationWindows";
	Locations[n].models.always.windows.level = 65539;	
	Locations[n].models.always.sails = "FenixPlatformm_sails";
	Locations[n].models.always.sails.tech = "LocationWindows";
	Locations[n].models.always.sails.level = 65534;	
	Locations[n].models.always.plan1 = "Plan1";
	Locations[n].models.always.plan1.tech = "LocationWindows";
	...
	Locations[n].models.always.plan2.tech = "LocationWindows";
	Locations[n].models.always.plan2.level = 65532;	
	Locations[n].models.always.locators = "FenixPlatformm_locators";	
	Locations[n].models.always.grassPatch = "FenixPlatformm_grass";
	Locations[n].models.always.grassPatch.texture = "grass\algaeU1.tga.tx";					
	//Day
	locations[n].models.day.charactersPatch = "FenixPlatformm_patch_day";
	locations[n].models.day.fonarday = "FenixPlatformm_fd";	
	//Night
	locations[n].models.night.charactersPatch = "FenixPlatformm_patch_day";	
	Locations[n].models.night.fonarnight = "FenixPlatformm_fn";	
	//Environment
	locations[n].environment.weather = "true";
	locations[n].environment.sea = "true";
	...
	locations[n].private1.key = "keys_skel";
	locations[n].private2.skel = true;
	locations[n].private1.money = 12200;
	...
	locations[n].private1.items.indian020 = 3;
	...
	//Флейт Фернандо Диффиндур   FernandaDiffIndoorr
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "FernandaDiffIndoorr";
	locations[n].id.label = "FernandaDiffIndoor cabin";
	locations[n].filespath.models = "locations\Gothic\LostShipsCityyInsides\FernandaDiffIndoorr";
	locations[n].image = "loading\IntsideLSC_" + rand(6) + ".tga";
	//Town sack
	locations[n].townsack = "LostShipsCityy";
	locations[n].lockWeather = "Insidee";
	...
	// Каравелла Флерон   FleuronTavernn 
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "FleuronTavernn";
	locations[n].id.label = "FleuronTavern cabin";
	locations[n].filespath.models = "locations\Gothic\LostShipsCityyInsides\FleuronTavernn";
	Locations[n].image = "loading\inside\tavern3.tga";
	//Town sack
	locations[n].townsack = "LostShipsCityy";
	locations[n].lockWeather = "Insidee";
	//Sound
	...
	locations[n].private1.items.indian010 = 30;
	...
	locations[n].private3.items.mineral010 = 58;

	n = n + 1;	
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Пинас Фурия   FurieShipInside22
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "FurieShipInside22";
	locations[n].id.label = "FurieShipInside2 cabin";
	locations[n].filespath.models = "locations\Gothic\LostShipsCityyInsides\FurieShipInside22";
	locations[n].image = "loading\IntsideLSC_" + rand(6) + ".tga";
	//Town sack
	locations[n].townsack = "LostShipsCityy";
	locations[n].lockWeather = "Insidee";
	...
	locations[n].private1.items.mineral010 = 4;
	...
	locations[n].private1.items.potion5 = 12;
	locations[n].private2.items.shotgun_bullet = 2; // револьверная пуля
	
	n = n + 1;

	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Галеон   GloriaChurchh
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "GloriaChurchh";
	locations[n].id.label = "GloriaChurch cabin";
	locations[n].filespath.models = "locations\Gothic\LostShipsCityyInsides\GloriaChurchh";
	locations[n].image = "loading\IntsideLSC_" + rand(6) + ".tga";
	//Town sack
	locations[n].townsack = "LostShipsCityy";
	locations[n].lockWeather = "Insidee";
	...
	n = n + 1;
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	//Флейт Плуто  PlutoStoreSmalll
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "PlutoStoreSmalll";
	locations[n].id.label = "PlutoStoreSmall cabin";
	locations[n].filespath.models = "locations\Gothic\LostShipsCityyInsides\PlutoStoreSmalll";
	locations[n].image = "loading\IntsideLSC_" + rand(6) + ".tga";
	//Town sack
	locations[n].townsack = "LostShipsCityy";
	locations[n].lockWeather = "Insidee";
	...
	// Корвет Протектор  ProtectorFisherr
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "ProtectorFisherr";
	locations[n].id.label = "ProtectorFisher cabin";
	locations[n].filespath.models = "locations\Gothic\LostShipsCityyInsides\ProtectorFisherr";
	locations[n].image = "loading\IntsideLSC_" + rand(6) + ".tga";
	//Town sack
	locations[n].townsack = "LostShipsCityy";
	locations[n].lockWeather = "Insidee";
	...
	//Варшип Сан Августин  SanAugustineResidencee
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "SanAugustineResidencee";
	locations[n].id.label = "SanAugustineResidence cabin";
	locations[n].filespath.models = "locations\Gothic\LostShipsCityyInsides\SanAugustineResidencee";
	locations[n].image = "loading\IntsideLSC_" + rand(6) + ".tga";
	//Town sack
	locations[n].townsack = "LostShipsCityy";
	locations[n].lockWeather = "Insidee";
	//Sound
	locations[n].type = "LSCС_insidee";
	locations[n].fastreload = "LostShipsCityy";
	locations[n].islandId = "LostShipsCityy";
	//Models
	//Always	
	...
	locations[n].reload.l8.go = "LostShipsCityy_town";
	locations[n].reload.l8.emerge = "reload2";
	locations[n].reload.l8.autoreload = "0";
	locations[n].reload.l8.label = "LSC Townn";
	...
	//Барк Сан Габриель   SanGabrielMechanicc
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "SanGabrielMechanicc";
	locations[n].id.label = "SanGabrielMechanic cabin";
	locations[n].filespath.models = "locations\Gothic\LostShipsCityyInsides\SanGabrielMechanicc";
	locations[n].image = "loading\IntsideLSC_" + rand(6) + ".tga";
	//Town sack
	locations[n].townsack = "LostShipsCityy";
	locations[n].lockWeather = "Insidee";
	...
	//Бриг Санта Флорентина  SantaFlorentinaShipInside44
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "SantaFlorentinaShipInside44";
	locations[n].id.label = "SantaFlorentinaShipInside4 cabin";
	locations[n].filespath.models = "locations\Gothic\LostShipsCityyInsides\SantaFlorentinaShipInside44";
	locations[n].image = "loading\IntsideLSC_" + rand(6) + ".tga";
	//Town sack
	locations[n].townsack = "LostShipsCityy";
	locations[n].lockWeather = "Insidee";
	...
	//Бэттлшип Тартарус   TartarusPrisonn
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "TartarusPrisonn";
	locations[n].id.label = "TartarusPrison cabin";
	locations[n].filespath.models = "locations\Gothic\LostShipsCityyInsides\TartarusPrisonn";
	locations[n].image = "loading\IntsideLSC_" + rand(6) + ".tga";
	//Town sack
	locations[n].townsack = "LostShipsCityy";
	locations[n].lockWeather = "Insidee";
	...
	//ключи для сундуков и предметы внутри
	locations[n].private1.key = "keys_skel"; // сундук внизу тюрьмы, открывается ломиком
	...
	//Галеон Веласко  VelascoShipInside11
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "VelascoShipInside11";
	locations[n].id.label = "VelascoShipInside1 cabin";
	locations[n].filespath.models = "locations\Gothic\LostShipsCityyInsides\VelascoShipInside11";
	locations[n].image = "loading\IntsideLSC_" + rand(6) + ".tga";
	//Town sack
	locations[n].townsack = "LostShipsCityy";
	locations[n].lockWeather = "Insidee";
	...
	Locations[n].id = "ExternalRingDeckk";
	...
	//Reload map
	locations[n].reload.l1.name = "reload1";
	locations[n].reload.l1.go = "ExternalRingInsidee";
	locations[n].reload.l1.emerge = "reload2";
	locations[n].reload.l1.autoreload = "0";
	locations[n].reload.l1.label = "My_Deck";

	locations[n].reload.l2.name = "reload2";
	locations[n].reload.l2.go = "ExternalRingCabin11";
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "ExternalRingInsidee";
	...
	locations[n].reload.l2.name = "reload2";
	locations[n].reload.l2.go = "ExternalRingDeckk";
	locations[n].reload.l2.emerge = "reload1";
	locations[n].reload.l2.autoreload = "0";
	locations[n].reload.l2.label = "LSC Townn";
	...
	locations[n].private2.items.mineral010 = 11;
	...
	locations[n].environment.sea = "true";
                     ...
                     Locations[n].reload.l1.name = "reload1";
	Locations[n].reload.l1.go = "ExternalRingDeckk";
	Locations[n].reload.l1.emerge = "reload2";
	...
	locations[n].private1.items.map_maine_2 = 1;
	locations[n].private1.items.keyQuestLSCC = 1;
