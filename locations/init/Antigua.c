...
int LocationInitAntigua(int n)
{
	...
	locations[n].reload.l20.go = "SentJons_HouseF2";
	locations[n].reload.l20.emerge = "reload1";
	locations[n].reload.l20.autoreload = "0";
	locations[n].reload.l20.label = "Morgan's House";
	...
	locations[n].reload.l2.disable = 1; // закроем, но свљзку сделаем для квестовых нужд.
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	Locations[n].reload.l2.name = "reload2";
	Locations[n].reload.l2.go = "Town_Dungeon";
	...
	locations[n].image = "loading\inside\flamhouse_0.tga";
	//Town sack
	locations[n].townsack = "SentJons";
	locations[n].lockWeather = "Inside";
	//Sound
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Дом Моргана
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "SentJons_HouseF2";
	locations[n].filespath.models = "locations\inside\FlamHouse";
	...
	locations[n].reload.l4.name = "reload2"; //погребок-с.
	locations[n].reload.l4.go = "Town_Dungeon"; 
	locations[n].reload.l4.emerge = "reload1";
	locations[n].reload.l4.autoreload = "0";
	locations[n].reload.l4.label = "Dungeon";
	LAi_LocationFightDisable(&locations[n], true);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//Reload map
	locations[n].reload.l1.name = "reload1";
	locations[n].reload.l1.go = "SentJons_HouseF2";
	locations[n].reload.l1.emerge = "reload2";
	locations[n].reload.l1.autoreload = "0";
	...
	locations[n].reload.l2.name = "reload2_back";
	locations[n].reload.l2.go = "SentJons_church";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	// Бухта Норт	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Shore91";
	locations[n].id.label = "Shore91";
	locations[n].image = "loading\outside\harbor_" + rand(5) + ".tga";
	locations[n].worldmap = "Shore91";
	//Sound
	locations[n].type = "seashore";
	locations[n].islandId = "Antigua";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	// залив Кайрал-Бей	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Shore92";
	locations[n].id.label = "Shore92";
	locations[n].image = "loading\outside\harbor_" + rand(5) + ".tga";
	locations[n].worldmap = "Shore92";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// залив Вэлли-Черч	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Shore93";
	locations[n].id.label = "Shore93";
	locations[n].image = "loading\outside\harbor_" + rand(5) + ".tga";
	locations[n].worldmap = "Shore93";
	//Sound
	locations[n].type = "seashore";
	locations[n].islandId = "Antigua";
