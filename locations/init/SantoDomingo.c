...
int LocationInitSantoDomingo(int n)
{
	...
	locations[n].reload.l2.name = "reload2";
	locations[n].reload.l2.go = "SantoDomingo_Bank_residence";
	locations[n].reload.l2.emerge = "reload1";
	locations[n].reload.l2.autoreload = "0";
	locations[n].reload.l2.label = "Room";
	LAi_LocationFightDisable(&locations[n], true);
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Дом главы банков Смитов	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "SantoDomingo_Bank_residence";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////мыс Энганьо	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Shore100";
	locations[n].id.label = "Shore100";
	locations[n].image = "loading\outside\harbor_" + rand(5) + ".tga";
	locations[n].worldmap = "Shore100";
	//Sound
	locations[n].type = "seashore";
	locations[n].islandId = "Hispaniola";
	locations[n].islandIdAreal = "Hispaniola1";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// бухта Бараона	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Shore101";
	locations[n].id.label = "Shore101";
	locations[n].image = "loading\outside\harbor3.tga";
	locations[n].worldmap = "Shore101";
	//Sound
	locations[n].type = "seashore";
	locations[n].islandId = "Hispaniola";
	locations[n].islandIdAreal = "Hispaniola1";
	...
	//Models
	//Always
	locations[n].filespath.models = "locations\Outside\Shores\Shore17";
	Locations[n].models.always.shore17 = "shore17";
	locations[n].models.always.shore17.sea_reflection = 1;
	Locations[n].models.always.shore17seabed = "shore17_sb";
	Locations[n].models.always.locators = "shore17_locators";

	Locations[n].models.always.grassPatch = "shore17_grass";
	Locations[n].models.always.grassPatch.texture = "grass\grassshore.tga.tx";
	...
	Locations[n].models.always.fishingpier.tech = "DLightModel";
	
	//Day
	locations[n].models.day.charactersPatch = "shore17_patch";
	//Night
	locations[n].models.night.charactersPatch = "shore17_patch";	
	//Environment
	locations[n].environment.weather = "true";
	locations[n].environment.sea = "true";
	//Reload map
	...
	locations[n].reload.l3.name = "reload2_back";
	locations[n].reload.l3.go = "HouseShore101";
	locations[n].reload.l3.emerge = "reload1";
	locations[n].reload.l3.autoreload = "0";
	...
	//Reload map
	locations[n].reload.l1.name = "reload1_back";
	locations[n].reload.l1.go = "Shore101";
	locations[n].reload.l1.emerge = "reload2_back";
	locations[n].reload.l1.autoreload = "0";
	locations[n].reload.l1.label = "Shore101";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// бухта Баия-Эскосеса	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Shore102";
	locations[n].id.label = "Shore102";
	locations[n].image = "loading\outside\harbor_" + rand(5) + ".tga";
	locations[n].worldmap = "Shore102";
	//Sound
	locations[n].type = "seashore";
	locations[n].islandId = "Hispaniola";
	locations[n].islandIdAreal = "Hispaniola1";
