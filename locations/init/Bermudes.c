...
int LocationInitBermudes(int n)
{
	...
	locations[n].reload.l21.name = "houseSp1";//дом по пятому квесту пиратки
	locations[n].reload.l21.go = "Pirates_houseSp1";
	locations[n].reload.l21.emerge = "reload1";
	locations[n].reload.l21.autoreload = "0";
	locations[n].reload.l21.label = "Orry_House";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Pirates_houseSp1"; //с комнатой на втором этаже
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//Sound
	locations[n].type = "seashore";
 	locations[n].islandId = "Deadmanchest";
	//Models
	//Always
	locations[n].filespath.models = "locations\Gothic\Deadmanchest";
	Locations[n].models.always.Deadmanchest = "Deadmanchest";
	Locations[n].models.always.Deadmanchest.sea_reflection = 1;
	Locations[n].models.always.locators = "Deadmanchest_locators";

	Locations[n].models.always.grassPatch = "Deadmanchest_patch";
	Locations[n].models.always.grassPatch.texture = "grass\grassshore.tga.tx";
				
	//Day
	locations[n].models.day.charactersPatch = "Deadmanchest_patch";
	//Night
	locations[n].models.night.charactersPatch = "Deadmanchest_patch";
	//Environment
	locations[n].environment.weather = "true";
	locations[n].environment.sea = "true";
	//Reload map
