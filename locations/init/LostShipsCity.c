...
int LocationInitLostShipsCity(int n)
{
	...
	locations[n].image = "loading\OutsideLSC_" + rand(2) + ".tga";
	//Sound
	...
	locations[n].private3.items.topor_04 = 2;
	locations[n].private3.items.potionwine = 1;
	locations[n].private3.items.newblade13 = 1;
	locations[n].private3.items.newblade17 = 1;
	locations[n].private3.items.blade_11 = 3;
	locations[n].private3.items.topor_02 = 4;
	locations[n].private3.items.topor_03 = 3;
	locations[n].private3.items.blade_30 = 1;
	...
	locations[n].private5.items.blade_06 = 1;
	...
	locations[n].private7.items.pistol11 = 2;
	...
	locations[n].private8.items.BackPack4 = 1;
	...
	locations[n].private10.items.Mushket_9 = 1;
	...
	locations[n].private11.items.sculMa1 = 1;
	locations[n].private11.items.sculMa2 = 1;
	locations[n].private11.items.sculMa3 = 1;
	...
	locations[n].private2.items.blade_28 = 1;
	...
	locations[n].private1.items.pistol_06 = 1;
	...
	locations[n].private5.skel = true;
	locations[n].private5.items.newblade18 = 1;
	locations[n].private5.items.blade_20 = 1;
	locations[n].private5.items.blade_19 = 1;
	locations[n].private5.items.blade_12 = 1;
	locations[n].private5.items.blade_13 = 1;
	locations[n].private5.items.topor_012 = 1;
	...
	locations[n].private6.skel = true;
	locations[n].private6.items.pistol_01 = 10;
	locations[n].private6.items.pistol_04 = 1;
	locations[n].private6.items.pistol_03 = 3;
	locations[n].private6.items.pistol2 = 1;
	locations[n].private6.items.pistol5 = 1;
	locations[n].private6.items.pistol_08 = 1;
	...
	locations[n].private3.items.pistol_02 = 2;
	...
	locations[n].private1.items.newblade16 = 1;
	...
	locations[n].private2.items.newblade4 = 1;
	locations[n].private2.items.Mushket_8 = 1;
	locations[n].private2.items.grapeshot = 25;
