...
int LocationInitQuestLocations(int n)
{
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Хаза инквизиции (по квесту Отступники Веры) дубль 2 так как основная даёт вылет
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Santiago_Incquisitio2";
	...
	locations[n].type.LSC = true; //локация ККС
	locations[n].dolly = 2;
	//Models
	//Always	
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Подводная Локация
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "UnderWaterr";
	locations[n].id.label = "UnderWater";
	locations[n].filespath.models = "locations\Gothic\UnderWaterr";	
	locations[n].image = "loading\UnderWater_" + rand(1) + ".tga";
	//Sound	
	locations[n].type = "underwater";
	locations[n].type.LSCC = true; //локация ККС
	locations[n].dolly = 2;
	//Models
	//Always	
	Locations[n].models.always.UnderWater = "UnderWaterr";
	Locations[n].models.always.UnderWater.tech = "DLightModel";	
	
	Locations[n].models.always.outside = "UnderWaterr_outside";
	Locations[n].models.always.outside.tech = "DLightModel";
			
	Locations[n].models.always.reflect = "UnderWaterr_reflect";
	Locations[n].models.always.reflect .tech = "DLightModel";	
	Locations[n].models.always.reflect.sea_reflection = 1;
		
	Locations[n].models.always.sails = "UnderWaterr_sails";	
	Locations[n].models.always.sails.tech = "DLightModel";
		
	Locations[n].models.always.plants = "UnderWaterr_plants";	
	Locations[n].models.always.plants.tech = "DLightModel";
	//Locations[n].models.always.plants.tech = "LocationWindows";
	//Locations[n].models.always.plants.level = 66532;
	...
	Locations[n].models.always.locators = "UnderWaterr_locators";	
	
	Locations[n].models.always.grassPatch = "UnderWaterr_grass";
	Locations[n].models.always.grassPatch.texture = "grass\algaeU2.tga.tx";						
	//Day
	locations[n].models.day.charactersPatch = "UnderWaterr_patch_day";
	//Night
	locations[n].models.night.charactersPatch = "UnderWaterr_patch_day";		
	//Environment
	locations[n].environment.weather = "true";
	locations[n].environment.sea = "true";
	locations[n].environment.weather.rain = false;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// ГОРОД ГПК сон ГГ	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "LostShipsCity_town_fake";
	...
	Locations[n].models.always.LostShipsCityy = "LostShipsCityy";	
	//Locations[n].models.always.LostShipsCityy.level = 65538;
	...
	locations[n].environment.weather = "true";
	locations[n].environment.sea = "true";
	Locations[n].camshuttle = 1;	/// покачаем на волнах	
