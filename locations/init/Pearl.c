...
int LocationInitPearl(int n)
{
	...
	Locations[n].items.randitem2 = "indian019";
	...
	locations[n].reload.l1.autoreload = "0";
	locations[n].reload.l1.label = "Street";
	Locations[n].box.box1 = "indian020";
	...
	locations[n].reload.l1.autoreload = "0";
	locations[n].reload.l1.label = "Street";
	Locations[n].box.box1 = "indian018";
...
*/	
	...
	locations[n].reload.l2.name = "reload2_back";
	locations[n].reload.l2.go = "Pearl_Jungle_06"; //выход с Блуфилдс
	locations[n].reload.l2.emerge = "reload2";
	locations[n].reload.l2.autoreload = "1";
	locations[n].reload.l2.label = "Jungle";
	locations[n].locators_radius.reload.reload2_back = 2.0;
	...
	locations[n].reload.l1.autoreload = "0";
	locations[n].reload.l1.label = "Street";
	Locations[n].items.randitem2 = "indian017";
	Locations[n].items.randitem1 = "indian005";
	Locations[n].box.box1 = "Totem_003";
	...
	locations[n].reload.l1.autoreload = "0";
	locations[n].reload.l1.label = "Street";
	Locations[n].box.box1 = "indian021";
	...
	locations[n].reload.l1.autoreload = "0";
	locations[n].reload.l1.label = "Street";
	Locations[n].box.box1 = "indian017";
