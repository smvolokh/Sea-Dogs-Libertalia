...
#include "locations\init\Tenotchitlan_1.c"
#include "locations\init\LostShipsCity.c"
#include "locations\init\LostShipsCityy.c"
...
void InitLocations()
{
	...
	for(int i = 0; i < MAX_LOCATIONS; i++)
	{
		...
		loc.id = "";
		loc.index = i;
		loc.image = "loading\sea_0" + rand(6) + ".tga";
	...
	Locations[0].IslandsList.LostShipsIsland.begin = n;  //ГПК2
	n = LocationInitLostShipsCityy(n);
	Locations[0].IslandsList.LostShipsIsland.end = n;
	Trace("LostShipsIsland locations " + n);	
	...
	Locations[0].IslandsList.Tenotchitlan_1.begin = n;
	n = LocationInitTenotchitlan_1(n);
	Locations[0].IslandsList.Tenotchitlan_1.end = n;
	Trace("Tenotchitlan_1 locations " + n);
