...
    CI_CreateAndSetControls( "", "TimeScaleSlower", CI_GetKeyCode("VK_SUBTRACT"), 0, false );
	...
	CI_CreateAndSetControls( "", "CSM_MenuChars", CI_GetKeyCode("VK_NUMPAD1"), 0, false );
	CI_CreateAndSetControls( "", "CSM_MenuSkills", CI_GetKeyCode("VK_NUMPAD2"), 0, false );
	CI_CreateAndSetControls( "", "CSM_MenuItems", CI_GetKeyCode("VK_NUMPAD3"), 0, false );
	CI_CreateAndSetControls( "", "CSM_MenuShipsTuning", CI_GetKeyCode("VK_NUMPAD4"), 0, false );
	CI_CreateAndSetControls( "", "CSM_MenuTowns", CI_GetKeyCode("VK_NUMPAD5"), 0, false );
	CI_CreateAndSetControls( "", "CSM_MenuGoods", CI_GetKeyCode("VK_NUMPAD6"), 0, false );
	CI_CreateAndSetControls( "", "CSM_MenuOfficers", CI_GetKeyCode("VK_NUMPAD7"), 0, false );
	CI_CreateAndSetControls( "", "CSM_MenuShips", CI_GetKeyCode("VK_NUMPAD8"), 0, false );
	CI_CreateAndSetControls( "", "CSM_MenuMisc", CI_GetKeyCode("VK_NUMPAD9"), 0, false );
	CI_CreateAndSetControls( "", "CSM_HotKeyF4", CI_GetKeyCode("VK_F4"), 0, false );
	// <-- CheatSurfMenu by Cheatsurfer
...
// Character ===================================================================
    ...
    // boal -->
	CI_CreateAndSetControls( "PrimaryLand", "BOAL_UsePotion", CI_GetKeyCode("KEY_X"), 0, true ); // Пират Либерталии 21.07.20 дефолтом перевесил на "X"
	MapControlToGroup("BOAL_UsePotion","FightModeControls");
	
	// Warship 13.06.09 Выпить противоядие
	CI_CreateAndSetControls("PrimaryLand", "UseAntidote", CI_GetKeyCode("KEY_C"), 0, true);
	...
	// <-- JA
	CI_CreateAndSetControls("PrimaryLand", "csmQuickChangeWeapon", CI_GetKeyCode("KEY_Z"), 0, true);
	MapControlToGroup("csmQuickChangeWeapon", "FightModeControls");
	...
	CI_CreateAndSetControls( "PrimaryLand", "Ultimate_potion", CI_GetKeyCode("KEY_V"), 0, true); // выпить зелье команчей
...
// Ship ========================================================================
	...
	CI_CreateAndSetControls( "Sailing3Pers", "BOAL_ActivateTurn180", CI_GetKeyCode("KEY_Y"), 0, true );
	MapControlToGroup("BOAL_ActivateTurn180","Sailing1Pers");
	CI_CreateAndSetControls( "Sailing3Pers", "BOAL_ActivateImmediateReload", CI_GetKeyCode("KEY_U"), 0, true );	MapControlToGroup("BOAL_ActivateImmediateReload","Sailing1Pers");
	CI_CreateAndSetControls( "Sailing3Pers", "BOAL_ActivateLightRepair", CI_GetKeyCode("KEY_I"), 0, true );
	MapControlToGroup("BOAL_ActivateLightRepair","Sailing1Pers");
	CI_CreateAndSetControls( "Sailing3Pers", "BOAL_ActivateInstantRepair", CI_GetKeyCode("KEY_O"), 0, true );
...
*/	
	if (MOD_BETTATESTMODE == "On")
	{
		//CI_CreateAndSetControls( "Sailing3Pers", "Test_MastFall", CI_GetKeyCode("KEY_P"), 0, true );
	}
/*
