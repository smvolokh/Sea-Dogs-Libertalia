...
if(_sColony == "LeFransua") sColonyTown = "LeFransua_Port";
if(_sColony == "LeKe") sColonyTown = "LeKe_town";
if(_sColony == "SantLous") sColonyTown = "SantLous_Port";
if(_sColony == "PortAntonio") sColonyTown = "PortAntonio_town";
if(_sColony == "VillaAlegria") sColonyTown = "VillaAlegria_Port";
