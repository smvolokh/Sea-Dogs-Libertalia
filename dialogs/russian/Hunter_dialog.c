void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "meeting":
			...
			{   
			link.l4 = RandPhraseSimple ("Вы ошибаетесь! Меня зовут Фульк Делюк, я местный торговец рыбой.", "Уверяю вас, вы ошибаетесь! Я Фульк Делюк! Работаю в тюрьме, живу там же. Да меня здесь каждая собака знает!");
			link.l4.go = "lier3";
			}
		break;
