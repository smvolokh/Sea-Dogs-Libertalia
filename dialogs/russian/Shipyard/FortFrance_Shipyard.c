...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "FMQM_3":
			...
			if (MOD_SKILL_ENEMY_RATE < 7) sTemp = "каравелле-редонде";// Addon 2016-1 Jason пиратская линейка
		...
		case "FMQM_6":
			dialog.text = "Не переживайте. Вы же не понесете ее в магазин или контрабандистам. После операции возвращаетесь в Форт де Франс и ставите свое судно ко мне в доки на ремонт, вечером. По темноте, дабы не привлекать внимание плотников, двое моих верных людей перенесут всю смолу с вашего корабля в укромное место на верфи. Никто ничего не заподозрит.";
