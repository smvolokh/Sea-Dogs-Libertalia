...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = "Не подскажешь куда подевался Тиракс?";
...
//********************** Месть корсара **********************
		...
		case "RevengeCorsair":
			dialog.text = "Он ушёл в море несколько дней назад, больше мне нечего добавить.";
			link.l1 = "Один ушёл или с кем-то?";
			link.l1.go = "RevengeCorsair_1";

		break;

		case "RevengeCorsair_1":
			dialog.text = "Тут Жан Красавчик объявился внезапно, вот вскоре вместе с ним Тиракс и ушёл. А куда - неизвестно.";
			link.l1 = "Спасибо!";
			link.l1.go = "exit";
