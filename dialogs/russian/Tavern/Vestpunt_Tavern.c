...
//********************** Мистер и Мисси Смит **********************
 		...
 		case "Smithy":
    		dialog.text = "Крошимер Говард? А-а-а, Говард! Вообще, кажется, её зовут Августа, но да ладно. Да, странная девчёнка, никуда не выходит, ни с кем не общается! Уже как три недели снимает у меня комнату. Она наверху, можете подняться и поговорить с ней, если хотите.";
    		link.l1 = "Хм, вот как? Что ж, спасибо. Я поднимусь.";
    		link.l1.go = "exit";
		npchar.quest.Smithy_DouwesenTavern = "true";	
		LocatorReloadEnterDisable("Vestpunt_Tavern", "reload2_back", false); //открыть комнату
