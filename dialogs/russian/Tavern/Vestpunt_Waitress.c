...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			if (pchar.questTemp.piratesLine == "Soukins_seekRings" && CheckCharacterItem(pchar, "jewelry8") && CheckCharacterItem(pchar, "jewelry7"))
			{
				link.l1 = "Я "+ GetSexPhrase("принес","принесла") +" то, что ты хотела. Вот твои камушки.";
				link.l1.go = "PL_Q7_3";
			}
		break;
		case "PL_Q7_1":
			dialog.text = "Принеси мне голубой янтарь и простой янтарь. И тогда, возможно, я смогу тебе помочь...";
			link.l1 = "У меня его нет...";
			link.l1.go = "PL_Q7_2";
			pchar.questTemp.piratesLine = "Soukins_seekRings";
			if (CheckCharacterItem(pchar, "jewelry8") && CheckCharacterItem(pchar, "jewelry7"))
            {
				link.l2 = "Вот твои камушки, дорогуша...";
				link.l2.go = "PL_Q7_3";
			}
		break;
		case "PL_Q7_2":
		...
		case "PL_Q7_3":
			...
			TakeItemFromCharacter(pchar, "jewelry8");
		break;
		case "PL_Q7_4":
			dialog.text = "Нет.";
