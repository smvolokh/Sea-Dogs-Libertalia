...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = "Послушай, приятель, ничего не слышно в таверне интересного про бриг 'Черная Горгулья'?";
				link.l1.go = "BlueBird_1";
			}
                                                          // Посылка для Сагитты
			if(PChar.Gothic_Delivery == "12")
			{
				link.l1 = "Слушай, я тут ищу одного человека, его имя Акил, он не появлялся здесь?";
		...
		case "GothicLine_Delivery_1":
			dialog.text = "Хм. Дай вспомнить. Нет, не припоминаю. Может быть, заходил, да только откуда мне знать всех посетителей моей таверны. Они же мне не представляются, когда рому просят.";
			link.l1 = "Да, верно. Ладно, пойду искать.";
			link.l1.go = "GothicLine_Delivery_2";
		break;
		
		case "GothicLine_Delivery_2":
			dialog.text = "А зачем он тебе нужен-то?";
			link.l1 = "У меня к нему есть вопросы.";
			link.l1.go = "GothicLine_Delivery_3";
		break;
		
		case "GothicLine_Delivery_3":
			dialog.text = "Вопросы, говоришь? Ну, если найдёшь его, как следует поговори.";
			link.l1 = "Что-что, а это я умею. Ладно, до встречи.";
			link.l1.go = "exit";
		...
		break;
		case "BlueBird_3":
			dialog.text = "Дык здесь и видят, у Исла-Тесоро. По хождению в наших рифах 'Черной Горгулье' равных нет, не раз в погоне за ней галеоны да фрегаты бились - и прямиком на дно!";
		...
		case "BlueBird_5":
			...
			link.l1 = "Не подскажешь ли ты, милейший, куда перебрался этот бывший хозяин магазина?";
			link.l1.go = "BlueBird_6";
		break;
		case "BlueBird_6":
			dialog.text = "Слыхал я, что он перебрался в Пуэрто-Принсипе, торгует там себе потихоньку и никуда не высовывается.";
		...
		case "tieyasal_1":
			dialog.text = "Понятия не имею. Он ушел в море, а куда... он вроде что-то говорил о Блуфилдс. Вероятно, за тобой отправился, не иначе.";
			link.l1 = "Это не ты его в Блуфилдс отправил?";
