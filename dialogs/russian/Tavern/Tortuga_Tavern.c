    ...
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			if (CheckAttribute(pchar, "questTemp.Mtraxx.Jeweller"))
			{
             ...
             //Гот. линейка, квест. узнаем, где Лоран де Граф.
		...
		case "guardoftruth_2":
			dialog.text = "Всегда пожалуйста, месье "+pchar.name+", любая информация для нашего славного капитана, спасителя Форт де Франса! Заходите еще!";
			link.l1 = "...";
			link.l1.go = "exit";	
...
//============================ Гот. линейка, квест. узнаем о Лоране де Графе =======================
  	 	case "Gothic_3_1":
        ...
        break;
  	 	case "Gothic_3_3":
			...
			link.l1 = "Он мне нужен срочно по очень важному делу. "+ GetSexPhrase("Искал","Искала") +" его в Шарлотт-Тауне, теперь ищу здесь. Я "+ GetSexPhrase("сам голландец","сама голландка") +", как и Лоран...";
			link.l1.go = "Gothic_3_4";
        break;
   	 	case "Gothic_3_4":
			dialog.text = "Ладно, скажу тебе, раз так надо. Слышал я, что он курсирует на Кубе рядом с Сантьяго. Де Граф имеет в своем распоряжении фрегат 'Коминте'.";
