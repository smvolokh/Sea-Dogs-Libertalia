...
case "First time":
dialog.text = "О, приветсвую, капитан! Приятно видеть преуспевающего коллегу! Чем могу быть полезен?";
link.l1 = "Приветствую! Я тут подумал"+ GetSexPhrase("","а") +", не хотите ко мне присоединиться? Вместе мы сможем хорошие дела провернуть.";
link.l1.go = "companion";
link.l2 = "Поторгуем, капитан?";
link.l2.go = "Trade_1";
link.l3 = "Здравствуйте, сударь! Не желаете ли партейку, отдохнуть от дел?";
link.l3.go = "Play_Game";
link.l4 = "Я просто решил снова поприветствовать Вас!Удачи!";
link.l4.go = "exit";	
break;
...
break;
	...
	// на Тайясаль
		case "tieyasal":
			...
			link.l1 = "Спасибо, дружище! Я рад" + GetSexPhrase("","а") + ", что не ошиб" + GetSexPhrase("ся","ась") + " в тебе.";
