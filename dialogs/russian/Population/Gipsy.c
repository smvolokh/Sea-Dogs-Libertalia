...
// <-- продажа мышьяка
	...
	// --> Мангароса
		...
		case "mangarosa_4":
			dialog.text = "Соколик, поверь - не стоит оно того. Не ввязывайся в это дело, сгубит оно тебя. Но если ты хочешь - держи рецептик. И... смотрю я на тебя - бравый парень, с саблей, моряк... может, даже капитан?";
