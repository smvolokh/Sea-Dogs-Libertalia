...
// Jason-------------------------------------------------Сага----------------------------------------------
		...
		case "ispoved":
			...
			{   
			link.l2 = "Падре, дело в том, что я дал обет служения Господу, я проливал свою и чужую кровь как воду, чтобы искоренить зло и утвердить торжество Истинной Веры...";
	...
	case "ispoved_22":
			...
			link.l1 = "Я знаю, падре, поэтому и пришёл... Всё это было не ради наживы, а ради служения Вере...";
