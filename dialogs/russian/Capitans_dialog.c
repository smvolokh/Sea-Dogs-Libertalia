		...
		case "First time":
			...
			if (!bDisableMapEnter)
			{
				...
				if(CheckAttribute(NPChar, "surrendered"))
				{
					...
					dialog.text = "На корабле поднят белый флаг, капитан. Мы капитулируем. Я вверяю себя, свой корабль и экипаж в Ваше распоряжение. Уповаю на Ваше милосердие и благородство. Что Вы хотите от от меня?";
					//выкуп
