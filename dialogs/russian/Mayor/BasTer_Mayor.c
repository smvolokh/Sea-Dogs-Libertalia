...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "guardoftruth_2":
			dialog.text = "И с каких это пор вы стали таким ревностным и добропорядочным верующим, а, мсье "+pchar.lastname+"? Испанцы нам не друзья, и я не считаю должным оказывать давление на святого отца в этом вопросе. Подарен крест - и ладно. Наш священник никакого отношения к грабежу и убийству не имеет, так что...";
			link.l1 = "Ничем не можете мне помочь?";
			link.l1.go = "guardoftruth_3";
		break;
		
		case "guardoftruth_3":
			dialog.text = "Буду откровенным, мсье "+pchar.lastname+": и не считаю должным. Я не испытываю любви к этим папистским фанатикам.";
 	...
 	PlaySound("VOICE\Russian\gotica\SFX\ZOMBIE_01.wav");
		...
		case "baster_goldengirl":
			dialog.text = "А, капитан "+GetFullName(pchar)+", я чуть не позабыл! Да-да, мой старый друг очень желает с вами встретится и просил оповестить, как только вы явитесь в город. Прошу вас, проходите в малую приемную, а я немедля пошлю весточку Ангеррану. Кстати, а как вы познакомились?";
	...
	AfterTownBattle();
 	...
 	PlaySound("VOICE\Russian\gotica\SFX\ZOMBIE_01.wav");
            ...
            Link.l1 = "Слушай меня, несчастный засранец. Я знаю, что у тебя есть четыре предмета: три хрустальных черепа тольтеков разного цвета и странный индейский предмет, похожий на погремушку. Отдай мне эти предметы и мы уберемся из города.";
	...
	Link.l1 = "Еще бы ты мне запрещал, засранец, серишь здесь как бельдийская лошадь...";
	Link.l1.go = "exit";
	NextDiag.TempNode = "Cupture_after";
