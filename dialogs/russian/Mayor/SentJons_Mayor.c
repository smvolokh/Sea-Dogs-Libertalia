...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "G_Girl":
			...
			link.l1 = "Бригантины, ваша светлость. Перевозившей кап... почту. Важные документы. Я слышал, ведется расследование, и, как верный друг английской короны, не могу не поделиться важными сведениями.";
			link.l1.go = "G_Girl_1";
		break;
