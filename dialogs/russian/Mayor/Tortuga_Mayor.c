...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		// Jason НСО
		case "patria_tortuga":
			dialog.text = "Хорошо, капитан "+GetFullName(pchar)+". Барону с моей стороны будет оказан соответствующий его положению прием и содействие в выполнении его требований.";
			link.l1 = "";
