...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "Sharlie_junglejew":
			dialog.text = "Дайте поглядеть поближе... Невероятно! Это просто невероятно, "+pchar.name+"! Это серьги моей жены. Я сам их ей подарил перед отъездом в колонии. Они исчезли несколько месяцев назад при загадочных обстоятельствах. Я так и знал, что они были украдены!\n"+pchar.name+"!, я очень рад, что вы пришли прямо ко мне, а не стали сбывать эту дорогую мне вещь лавочникам. Я в долгу не останусь. Как я слышал, вы собираетесь приобрести корабль? Раз вы решили приобщиться к морскому делу, то вам несомненно потребуется карта нашего архипелага. Или я могу предложить вам свой охотничий карабин - это хорошее оружие, он служил мне верой и правдой. Может и Вам послужит, если захотите. Что Вам сейчас более необоходимо? Оружие или карта?";
			link.l1 = "Ваша светлость, я выберу карабин! Хорошее оружие никогда лишним не будет.";
			link.l1.go = "Sharlie_junglejew_0";
			link.l2 = "Ваша светлость, я выберу карту! Мне не помешает познакомиться с архипелагом поближе.";
			link.l2.go = "Sharlie_junglejew_1";
		break;

	case "Sharlie_junglejew_0":
	dialog.text = "Как пожелаете, этот карабин теперь Ваш!";
			link.l1 = "Спасибо, Ваша Светлость!";
			link.l1.go = "Sharlie_junglejew_00";
		break;

case "Sharlie_junglejew_1":
			dialog.text = "Как пожелаете, презентую Вам карту нашего архипелага!";
			link.l1 = "Спасибо, Ваша Светлость!";
			link.l1.go = "Sharlie_junglejew_01";
		break;

	case "Sharlie_junglejew_00":
			DialogExit();
			PlaySound("interface\important_item.wav");
			RemoveItems(pchar, "jewelry25", 1);
			GiveItem2Character(pchar, "mushket_01"); 
			AddQuestRecord("SharlieE", "01");
			CloseQuestHeader("SharlieE");
			DeleteAttribute(pchar, "questTemp.Sharlie.Junglejew");
		break;
		
	case "Sharlie_junglejew_01":
			DialogExit();
			PlaySound("interface\important_item.wav");
			RemoveItems(pchar, "jewelry25", 1);
