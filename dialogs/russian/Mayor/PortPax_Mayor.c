...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		// Jason НСО
		case "patria_portpax":
			dialog.text = "Очень рад встрече с вами, капитан "+GetFullName(pchar)+"! , и с бароном. Я сделаю все возможное для того, чтобы пребывание месье Форже в нашей колонии было максимально комфортным. И пользуясь тем, что столь высокопоставленные особы нанесли мне визит, я буду ходатайствовать вам об одном деле.";
