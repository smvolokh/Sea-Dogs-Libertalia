...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "patria_Sl_4":
			dialog.text = "Я даже не сомневался, что это будете вы. Тем лучше! Наша эскадра готова. Линейный корабль 1 ранга и два корабля 4 ранга. Максимальный размер всей эскадры не должен превышать восьми кораблей.";
			if (GetCompanionQuantity(pchar) > 5)
			{
				link.l1 = "Тогда я поставлю лишние корабли на стоянку.";
				link.l1.go = "patria_Sl_5";
			}
			else
			{
				link.l1 = "Отлично! Можем отправляться в путь.";
				link.l1.go = "patria_Sl_6";
			}
		break;
