...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "caleuche_7":
			...
			dialog.text = "Но беды наши на этом не закончились, сын мой. Недавно мне прилал письмо настоятель церкви Гаваны, отец "+sld.name+". Он сообщил ужасные вести. В пещере, в джунглях Кубы, охотниками были замечены жуткие существа, похожие на ходячих мертвецов. Особенно кошмарным это выглядит на фоне того, что в Гаване таинственым образом пропали люди, отправившиеся в джунгли по тем или иным делам.";
