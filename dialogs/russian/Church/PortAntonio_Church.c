...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			link.l1 = HeroStringReactionRepeat(RandPhraseSimple("Я передумал" + GetSexPhrase("","а") + "...", "Не сейчас, " + GetSexPhrase("падре","сестра") + "..."), "Да, пока особо и нечего сказать...",
                      "Задам, задам... Только позже...", "Простите, " + GetSexPhrase("падре","сестра") + "...", npchar, Dialog.CurrentNode);
			link.l1.go = "exit";
		...
		case "Consumption":
			...
			link.l1 = "Ясно. Простите за беспокойство, " + GetSexPhrase("падре","сестра") + "...";
			link.l1.go = "exit";
