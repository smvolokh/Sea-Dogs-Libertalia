...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "trial_8":
			...
			dialog.text = "Дело обстоит так. 'Алькантара' к выходу в море уже давно готова, но ее намеренно не ставят под погрузку, причем по приказу самого губернатора. Ну, это мне так сказали. А плотники сейчас делают всякую мелкую работу, которая на выход судна в море никак не влияет\nВсе ждут прихода какой-то каравеллы-латины из Картахены. Дело в том, что на 'Алькантаре' недостаточный, по мнению капитана, запас пороха. Вот и ждут, пока 'Нинья' привезет порох для 'Алькантары'\nНо всем это ожидание уже порядком надоело, так что если 'Нинья' не прибудет через три дня - 'Алькантара' отправится в путь и так...";
