...
Link.l2 = "Начальник, не кипишуй, может договоримся?";
		...
		break;
		case "NotPegYou2":
			dialog.text = RandPhraseSimple("Ладно. Все в порядке, вы можете идти, " + GetAddress_Form(pchar) + ".", "Хорошо-хорошо. Все в порядке, " + GetAddress_Form(pchar) + ", прошу прощения.");
			link.l1 = "Так-то!";
...
//============================== Взятка =========================
		...
		case "SoldierNotBlade":
			dialog.text = LinkRandPhrase("Какого черта ты бегаешь по форту с обнаженным клинком? Немедленно убери оружие!", "Приказываю вам немедленно убрать оружие в ножны!", "Эй, "+ GetSexPhrase("приятель","подруга") +", прекрати пугать народ! Убери оружие в ножны.");
