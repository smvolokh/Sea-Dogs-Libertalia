...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = "Я знаю, что у вас есть должник по имени Алехандро Пистолето. Скажите, насколько велика его... провинность?";
                link.l1.go = "Sharlie";
			}	
			if (CheckAttribute(pchar, "questTemp.Sharlie") && pchar.questTemp.Sharlie == "bankskipermoney")
			{
				link.l1 = "Я по поводу долга Алехандро Пистолето.";
		...
		case "Sharlie_5x": // Addon 2016-1 Jason пиратская линейка 1
			...
			link.l1 = "Жаль. Что же, тогда я принесу деньги за Алехандро. До встречи!";
			link.l1.go = "exit";
		...
		case "Sharlie_9":
			dialog.text = "Дело ваше. Если чувствуете, что не по плечу ноша - то лучше сразу отказаться. Тогда жду вас с деньгами в качестве уплаты долга Деллюка.";
		...
		case "Sharlie_14":
			...
			link.l1 = "Что насчет долга Алехандро Пистолето?";
