...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
	                     PlaySound("VOICE\Russian\gotica\BRONKO\DIA_BRONKO_HALLO_06_00.wav");
			dialog.text = "И куда это мы направляемся, а?";
			link.l1 = "...";
			link.l1.go = "Bronco_1";			
		break;

		case "Bronco_1":
	                     PlaySound("VOICE\Russian\gotica\BRONKO\DIA_BRONKO_HALLO_15_01.wav");
			dialog.text = "...";
			link.l1 = "А ты, что здесь старший!";
			link.l1.go = "Bronco_2";			
		break;

		case "Bronco_2":
	                     PlaySound("VOICE\Russian\gotica\BRONKO\DIA_BRONKO_HALLO_06_02.wav");
			dialog.text = "Сейчас в морду получишь - придурок.";
			link.l1 = "...";
			link.l1.go = "Bronco_3";			
		break;

		case "Bronco_3":
	                     PlaySound("VOICE\Russian\gotica\BRONKO\DIA_BRONKO_HALLO_06_03.wav");
			dialog.text = "Если ты хочешь свободно ходить по моей земле, ты должен заплатить мне 5 золотых или душу из тебя вытрясу.";
			link.l1 = "...";
			link.l1.go = "exit";			
