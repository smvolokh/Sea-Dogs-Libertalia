...
// ********************* Сеньян (в таверне Саванна-ла-Мар) ******************************
		...
		case "Senyan_2":
 	                   PlaySound("VOICE\Russian\gotica\BDT\DIA_ADDON_BDT_1084_SENYAN_HI_BAD_15_00.wav");
            	                   dialog.text = "";
        	                    link.l1 = "Сначало расскажи мне плохие новости...";
        	                    link.l1.go = "Senyan_3";
		break;
		...
		case "Senyan_4":
 	                   PlaySound("VOICE\Russian\gotica\BDT\DIA_ADDON_BDT_1084_SENYAN_HI_BAD_12_03.wav");
            	                   dialog.text = "И если они найдут тебя - они убъют тебя...";
        	                    link.l1 = "";
        	                    link.l1.go = "Senyan_5";
		break;
		...
		case "Senyan_6":
 	                   PlaySound("VOICE\Russian\gotica\BDT\DIA_ADDON_BDT_1084_SENYAN_HI_BAD_12_05.wav");
            	                   dialog.text = "Значит ты дерёшся не хуже чем плетёшь интриги, придти в лагерь в таких доспехах - это...";
        	                    link.l1 = "";
        	                    link.l1.go = "Senyan_7";
		break;
...
// ********************* Сеньян (на Мартинике) ******************************
		...
		case "Senyan_coast_1":
			dialog.text = "Как ты понимаешь я работал на Девида Смита и являлся его глазами и ушами... Я видел бой и похоже Кэрол ускользнула от тебя. Это плохо, как для тебя и меня...";
		...
		link.l1 = "Похоже, что так, теперь с этой сучкой у меня личные счёты. Ты пойдёшь со мной на корабле?";
		...
		//pchar.quest.Gothic_PuertoRico.win_condition.l1 = "locator";
		//pchar.quest.Gothic_PuertoRico.win_condition.l1.location = "VillaAlegria_Town2";
	                   //pchar.quest.Gothic_PuertoRico.win_condition.l1.locator_group = "reload";
	                   //pchar.quest.Gothic_PuertoRico.win_condition.l1.locator = "reload4";
		//pchar.quest.Gothic_PuertoRico.function = "Gothic_SenyanTalk";

                                      pchar.questTemp.GothicSmithy = "HaryHooms_Smithy";
		AddCharacterExpToSkill(pchar, "Fortune", 50);//везение
		AddCharacterExpToSkill(pchar, "Leadership", 50);
		break;


// ********************* Сеньян ( в Пуэрто - Рико) ******************************

		case "PuertoRico":
            	                   dialog.text = "Прошу прощения капитан в этот дом есть черный ход!";
        	                    link.l1 = "Черный ход? Где...";
        	                    link.l1.go = "Senyan_PuertoRico_1";
		break;

		case "Senyan_PuertoRico_1":
            	                   dialog.text = "Я покажу!";
        	                    link.l1 = "Понял...";
        	                    link.l1.go = "Senyan_PuertoRico_End";
		break;

 		case "Senyan_PuertoRico_End":
                                      NextDiag.CurrentNode = "First time";
		DialogExit();      
		AddDialogExitQuestFunction("Gothic_SmithyPuertoRico_2");
		break;

		case "Senyan_PuertoRico_2":
            	                   dialog.text = "Это здесь!";
        	                    link.l1 = "...";
        	                    link.l1.go = "Senyan_PuertoRico_3";
		break;

 		case "Senyan_PuertoRico_3":
                                      NextDiag.CurrentNode = "Senyan_officer";
		DialogExit();      
		break;
		...
		case "PuertoRicoCave":
            	                   dialog.text = "Капитан у нас гости!";
        	                    link.l1 = "...";
        	                    link.l1.go = "Senyan_PuertoRicoCave_1";
		break;

		case "Senyan_PuertoRicoCave_1":
                                      NextDiag.CurrentNode = "Senyan_officer";
		DialogExit();  
		AddDialogExitQuestFunction("Gothic_SmithyPuertoRico_6");
		break;
