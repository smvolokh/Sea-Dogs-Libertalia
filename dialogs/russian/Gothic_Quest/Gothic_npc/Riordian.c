...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
	                     PlaySound("VOICE\Russian\gotica\RIORDIAN\DIA_ADDON_RIORDIAN_HALLO_15_00.wav");
		dialog.text = "...";
		link.l1 = "Чем ты занимаешься!";
		link.l1.go = "Riordian_1";			
		break;

		case "Riordian_1":
	                     PlaySound("VOICE\Russian\gotica\RIORDIAN\DIA_ADDON_RIORDIAN_HALLO_10_01.wav");
		dialog.text = "Я изучаю культуру древнего народа.";
		link.l1 = "...";
		link.l1.go = "Riordian_2";			
		break;

		case "Riordian_2":
	                     PlaySound("VOICE\Russian\gotica\RIORDIAN\DIA_ADDON_RIORDIAN_HALLO_10_02.wav");
		dialog.text = "Cудя по их записям они жили здесь в далёком прошлом.";
		link.l1 = "...";
		link.l1.go = "Riordian_3";			
		break;

		case "Riordian_3":
	                     PlaySound("VOICE\Russian\gotica\RIORDIAN\DIA_ADDON_RIORDIAN_HALLO_10_03.wav");
		dialog.text = "Я точно незнаю когда именно они возвели эти залы но уже в то время их цивелизация была достаточно высокоразвитой.";
		link.l1 = "...";
		link.l1.go = "exit";			
