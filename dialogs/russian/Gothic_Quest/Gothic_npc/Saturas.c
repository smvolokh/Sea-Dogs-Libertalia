...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
	                     PlaySound("VOICE\Russian\gotica\SATURAS\DIA_ADDON_SATURAS_HALLO_14_00.wav");
		dialog.text = "Ты спятил, ВОН...";
		link.l1 = "...";
		link.l1.go = "Saturas_1";			
		break;

		case "Saturas_1":
	                     PlaySound("VOICE\Russian\gotica\SATURAS\DIA_ADDON_SATURAS_HALLO_14_01.wav");
		dialog.text = "Под сводами этого места, слишком опасно для начинающего искателя приключений.";
		link.l1 = "...";
		link.l1.go = "Saturas_2";			
		break;

		case "Saturas_2":
	                     PlaySound("VOICE\Russian\gotica\SATURAS\DIA_ADDON_SATURAS_KEINEAHNUNG_15_00.wav");
		dialog.text = "...";
		link.l1 = "Понятия не имею, просто заглянул - нельзя!";
		link.l1.go = "exit";			
