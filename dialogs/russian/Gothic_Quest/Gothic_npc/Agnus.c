...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Agnus_1":
	                     PlaySound("VOICE\Russian\gotica\PIR\DIA_ADDON_PIR_6_CHEF_06_02.wav");
		dialog.text = "На месте Грега, я бы отправил Френсиса на болото.";
		link.l1 = "...";
		link.l1.go = "exit";			
