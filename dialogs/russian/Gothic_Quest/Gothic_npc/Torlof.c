...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
	                                   PlaySound("VOICE\Russian\gotica\TORLOF\DIA_TORLOF_DI_HALLO_15_00.wav");
			dialog.text = "...";
			link.l1 = "Всё спокойно?";
			link.l1.go = "Torlof_1";			
		break;

		case "Torlof_1":
	                                   PlaySound("VOICE\Russian\gotica\TORLOF\DIA_TORLOF_DI_HALLO_01_01.wav");
			dialog.text = "Пока да, но всё может измениться в одно мгновение - будь осторожен.";
			link.l1 = "...";
			link.l1.go = "Torlof_2";			
		break;

		case "Torlof_2":
	                                   PlaySound("VOICE\Russian\gotica\TORLOF\DIA_TORLOF_DI_HALLO_01_02.wav");
			dialog.text = "Если эти презренные орки будут оставаться там где они есть сейчас - я не вижу никакой проблемы.";
			link.l1 = "...";
			link.l1.go = "exit";			
