...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
	                     PlaySound("VOICE\Russian\gotica\NEFARIUS\DIA_ADDON_NEFARIUS_HALLO_15_00.wav");
		dialog.text = "...";
		link.l1 = "Как дела!";
		link.l1.go = "Nefarius_1";			
		break;

		case "Nefarius_1":
	                     PlaySound("VOICE\Russian\gotica\NEFARIUS\DIA_ADDON_NEFARIUS_HALLO_05_01.wav");
		dialog.text = "А, что ты здесь делаешь? Вот это сюрприз...";
		link.l1 = "...";
		link.l1.go = "Nefarius_2";			
		break;

		case "Nefarius_2":
	                     PlaySound("VOICE\Russian\gotica\NEFARIUS\DIA_ADDON_NEFARIUS_HALLO_05_02.wav");
		dialog.text = "Я думал ты погиб.";
		link.l1 = "...";
		link.l1.go = "Nefarius_3";			
		break;

		case "Nefarius_3":
	                     PlaySound("VOICE\Russian\gotica\NEFARIUS\DIA_ADDON_NEFARIUS_HALLO_15_03.wav");
		dialog.text = "...";
		link.l1 = "Почти.";
		link.l1.go = "Nefarius_4";			
		break;

		case "Nefarius_4":
	                     PlaySound("VOICE\Russian\gotica\NEFARIUS\DIA_ADDON_NEFARIUS_HALLO_05_04.wav");
		dialog.text = "Из-за тебя поднялся большой шум, ты знаешь об этом. Сатураса было не узнать, те события полностью вывели его из себя.";
		link.l1 = "...";
		link.l1.go = "exit";			
