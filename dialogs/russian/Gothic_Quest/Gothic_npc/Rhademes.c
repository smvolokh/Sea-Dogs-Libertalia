// Радемес сын предводителя Куарходрона
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Rhademes":
	                     PlaySound("VOICE\Russian\GOTHIC\QUARHODRON\DIA_ADDON_RHADEMES_DEINVATER_03_01.wav");
		dialog.text = "Куарходрон я всё ещё помню стук молотков на другой стороне ворот спустя столько времени.";
		link.l1 = "...";
		link.l1.go = "Rhademes_1";			
		break;

		case "Rhademes_1":
	                     PlaySound("VOICE\Russian\GOTHIC\QUARHODRON\DIA_ADDON_RHADEMES_DEINVATER_03_02.wav");
		dialog.text = "Меч отомстил мне, за то, что я не справился.";
		link.l1 = "...";
		link.l1.go = "Rhademes_2";			
		break;

		case "Rhademes_2":
	                     PlaySound("VOICE\Russian\GOTHIC\QUARHODRON\DIA_ADDON_RHADEMES_FIRST_03_00.wav");
		dialog.text = "Мой дух был заперт здесь целую вечность.";
		link.l1 = "...";
		link.l1.go = "Rhademes_3";			
		break;

		case "Rhademes_3":
	                     PlaySound("VOICE\Russian\GOTHIC\QUARHODRON\DIA_ADDON_RHADEMES_FIRST_03_01.wav");
		dialog.text = "Теперь я наконец - то свободен у меча новый хозяин.";
		link.l1 = "...";
		link.l1.go = "Rhademes_4";			
		break;

		case "Rhademes_4":
	                     PlaySound("VOICE\Russian\GOTHIC\QUARHODRON\DIA_ADDON_RHADEMES_FIRST_03_07.wav");
		dialog.text = "...";
		link.l1 = "...";
		link.l1.go = "exit";
		AddDialogExitQuest("GothicTempleRhademes");		
		break;
