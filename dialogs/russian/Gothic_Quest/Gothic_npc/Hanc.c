...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Hanc_1":
	                     PlaySound("VOICE\Russian\gotica\PIR\DIA_ADDON_PIR_7_HELLO_07_04.wav");
		dialog.text = "Френсис, который остался за главного всего лишь жалкий клоун, никто не воспринимает его всерьёз.";
		link.l1 = "...";
		link.l1.go = "exit";			
