...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
	                     PlaySound("VOICE\Russian\gotica\MALCOM\DIA_ADDON_MALCOM_HELLO_04_01.wav");
		dialog.text = "Ты не отсюда, верно!";
		link.l1 = "...";
		link.l1.go = "Malcom_1";			
		break;

		case "Malcom_1":
	                     PlaySound("VOICE\Russian\gotica\MALCOM\DIA_ADDON_MALCOM_HELLO_04_02.wav");
		dialog.text = "Похоже ты проделал дальний путь.";
		link.l1 = "...";
		link.l1.go = "Malcom_2";			
		break;

		case "Malcom_2":
	                     PlaySound("VOICE\Russian\gotica\MALCOM\DIA_ADDON_MALCOM_PERM_15_00.wav");
		dialog.text = "...";
