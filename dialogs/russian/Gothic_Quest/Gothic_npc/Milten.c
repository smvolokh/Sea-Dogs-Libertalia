...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
		dialog.text = "На самом интересном - обломал?";
		link.l1 = "Ну, пардон?";
		link.l1.go = "exit";
		...
		case "Milten_hallo_1":
	                   PlaySound("VOICE\Russian\gotica\MILTEN\DIA_MILTENOW_HELLO_03_00.wav");
	                  dialog.text = "Посмотрите кто вернулся, наш герой из - за барьера!";
		link.l1 = "";
		link.l1.go = "Milten_hallo_2";
		break;

		case "Milten_hallo_2":
	                   PlaySound("VOICE\Russian\gotica\MILTEN\DIA_MILTENOW_HELLO_YES_15_00.wav");
		dialog.text = "";
		link.l1 = "Рад видеть тебя Мильтон, ты всё ещё здесь или здесь опять...";
		link.l1.go = "Milten_End";
		break;
		...
		case "Milten_officer":
			...
			link.l2.go = "exit";
			NextDiag.TempNode = "Milten_officer";
		break;
	...
	// на Тайясаль
		case "tieyasal":
			...
			link.l1 = "Спасибо, Мильтон! Я рад" + GetSexPhrase("","а") + ", что не ошиб" + GetSexPhrase("ся","ась") + " в тебе.";
