...
// в таверне Сент - Луи
	...
	case "24":
        	...
        	link.l1 = "Я отправился в вашу резиденцию в Сан-Хуане, в поисках вас, мистер Смит, но вместо вас нашёл там вашу дочь. Она рассказала мне подробности вашей истории и попросила помочь вам. И вот я здесь.";
        	link.l1.go = "20 Exit";
	...
	case "27":
        	...
        	link.l3 = "Вы оба надоели мне, два чокнутых жадных торгаша! Думаю, я сделаю мир чище, если избавлю его от вас обоих. Ведь нет конфликтующих - не будет и конфликта, верно?";
        	link.l3.go = "Kill All";
...
//**************** КОНЦОВКА №4 - "МИРНОЕ" РЕШЕНИЕ КОНФЛИКТА *****************
 	...
 	case "34":
		...
		break;
 		...
 		case "35":
            	dialog.text = "" + PChar.name + " ... навестите меня через месяц в моей резиденции на Пуэрто-Рико… в Сан-Хуане... мне нужно будет сказать вам ещё кое-что...";
 	...
 	case "36":
		...
		CloseQuestHeader("Smithy");
		AddMoneyToCharacter(pchar, 700000);
		Log_SetStringToLog("700 000 монет");
// уточнить дом и локатор перехода из города
