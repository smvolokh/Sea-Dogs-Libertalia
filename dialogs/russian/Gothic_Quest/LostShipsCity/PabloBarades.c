	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			else
			{
				...
				if (pchar.questTemp.LSCC == "toSeekGoods" && CheckAttribute(pchar, "questTemp.LSCC.additional.knippels"))
				{
		...
		case "SeekCrew":
			...
			link.l1 = "Команду на мой воздушный шар. Предлагаю тебе уйти из Города со мной.";
		...
		case "SeekCrew_4":
			...
			link.l1 = "Отлично! Прямо сейчас отправляйся на 'Сан Габриэль', там Механик переправит тебя на воздушный шар.";
