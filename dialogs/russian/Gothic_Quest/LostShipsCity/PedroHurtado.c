...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "SeekCrew_1":
			dialog.text = ""+ GetSexPhrase("Дружище","" + pchar.name + "") +", у тебя что, действительно есть воздушный шар, на котором можно улететь отсюда?";
			link.l1 = "Да.";
			link.l1.go = "SeekCrew_2";
		break;
		case "SeekCrew_2":
			dialog.text = "Тогда и думать нечего! Я согласен.";
			link.l1 = "Отлично! Прямо сейчас отправляйся на 'Сан Габриэль', там Механик переправит тебя на мой воздушный шар.";
