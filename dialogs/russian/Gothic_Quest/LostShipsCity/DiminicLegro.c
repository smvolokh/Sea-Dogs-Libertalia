...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "SeekCrew":
			...
			link.l1 = "Понимаю. Но принимай решение быстро. Если ты согласен, то нужно прямо сейчас отравляться на мой воздушный шар.";
		...
		case "SeekCrew_2":
			...
			link.l1 = "Отлично. Сейчас отправляйся на 'Сан Габриэль', там Механик организует переправу на воздушный шар.";
