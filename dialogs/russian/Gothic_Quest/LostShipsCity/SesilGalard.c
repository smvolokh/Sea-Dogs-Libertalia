...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			if (pchar.questTemp.LSCC == "toKnowAboutMechanic")
			{
			...
			if (npchar.quest.meeting == "0")
			{
				...
				{
					if (npchar.location == "AvaShipInside33") dialog.text = "Приветствую вас в моей скромной обители, капитан. Как добрались в шторм?";
				...
				{
					if (npchar.location == "AvaShipInside33") dialog.text = "Приветствую вас в моей скромной обители, капитан. Как добрались?";
		...
		case "HelpMe_1":
			...
			link.l1.go = "exit";
			npchar.quest.meeting = "1";
			AddDialogExitQuestFunction("LSCC_SaveSesilGalard_2");		
		break;
