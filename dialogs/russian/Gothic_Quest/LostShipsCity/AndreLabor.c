	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			else
			{
				...
				link.l4 = "Ничего...";
				link.l4.go = "exit";
				if (pchar.questTemp.LSCC == "toAndreLabor")
				{
		...
		case "Tizer_5":
			...
			pchar.questTemp.LSCC = "toProtector";
			pchar.quest.LSCC_enterToProtector.win_condition.l1 = "location";
			pchar.quest.LSCC_enterToProtector.win_condition.l1.location = "ProtectorFisherr";
			pchar.quest.LSCC_enterToProtector.function = "LSCC_enterToProtector";
		break;
