...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			if (pchar.questTemp.LSCC == "SessilIsDead")
			{
			...
			if (npchar.quest.meeting == "0")
			{
				...
				{
					if (npchar.location == "FurieShipInside22") dialog.text = "Боже мой, какой шторм!.. Здравствуйте, меня зовут " + GetFullName(npchar) + ", я хозяйка этого дома.";
				...
				{
					if (npchar.location == "FurieShipInside22") dialog.text = "Здравствуйте, меня зовут " + GetFullName(npchar) + ", я хозяйка этого дома.";
		...
		case "SessilDead_7":
			...
			link.l1 = "Спасибо.";
			link.l1.go = "exit";
			pchar.questTemp.LSCC = "toSeekMechanik";
			AddQuestRecord("ISS_MainLine", "32");
			pchar.quest.LSCC_enterCasper.win_condition.l1 = "location";
			pchar.quest.LSCC_enterCasper.win_condition.l1.location = "SanGabrielMechanicc";
			pchar.quest.LSCC_enterCasper.function = "LSCC_enterCasper"; 
		...
		case "SeekGoods_3":
			...
			link.l1.go = "exit";
			pchar.questTemp.LSCC.additional.knippels = true;
			AddQuestRecord("ISS_MainLine", "51");
		break;
		//найм команды
		case "SeekCrew":
			dialog.text = "Вот как? Интересно... У вас действительно есть воздушный шар?";
			link.l1 = "Да.";
			link.l1.go = "SeekCrew_1";
		break;
		case "SeekCrew_1":
			dialog.text = "И он в хорошем состоянии? Мы долетим до Большой земли?";
			link.l1 = "Непременно.";
			link.l1.go = "SeekCrew_2";
		break;
		case "SeekCrew_2":
			dialog.text = "Тогда я согласна.";
			link.l1 = "Хорошо. Сейчас как можно быстрей отправляйтесь на 'Сан Габриэль'. Хенрик Ведекер переправит вас на мой воздушный шар.";
