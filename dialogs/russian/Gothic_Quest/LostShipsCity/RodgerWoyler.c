...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "SeekCrew":
			...
			link.l1 ="Команду на мой воздушный шар. Предлагаю вам пойти ко мне в матросы.";
			link.l1.go = "SeekCrew_1";
		break;
		case "SeekCrew_1":
			dialog.text = "Вы шутите?";
			link.l1 = "Нет. У меня действительно есть воздушный шар, готовый к отлёту. Я жду вашего решения.";
