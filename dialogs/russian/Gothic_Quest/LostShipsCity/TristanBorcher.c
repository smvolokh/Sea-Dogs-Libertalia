...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "int_quests":
			...
			if (!CheckAttribute(NextDiag, NodeName+".l4") && pchar.questTemp.LSCC == "toSeekOldCitizen")
			{
		...
		case "SeekCrew":
			...
			link.l1 ="Не совсем так, на воздушный шар...";
			link.l1.go = "SeekCrew_1";
		break;
		case "SeekCrew_1":
			dialog.text = "И у вас действительно есть воздушный шар?";
			link.l1 = "Да, у меня есть воздушный шар, подготовленный к полёту.";
			link.l1.go = "SeekCrew_2";
		break;
		case "SeekCrew_2":
			dialog.text = "Я хочу улететь отсюда вместе с вами. Что я должен делать?";
			link.l1 = "Немедленно отправляйтесь на 'Сан Габриэль'. Хенрик Ведекер переправит вас на воздушный шар.";
