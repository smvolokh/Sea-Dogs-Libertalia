...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "SeekCrew":
			...
			link.l1 ="Я предлагаю вам уплыть из Города на Большую землю в составе команды моего воздушного шара.";
			link.l1.go = "SeekCrew_1";
		break;
		case "SeekCrew_1":
			dialog.text = "Вот это предложение! И у вас что, действительно есть воздушный шар?";
			link.l1 = "Да, есть.";
			link.l1.go = "SeekCrew_2";
		break;
		case "SeekCrew_2":
			dialog.text = "Ну что же, тут и думать нечего. Я ухожу с вами.";
			link.l1 = "Прекрасно. Сейчас отправляйтесь на 'Сан Габриэль'. Хенрик Ведекер переправит вас на мой воздушный шар.";
