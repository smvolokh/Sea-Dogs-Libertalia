	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			else
			{
				...
				if (pchar.questTemp.LSCC == "toSeekGoods" && CheckAttribute(pchar, "questTemp.LSCC.additional.balls"))
				{
		...
		case "SeekCrew_1":
			...
			link.l1 = "Прямо сейчас отправляйтесь на 'Сан Габриэль', там Механик организует переправу на воздушный шар.";
