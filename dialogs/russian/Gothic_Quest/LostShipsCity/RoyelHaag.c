...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "FT_5":
			...
			link.l1.go = "FT_6";
			AddQuestRecord("LSCC_findDekster", "2");	
			AddQuestUserData("LSCC_findDekster", "sSex", GetSexPhrase("","а"));
			AddQuestUserData("LSCC_findDekster", "sSex1", GetSexPhrase("ен","на"));
		break;
		case "FT_6":
		...
		case "SeekCrew":
			...
			link.l1 ="Я предлагаю вам пойти ко мне матросом на мой воздушный шар. В скором времени я отчаливаю.";
		...
		case "SeekCrew_2":
			...
			link.l1 = "Хорошо! Тогда немедленно отправляйтесь на 'Сан Габриэль'. Механик переправит вас на мой воздушный шар.";
