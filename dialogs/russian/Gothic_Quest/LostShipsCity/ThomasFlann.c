...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "SeekCrew":
			...
			link.l1 ="Ни в коей мере. У меня есть воздушный шар и я приглашаю тебя в команду.";
		...
		case "SeekCrew_2":
			...
			link.l1 = "Отлично! Сейчас, немедленно отправляйся на 'Сан Габриэль'. Механик переправит тебя на мой воздушный шар.";
