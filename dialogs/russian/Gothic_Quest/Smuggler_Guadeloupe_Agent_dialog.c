...
////////////////////////////////////////////////////////	
		...
		case "pirateStartQuest_Smuggler_4":
			pchar.questTemp.pirateStartQuest.Shore = "Shore38";
			dialog.text = "Ладно. Приходи с деньгами в место под названием пляж Ламантен, там и потолкуем...";
			...
			pchar.quest.pirateStartQuest_Smuggler_fc2.win_condition.l1.location = "Shore38";
...
//navy <--
			...
			else
			{
                if (npchar.quest.trade_date != lastspeak_date)
    			{
                    ...
                    {
                        Pchar.quest.contraband.CurrentPlace = "Mayak4";
                        ...
                        if (Pchar.quest.contraband.CurrentPlace != "None")//boal fix
                        {
                            ...
                            {
                                Dialog.Text = "Я знаю, с тобой можно иметь дело. Мы будем ждать тебя на маяке Гваделупы.";
                            }
                            else
                            {
            				    Dialog.Text = "Хм... Возможно, покупатель и найдется. Мы будем ждать вас в месте, называющемся маяк Гваделупы.";
            				}
