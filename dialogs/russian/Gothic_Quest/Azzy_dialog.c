	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Step_21":
        	dialog.text = "Деньгами я тебя обеспечу. Но дам тебе их не я.\n"+
                          "В городе Капстервиль подойдешь к ростовщику, его зовут " + GetFullName(characterFromId("Charles_usurer")) + ". Скажешь ему, что он должен тебе три миллиона и немедленно получишь все сумму целиком.";
		...
		case "Step_43":
        	dialog.text = "И это правильно, так как небезопасно для тебя.\n"+
                          ...
                          "А вообще, советую тебе посетить верфь на Исла-Тесоро, заправляет там Мастер, он местные парусники доводит до ума.";
