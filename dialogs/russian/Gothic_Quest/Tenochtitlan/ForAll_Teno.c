...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Shore53":
 	                                PlaySound("VOICE\Russian\GOTHIC\RENGARU_03.wav");
			pchar.defaultanimation = pchar.model.animation;
			dialog.text = "ПОМОГИТЕ, уходите отсюда! Уплывайте немедленно!";
			link.l1 = "В чем дело?";
		...
		case "Shore53_10":
			...
			dialog.text = "Ну, дело ваше, черт, я сваливаю от сюда. Прощайте, сеньор"+ GetSexPhrase("","ита") +"!";
			link.l1 = "Прощай...";
			link.l1.go = "exit";
			AddDialogExitQuestFunction("Tenoc_startInShore_2");
		                  DoQuestCheckDelay("Tenoc_Portal", 10.5);
		break;
	}
}
