...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			link.l1.go = "FT_1";	
			if (pchar.questTemp.Tenoc == "takeFire")
			{
		...
		break;
		case "FT_24":
			dialog.text = "Тотем Камаштли недалеко в джунглях, в траве. Тотем Тласолтеотль находится на жемчужном берегу великого Южного Моря в заливе попугаев. А тотем Тонатиу заброшен в джунгли между двумя испанскими городами, что расположены на перешейке между континентами.";
		...
		case "FT_25":
			...
			AddDialogExitQuestFunction("Tenoc_MontesumaGoQuest1");
		break;
		//--------------
		case "FTS_1":
			dialog.text = "Да, я ацтек, ты угадал"+ GetSexPhrase("","а") +". Меня зовут Монтесума. А как я могу называть тебя?";
		...
		case "Fire_7":
			...
			pchar.questTemp.Tenoc = "openTenTemples";
        ...
        //после драки с 
		case "AfterGTemple":
			if (CheckCharacterItem(pchar, "SkullAztecs")) //череп найден
			{
		...
		case "Skull_7":
			...
			LocatorReloadEnterDisable("Tenochtitlan_1", "reload1_back", false);
			...
			pchar.quest.Tenoc_clearGroups.win_condition.l1 = "ExitFromLocation";
			pchar.quest.Tenoc_clearGroups.win_condition.l1.location = pchar.location;
			pchar.quest.Tenoc_clearGroups.function = "Tenoc_clearGroups";
			NextDiag.CurrentNode = NextDiag.TempNode;
			DialogExit();
