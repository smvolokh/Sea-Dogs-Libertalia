...
//navy <--
			...
			else
			{
                if (npchar.quest.trade_date != lastspeak_date)
    			{
                    ...
                    {
                        Pchar.quest.contraband.CurrentPlace = "Shore45";
                        ...
                        if (Pchar.quest.contraband.CurrentPlace != "None")//boal fix
                        {
                            ...
                            {
                                Dialog.Text = "Я знаю, с тобой можно иметь дело. Мы будем ждать тебя на пляже Фахардо.";
                            }
                            else
                            {
            				    Dialog.Text = "Хм... Возможно, покупатель и найдется. Мы будем ждать вас в месте, называющемся пляж Фахардо.";
            				}
