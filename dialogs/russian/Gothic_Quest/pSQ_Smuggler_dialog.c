void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "pirateStartQuest_Smuggler3_2":
			...
			link.l2 = "Не торопись приятель, сдается мне, что этот товар со шхуны 'Грифон'. Живо говори, кто информатор.";
			link.l2.go = "pirateStartQuest_Smuggler3_5";
			GiveItem2Character(npchar, "spyglass2");
		...
		case "pirateStartQuest_Smuggler3_3":
			...
			link.l1 = "Не торопись, приятель, сдается мне, что этот товар со шхуны 'Грифон'. Хочешь получить вторую половину - говори, кто информатор.";
			link.l1.go = "pirateStartQuest_Smuggler3_5";
			AddMoneyToCharacter(pchar, -15000);
			AddMoneyToCharacter(npchar, 15000);
			AddCharacterGoods(pchar, GOOD_SLAVES, 100);
			AddQuestUserData("pSQ", "sText", "О рабах моему работодателю знать не обязательно, не напрасно же я выложил"+ GetSexPhrase("","а") +" за них 15 000 песо.");
		break;
