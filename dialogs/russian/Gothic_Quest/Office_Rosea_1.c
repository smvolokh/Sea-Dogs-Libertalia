...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "W_officer":
				...
				link.l2 = "К сожалению, мне некогда, " + npchar.name + ". Как-нибудь в другой раз...";
				link.l2.go = "exit1";
				break;
		...
		// патент
		case "patent":
			dialog.text = "Допустим, что слухи Вас не обманули.";
			link.l1 = "В таком случае я хочу у Вас приобрести французский каперский патент.";
			link.l1.go = "patent_1";
		break;

		case "patent_1":
			dialog.text = "Хотите постпупить на службу? Хорошо... Друзья и враги Франции станут вашими. Вы сможете топить корабли врагов. А сам патент обойдется Вам всего лишь в 100 000 песо.";
		...
		break;
			...
			case "patent_2":
		dialog.text = "Добро пожаловать на службу Франции, капитан "+GetFullName(pchar)+"!";
			link.l1 = "Благодарю!";
			link.l1.go = "exit";
		...
		case "No_money":
		dialog.text = "Хорошо! Обратитесь ко мне, когда у Вас будет нужная сумма.";
			link.l1 = "Обязательно!";
			link.l1.go = "exit";
		break;
	...
	case "flags":
			dialog.text = "Хм, для торговых целей? Ладно, допустим. Для судов Компании мы часто шьём флаги других стран, чтобы корабли могли беспрепятственно заходить в порт другой державы. Флаг какого государства Вам необоходим?";
			link.l1 = "Англии.";
			link.l1.go = "England";
			link.l2 = "Франции.";
			link.l2.go = "France";
