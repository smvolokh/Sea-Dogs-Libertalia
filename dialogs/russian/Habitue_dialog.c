...
void ProcessDialogEvent()
{
	...
	switch (Dialog.CurrentNode)
	{
		...
		case "trial_spy_1":
			dialog.text = "А кто же его ведает! Но скажу тебе так, дружище: я лично уверен, что его интересовал галеон 'Алакантара'. Ик! Вот руку на отсечение даю! Этот корабль снаряжает сам сеньор губернатор, так что целью этого прохвоста наверняка был сбор информации об этом судне.";
		...
		break;
			...
			dialog.text = "Вы слышали недавно вскрыли банк Порт - Рояла, всё под чистую выгребли!";
			link.l1 = "Вот это да! Банк Порт - Рояла взяли, во дела!";
			link.l1.go = "RevengeCorsair_Tavern_2";
			break;
			
			case "RevengeCorsair_Tavern_2":
			dialog.text = "И это под носом у Моргана! Ох если узнает Морган кто это сделал.... Отчаянные ребята, я так скажу, они уже покойники...";
			link.l1 = "Порт - Роял... Вот это да! Ладно, мне пора. Спасибо за рассказ!";
			link.l1.go = "exit_sit";
	...
	else
	{
		...
		case "sit_case_61": // откуп
			dialog.text = "Нет-нет, мне не нужно проблем! Возьмите 1000 песо и оставьте меня в покое, прошу вас.";
