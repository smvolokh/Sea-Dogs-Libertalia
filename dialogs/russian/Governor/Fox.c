...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			{
				dialog.text = "Что вы хотели, сударь? Хм... Постойте! Кажется, я понимаю: вы тот самый капитан, который вытащил мою дочь из лап прихвостней проклятого мерзавца Левассера!";
			...
			{
				dialog.text = "Как я понимаю, вы - тот самый капитан, который помог моим людям выполнить задание на Синт-Маартене? "+TimeGreeting()+"!";
		...
		case "terrapin":
			dialog.text = "И не один раз, капитан! Вы совершили поступок, который трудно было ожидать от корсара. Я действительно вам крайне признателен, и как солдат, и как отец. Дороже дочери для меня нет ничего на свете...";
			link.l1 = "Я рад, что все закончилось хорошо. Надеюсь, вы теперь измените свое мнение о корсарах.";
			link.l1.go = "terrapin_1";
		break;
		
		case "terrapin_1":
			dialog.text = "Одно то, что среди них есть такой благородный джентльмен, как вы, рискнувший жизнью ради спасения совершенно незнакомой вам английской девушки, и не искавший корыстных целей в этом, вызовет существенное потепление в моем отношении к вашим коллегам!";
			link.l1 = "Хорошие люди, как и мерзавцы, есть среди любой профессии, полковник...";
		...
		// Addon-2016 Jason, французские миниквесты (ФМК) Сент-Кристофер
		case "FMQN":
			dialog.text = "Я прочитал доклад. Ваши действия оценены весьма высоко, и вы должны получить награду. Таким образом, вам полагается тридцать тысяч песо наличными за экседиционные услуги, и хорошее оружие - за проявленный солдатский героизм. Вот этот клинок и трофейный дондербасс теперь ваши. Получите!";
			link.l1 = "Спасибо, сэр.";
			link.l1.go = "FMQN_1";
		break;
