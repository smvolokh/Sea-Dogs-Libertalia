...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
 	switch(Dialog.CurrentNode)
	{
        case "quests":
			...
			{
				link.l1 = "Офицер, я тут узнал, что у вас в тюрьме содержится человек по имени Алехандро Пистолето. Можно ли было бы как-нибудь поспособствовать его освобождению?";
                link.l1.go = "Sharlie";
			}
			if (CheckAttribute(pchar, "questTemp.Sharlie") && pchar.questTemp.Sharlie == "freeskiper")
			{
				link.l1 = "Офицер, я снова по поводу заключенного Алехандро Пистолето. Я купил право на его долг у ростовщика, и теперь хочу, чтобы этого человека передали мне. Вот его долговые бумаги, ознакомьтесь.";
		...
		case "Sharlie_4":
			dialog.text = "Хорошо, месье. Я не вижу причин вам отказывать. Пистолето сейчас приведут. Но я считаю своим долгом предупредить вас, что этот лис ускользнет от вас при первой же возможности, так что не питайте на его счет никаких иллюзий. Он же у нас новый пират...";
			link.l1 = "Я учту это, офицер. А теперь я бы хотел забрать своего должника.";
			link.l1.go = "Sharlie_5";
		break;
		
		case "Sharlie_5":
			dialog.text = "Да, конечно. Сержант! Привести сюда заключенного Алехандро Пистолето!";
			link.l1 = "...";
