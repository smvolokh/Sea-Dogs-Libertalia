			...
			if (CheckAttribute(pchar, "questTemp.Mtraxx") && pchar.questTemp.Mtraxx == "silk_13" && pchar.location == "PortRoyal_shipyard")
			{
			 ...
			 if (rand(3) <= 2)
			  {		
			    ...
			    {
                dialog.text = "Так-так. Кажется Вы, уважаемый, находитесь в розыске. И за вашу голову объявлена награда. Поэтому я откажу вам  в обслуживании и вызову стражу. Стража, сюда! А я пока тебя задержу!";
...
//--> -------------------------------------------Бремя гасконца---------------------------------------------------
		case "Sharlie":
			...
			link.l1 = "Это очень странно, так как мне сказали, что у вас на верфи сейчас есть новый гафельный шлюп.";
		...
		case "Sharlie_1":
			...
			{
				dialog.text = "Вы это сейчас наверное про гафельный шлюп, за который внес залог в три тысячи песо Мишель де Монпе? Так этот корабль уже продан, потому что согласно договору, полная сумма должна была быть выплачена не позднее, чем за неделю после спуска корабля на воду\nВсе сроки прошли, денег я так и не увидел, поэтому гафельный шлюп был продан. Так что не обессудьте, сударь.";
		...
		case "Sharlie_7":
			dialog.text = "Тогда смотрите. Недавно я приобрел по сходной цене лёгкий шлюп. Это бывшая пиратская посудина, ее прежних владельцев уже благополучно вздернули за многочисленные пригрешения. Корабль, прямо скажу, не ах, да и поврежден прилично, но в море выйти сможет\nМне некогда им сейчас заниматься - все мои работники заняты постройкой под заказ брига, так что можете купить его у меня в том состоянии, в каком он есть. Учитывая сказанное, уступлю дешевле обычного - пятнадцать тысяч песо, и это вместе с содержимым трюма.";
