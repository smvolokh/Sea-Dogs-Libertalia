...
//-------------------------------Джимми в доме в Саванне-ла-Мар------------------------------------
		case "Jimmy":
		...
		case "Jimmy_1_2":
			...
			link.l1 = "Да это же я, "+pchar.name+"! Славно мы посидели с тобой в Блуфилдс после того, как ты чуть было не вспорол брюхо этому наглецу в мундире. Как его звали, кстати? Вылетело из головы... Попадется он мне в море, не посмотрю на пушки его корвета!";
			link.l1.go = "Jimmy_2";
		break;
...
//-------------------------------------------корвет Донована, абордаж-----------------------------------------
		...
		case "Donovan_abordage_1":
			...
			link.l1 = "Не дури, Донован. Ты прекрасно понимаешь, о ком я говорю. Где девушка? Где Элиза, я тебя спрашиваю?";
			link.l1.go = "Donovan_abordage_2";
		break;
		
		case "Donovan_abordage_2":
			dialog.text = "Элиза? На моем судне нет портовых шлюх, гнусное отродье!";
...
//----------------------------------------поиск Энрике Гонсалеса, Картахена----------------------------------
		...
		case "GonsalesA":
			...
			link.l2 = "Меня зовут "+GetFullName(pchar)+". Я разыскиваю сына сeньоры Гонзалес Энрике по просьбе ее старого друга. Мне кажется, что это вы...";
		...
		case "Ortega_5":
			dialog.text = "Ничего. Я должен был показать ей перстень Бучера. По нему она признала бы меня, как гонца от капитана. А еще я должен был передать ей сундук с золотыми дублонами на содержание крошки. Чтобы забрать этот перстень у одного негодяя, мне пришлось его убить.Из-за этого я задержался на Антигуа на целый месяц\nА когда наконец добрался до Белиза Глэдис и след простыл, а город лежал в руинах после набега испанцев. Она успела продать свой дом и укатила куда-то вместе с новым хахалем, прихватив малютку Элизу с собой. Надеюсь, она позаботилась о ней, а не продала цыганам или в бордель на забаву.";
			link.l1 = "Дочь Бучера звали Элиза?";
			link.l1.go = "Ortega_6";
		break;
...
//----------------------------------------НПС по квесту Искушение Барбазона----------------------------------
		...
		case "vensan":
			...
			{
				dialog.text = "Барон "+pchar.name+"? Что ты здесь делаешь? А-аргх, три тысячи чертей, я понял! Это ты все затеял!";
