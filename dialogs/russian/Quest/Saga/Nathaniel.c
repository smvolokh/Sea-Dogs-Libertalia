// Натаниэль Хоук - пиратский барон Саванны-ла-Мар
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "diffindoor_9":
			...
			link.l1 = "Честно говоря, подробностей дела я не знаю, но уверен, что за всем стоит Джекман. Слишком много совпадений: сначала Блейз, потом ты... Джекман рвется к власти и устраняет всех, кто стоит у него на пути. Сейчас он возглавляет Саванну-ла-Мар, вместо тебя.";
		...
		case "diffindoor_13":
			...
			link.l1 = "Все будет хорошо, Натан. У нас со Свенсоном большие планы, и ты играешь в них одну из ключевых ролей. Тебе следует вернуться на свое место в Саванну-ла-Мар, а о подлеце Джекмане мы позаботимся.";
			link.l1.go = "diffindoor_14";
		break;
		
		case "diffindoor_14":
			dialog.text = "В Саванну-ла-Мар? И как ты себе это представляешь, парень? Посмотри на меня: пропитанная ромом развалина! Куда уж мне... Нет, годы моего правления Саванны-ла-Мар ушли навсегда и безвозвратно. Я заперт на этом проклятом кладбище кораблей, и, видно, навеки. Сколько я еще протяну? Месяц, два, год?\nА потом так и останусь лежать на этих гнилых досках, а Оле спустит то, что останется от Натаниэля Хоука, в море. Но что меня больше всего угнетает, так это то, что я больше никогда не увижу свою Данни. Эх, все кончено, приятель.";
		...
		case "story_20":
			dialog.text = "Он нигде не обозначен и находится на востоке Карибского моря. Его карта валяется у меня где-то в Саванне-ла-Мар, а туда мне теперь не добраться. Да и честно скажу - не вернусь я на этот проклятый остров никогда.";
		...
		case "caleuche_3":
			dialog.text = "Ох... Я не могу тебе отказать, дружище, но... ты не представляешь, что мы там с Данни пережили! Хаэль Роа находится севернее Сент-Кристофера, а его карту я нашел сразу по возвращении в Саванну-ла-Мар, она вот тут... (смотрит) Итак, координаты: 19 градусов 25 минут северной широты, 62 градуса 8 минут западной долготы.";
