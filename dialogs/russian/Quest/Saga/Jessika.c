...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "exit_talk_3":
			...
			link.l1 = "Гм. Мне очень не нравятся твои кровожадные намерения в отношении Элизы. Не смей ее трогать. В конце концов, она не несет ответ за свою мать.";
		...
		case "exit_talk_6":
			...
			link.l1 = "Ох, он будет очень рад. Могу представить. Ладно, подведем итоги: ты обещаешь, что никто тебя не увидит - раз, что ты не тронешь мою команду - два, что ты забудешь даже думать про Элизу - три, отдашь мне то, что я ищу - четыре, и вылечишь от своего колдовства - пять. Так?";
