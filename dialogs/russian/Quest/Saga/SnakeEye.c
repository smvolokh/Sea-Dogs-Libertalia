...
void ProcessDialogEvent()
{
	...
	//---------------------------------------- первая встреча------------------------------------------------
		...
		case "calendar_19":
			dialog.text = "Сказать. Это большой друг индеец мискито, жить в поселении Блуфилдс. Его звать Лесной Дьявол. Я знать его, ты тоже должен знать его.";
