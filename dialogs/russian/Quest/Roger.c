...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Mtr_officer_9":
			...
			SetFunctionTimerCondition("Mtraxx_TimeclearGulf", 0, 0, 30, false); // таймер
		...
		case "Jeffry_7":
			...
			SetFunctionTimerCondition("Mtraxx_SilkTimeOver", 0, 0, 121, false); // таймер
		break;
		...
		case "Jeffry_15":
            dialog.text = "Хо, кого я вижу! Да это же хитрюга "+pchar.name+" Барон собственной персоной! Здорово-здорово!";
			link.l1 = "Ха, Лысый Джеффри! Привет, приятель. "+pchar.name+" Барон? Хех!..";
			link.l1.go = "Jeffry_15x";
		break;
		
		case "Jeffry_15x":
            dialog.text = "Что, впервой услышал свое второе имя? Так тебя теперь кличут в Ла Веге.";
			link.l1 = "Ну, "+pchar.name+" - понятно, а почему 'Барон'?";
			link.l1.go = "Jeffry_15y";
		break;
		
		case "Jeffry_15y":
            dialog.text = "Да задатки руководителя у тебя, что надо. Распоряжаешься всем как хозяин, как Барон, ха-ха-ха!.. Как поживаешь? К Паскуале заходил? Затарился в рейс у этого четырехглазого пройдохи?";
		...
		case "Jeffry_18":
            dialog.text = "Эй-эй-эй! Барон, ты это... не горячись. Четырехглазый - свой человек, и если ты надумаешь его грабануть - проблемы от Маркуса тебе обеспечены. Скажи, это ведь Тиракс отправил тебя к Вуазье, так?";
			link.l1 = "Гм. Ну да...";
		...
		case "Jeffry_22":
            dialog.text = "Хо, Барон! А я-то недоумеваю: кто тут в джунглях фейерверк устроил! Грешным делом подумал на испанцев - целый отряд мушкетеров с собой взял.";
		...
		case "Jeffry_25":
            dialog.text = "Нет. На Барбадосе. Барон, ты что так взволновался?";
		...
		case "Jeffry_27":
            dialog.text = "Хех... Барон, да не ломай ты голову. Пошли сокровища искать.";
		...
		case "Jeffry_31":
            dialog.text = "Ну так и что ты паришься, Барон? Вот если бы их не было - был бы другой разговор. Пошли, показывай, как пройти. Посмотрим, что там за решетка.";
			link.l1 = "Ладно... Идем.";
			link.l1.go = "exit";
		...
		case "Jeffry_32":
            dialog.text = "Да, есть на что посмотреть! Целая куча золота! Было от чего Тесаку голову потерять... Нам здорово повезло, Барон! Как думаешь - сколько здесь?";
		...
		case "Billy_5":
            dialog.text = "Э-э, кэп, старому Билли вход в Порт-Ройяль заказан. Меня слишком хорошо там помнят, и мне совсем не хочется сушиться на солнышке на пирсе или на каменной арке среди рифов. Так что, сынок, жду от тебя новенький баркас в бухте Блэк-Ривера. И шелк не забудь! Ждать тебя я буду три дня, считая сегодняшний. Если не придешь послезавтра до полуночи - я отчаливаю.";
		...
		case "Mtr_acceptor_5_5":
            dialog.text = "Хорошо. Давай попробуем с ним договориться. Условия такие: партия шелка в сто рулонов, привозить сюда... нет, лучше в бухту Блэк-Ривер, там безопаснее, каждый месяц между 10 и 15 числом, ночью. Пароль - 'Лионский купец'.";
		...
		case "Mtr_acceptor_7_9":
            dialog.text = "Не переживай, мы люди честные. Условия сделки такие: партия шелка в сто рулонов, привозить сюда... нет, лучше в бухту Блэк-Ривер - там безопаснее, каждый месяц между 10 и 15 числом, ночью. Пароль - 'Лионский купец'.";
		...
		case "Pelly_23":
            dialog.text = "Хо! Здорово, Барон. Какими ветрами на Тортуге?";
		...
		case "Pelly_27":
            dialog.text = "И тебе того же, Барон.";
			link.l1 = "...";
			link.l1.go = "exit";
		...
		case "Pelly_28":
            dialog.text = "Отыскал трех птичек, Барон. Прятались в шкафах и под кроватью. Хороши милашки, как считаешь? Ха-ха-ха?!";
		...
		case "Pelly_30":
            dialog.text = "Алле хагель! Какого дьявола ты тут шаришься, Барон?";
		...
		case "Pelly_33":
            dialog.text = "Тебе всегда достается больше всех, Барон! Но в этот раз ты просчитался - я не уступлю ни дублона. Только не в этот раз! Сокровища принадлежат мне по праву первого!";
		...
		case "Pelly_34":
            dialog.text = "Ты хочешь меня облапошить, Барон? Как бы не так! Я не отдам тебе ни монеты, ни единой гинеи! Ты опоздал!\nА-а, я понимаю, что ты задумал! Разрази тебя гром, тебе это не удастся!!";
			link.l1 = "...";
			link.l1.go = "exit";
		...
		case "rocur_9":
			...
			link.l1 = "Мой корабль, корсарская шхуна и люди Тесака Пелли. Мое судно в порту Маракайбо, Тесак Пелли высадился в бухте Гуахира и разбил лагерь.";
			link.l1.go = "rocur_10";
		break;
		...
		case "rocur_19":
			...
			SetFunctionTimerCondition("Mtraxx_SeekWeaponOver", 0, 0, 300, false); // таймер
		break;
		...
		case "rocur_22":
			...
			link.l1 = "Согласен. Выберу какой-то один тип. Кофе, ваниль, копра, чай говоришь?";
			link.l1.go = "rocur_23";
		break;
		...
		case "rocur_53":
			...
			link.l1 = "Маркус дал мне месяц.";
			link.l1.go = "rocur_54";
		break;
		
		case "rocur_54":
            dialog.text = "Постарайся обернуться за три недели. Я тут подумаю немного... Приходи ровно через четырнадцать дней в бухту Гонаив, это на запад отсюда. Я буду ждать тебя там. Только не суйся в Ла Вегу, иди сразу.";
		...
		case "rocur_56":
			...
			SetFunctionTimerCondition("Mtraxx_PasqualeJanTimer", 0, 0, 14, false); // правки прогона 3
		...
		case "rocur_81":
            dialog.text = "Будешь возить ее на корабле? Не смеши! Она сбежит при первом удобном случае, а дальше - сам знаешь. Зачем она тебе сдалась?";
		...
		case "lepricon_1":
            dialog.text = "Позволь прежде дать старому буканьеру пару советов, кэп. Раз мы идем в сельву - значит, как пить дать, встретимся с краснокожими. Возьми с собой вещички, которые могут их заинтересовать, на обмен или в подарок. Индейские воины обычно приходят в восторг от красивых пистолей, таких как бретерский, даже если и не умеют из него стрелять. Еще они восхищаются приборами, например - компасом или подзорной трубой, так как считают, что они заколдованы магией белых\nДля их женщин хороши незатейливые украшения да всякая чепуха, вроде зеркалец и гребешков. Еще касательно огнестрельного оружия на случай схватки с краснокожими: лучше использовать картечницы, тромбоны, аркебузы, дондербассы, трабукко и разного рода мушкетоны: картечь весьма эффективно действует на толпы не защищенных кирасами и кожаными жилетами индейцев.";
		...
		case "lepricon_5x":
		  ...
		  // LocatorReloadEnterDisable("Shore106", "boat", false); 
		   ...
		   SetFunctionTimerCondition("Mtraxx_MeridaPotionLate", 0, 0, 300, false); // таймер, чтобы не ходил долго
		break;
		...
		case "lepricon_13":
            dialog.text = "Итак, как я понимаю - подельнички перегрызлись. Не смогли поделить добычу, не так ли, "+pchar.name+" Барон?";
		...
		case "lepricon_17":
            dialog.text = "Буду с тобой откровенным, Барон: ты никогда мне не нравился. Потому что ты выскочка. Ты просто наглый, распущенный юнец, любитель вина и падших женщин, провернувший под началом Тиракса несколько удачных прибыльных дел и вообразивший себя великим пиратом\nКроме того, в тебе видны задатки мясника. Неужели ты думаешь, что дикие бесчинства твоей команды в Картахене придали тебе веса среди берегового братства? Только среди таких же отморозков, как ты сам.";
		...
		case "shipstock":
			if (sti(npchar.portman) == 50) // krizis 50 кораблей - МАХ... По моему это уже как бесконечность :D Можно, конечно и 999 поставить, но задолбаетесь листать строчки диалога хD
			{
				dialog.text = "Кэп, на приколе уже стоит пятьдесят твоих кораблей. Окстись! Больше нет места."; // // krizis диалог про 50 кораблей(максимум был 2 корабля. Второго и ниже класса)
		...
		case "ShipStock_2":
			...
			/*if (sti(RealShips[sti(chref.Ship.Type)].Class) < 2) // krizis не нужно нам говорить про класс, ставим - что хотим
			{
			...
			/*if (sti(chref.Ship.Crew.Quantity) > 0) // krizis команду не куда девать? 50 кораблей? Да ладно, всё будет нормально. Команда(вроде) должна оставаться на местах
			{
		...
		case "mirabelle_19":
			...
			link.l1 = "Рад, что ты оказалась такой покладистой. Надеюсь, не притворяешься. Если же хитришь - пожалеешь об этом. Будешь хорошей девочкой и не станешь меня огорчать - буду с тобой ласков, обещаю. "+pchar.name+" Барон слов на ветер не бросает!";
		...
		case "mirabelle_20":
			...
			link.l1 = "Хех, а ты забавная, крошка... И мордашка у тебя ничего такая. Надеюсь, все остальное тоже на месте... Ну, теперь покажи своему капитану, что ты умеешь. Расслабимся с тобой на пару часов после морской качки.";
		...
		case "mirabelle_26":
			...
			link.l1 = RandSwear()+""+LinkRandPhrase("Ветер качает повешенных и разносит звон цепей, ха-ха!","Пятнадцать человек на сундук мертвеца! Йо-хо-хо, и бутылка рома!","Все семьдесят пять не вернулись домой - они потонули в пучине морской!")+" У "+pchar.name+" Барона все отлично, крошка.";
		...
		case "mirabelle_37":
            dialog.text = "Дорогой милый сеньор, спасибо! Я никогда не стану просить вас об этом - я хочу остаться пленницей этого острова и вашей пленницей, хи-хи... Вы такой добрый и такой грустный сегодня! Не поете песен, не ругаетесь, как обычно, а где ваш друг Жан, он такой грозный.";
			link.l1 = "Больше не будет ни песен, ни ругательств, Мирабель. Прости, что был груб с тобой раньше. Жан Пикар! К сожалению его я больше не увижу, он отбыл в Европу, а почему ты спрасила о нём? Понравился, да...";
			link.l1.go = "mirabelle_38";
		break;
		
		case "mirabelle_38":
            dialog.text = "Есть немного, отрицать не буду, но я слышала тогда о нём при разговоре Тиракса и Паскуале, поэтому и спросила. Вы теперь будете всегда суровый и строгий, как английский лорд?.. Ах, сеньор, хотите, я для вас станцую самбу сегодня вечером у костра, и спою? Только для вас. А сейчас пойдемте же со мной! От тоски нет лучше средства, чем любовь и ласка. Я соскучилась по вам.";
			link.l1 = "Подожди минутку, и что ты слышала, о чём они говорили?";
			link.l1.go = "mirabelle_38_1";
		break;

		case "mirabelle_38_1":

			dialog.text = "Говорили о каком - то банке и им нужен Жан как лучший медвежатник на Карибах.";

                        if (!CheckAttribute(npchar, "quest.Panama_toReady") && CheckAttribute(pchar, "questTemp.piratesLine.Detector")) // Поход на Панаму пройден, не даём квест
			{
				link.l1 = "Ты просто умница... Пойдем я тебе шпили-вили сделаю.";
				link.l1.go = "mirabelle_39_0";
			}
			else
			{
				link.l1 = "Достаточно я понял, ты просто умница, хорошо, хорошо, девочка... Пойдем я тебя ощестливлю.";
				link.l1.go = "mirabelle_39_0";
			}
		...
		case "CartahenaMayor_2":
            dialog.text = "Я знаю, на что способен отъявленный злодей и пират "+pchar.name+" Барон! И знаю, кто им руководит! Придет время - мы выжжем каленым железом ваше разбойничье гнездо на Эспаньоле! Выкуп? Сколько?";
		...
		case "CartahenaMayor_7":
            dialog.text = "Еще раз говорю тебе, "+pchar.name+" Барон: нет в Картехене таких денег!";
		...
		case "CartahenaMayor_10":
			...
			link.l1 = "Ага! Вот как мы заговорили?! И кто тут у нас мерзавец и негодяй, а? То, что мои молодчики бесчинствуют в городе среди простолюдинов - тебя не сподвигло на подвиги, а как дело дошло до твоих дамочек - засуетился? Торговаться со мной вздумал, canalla? Я покажу тебе, как перечить "+pchar.name+" Барону!";
		...
		case "CartahenaMayor_12":
            ...
            dialog.text = "Получи свои кровавые деньги, "+pchar.name+" Барон, и отзови негодяев из города на корабли. Пусть они наконец прекратят грабежи и насилие...";
		...
		case "camilla":
            ...
            dialog.text = "Ох, да это же сам "+pchar.name+" Барон, знаменитый пират, гроза испанского южного Мэйна!";
		...
		case "camilla_1":
			...
			link.l1 = "Камилла... Знавал я одну Камиллу, еще в юности. Как давно это было!..";
		...
		case "camilla_2":
            ...
            dialog.text = "";
			link.l1 = "... буэ!.. Извини, красотка, Барон сегодня малость выпил. Так это... ты просто так подошла ко мне, или у тебя какое-то дело?";
		...
		case "camilla_8":
			...
			WaitDate("", 0, 0, 0, 1, 5);
            dialog.text = "М-м-м... Подумать только - я сижу наедине вместе с самим "+pchar.name+" Бароном, пью чудесное вино...";
			link.l1 = "Ты останешься довольна нашей встречей, обещаю! "+pchar.name+" Барон щедр и ласков с дамами, которые ему не перечат. Ты ведь не будешь мне перечить, так?";
		...
		case "camilla_14":
            dialog.text = "Барон, у меня к тебе будет просьба. Выполнишь?";
		...
		case "camilla_19":
			...
			link.l1 = "Конечно, красотка. "+pchar.name+" Барон не обманывает своих партнеров, ха-ха! Валяй, я слушаю.";
		...
		case "camilla_25":
			...
			link.l1 = "Ты все равно опасаешься? Ха-ха! Да не трусь, Камилла: не обману я тебя. Ради каких-то жалких двухсот дублонов "+pchar.name+" Барон не станет унижаться до такого.";
		...
		case "camilla_29":
            dialog.text = "Я бы с радостью, Барон, но сейчас я готовлюсь к исповеди у своего духовника, и мне положено полное воздержание от всех соблазнов. Давай в следующий раз.";
		...
		case "camilla_sleep":
            dialog.text = "Твои мерзавцы убили моего отца и братьев. После твоего налета в Картахене не осталось, наверное, ни одной семьи, в которую не пришло бы горе\nНадеюсь, тебе сейчас в темном каменном мешке так же страшно, как было страшно жителям Картахены, когда твои нелюди резвились на улицах и в домах. Ты будешь гореть в аду, "+pchar.name+" Барон.";
			link.l1 = "";
			link.l1.go = "exit";
		...
		case "mishelle_sleep":
            dialog.text = "Расскажи мне, друг - как ты превратился в такого негодяя? Когда я говорил тебе познакомиться с пиратами, я не имел в виду жечь города, убивать мирных поселенцев, издеваться над женщинами. Даже войну можно вести достойно и благородно!";
			link.l1 = "";
			link.l1.go = "exit";
