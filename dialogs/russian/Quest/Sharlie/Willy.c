...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "catoche_3":
			...
			link.l1 = "У нас с ним давняя вражда... Еще с того дня, когда эскадра, возглавляемая им, напала на колонию Форт де Франс и чуть позже была уничтожена при моем непосредственном участии.";
		...
		case "isladevieques":
			...
			dialog.text = "И правду говорят, что у вас, как у кошки - девять жизней! "+TimeGreeting()+", месье. Что-то вы неважно выглядите...";
		...
		case "isladevieques_2":
			dialog.text = "Отнюдь. Я действительно нашел беднягу Арчибальда на этом самом острове. Вот только мемуаров никаких он не сочинял - дневник, который вы нашли в комнате Арчи в Порт-Рояле, куда пробрались столь изысканным способом, был написан им под мою диктовку, специально для вас, месье\nЯ давно за вами наблюдаю, с самого того дня, как мы встретились на мысе Каточе. Ведь это вы забрали с трупа дона Диего карту Двух Появлений? Не отпирайтесь: я знаю, что это вы.";
		...
		case "isladevieques_5_1":
			...
			{
				dialog.text = "Ваши офицеры проложили вам дорогу, месье. Они лежат вон там, в кустах. Скоро и вы отправитесь следом.";
