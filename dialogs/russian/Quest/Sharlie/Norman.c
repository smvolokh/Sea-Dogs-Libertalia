...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "tieyasal_16":
			dialog.text = "Корабль у него - галеон. Большой военный галеон. А зачем он был тут... ходил, вынюхивал что-то, расспрашивал. Но я подслушал его разговоры, да-да! Он искал какого-то "+GetFullName(pchar)+"!. Да, вот так и говорил - "+GetFullName(pchar)+"!. Стой, так это же ты - "+GetFullName(pchar)+"! Так он тебя искал, дружочек.";
		...
		case "tieyasal_19":
			dialog.text = "Он собирался в Блуфилдс. Сказал, что "+GetFullName(pchar)+"! следует искать под крылышком у Лесного Дьявола. Но он оставил здесь своих людей... стой, тебя ведь уже заметили!";
			link.l1 = "Кто заметил?";
