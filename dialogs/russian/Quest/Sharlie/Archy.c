...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "portroyal":
			dialog.text = "Ха, месье "+GetFullName(pchar)+"! ! Рад вас приветствовать в Порт-Рояле! Надеюсь, вы меня не забыли?";
		...
		case "portroyal_3":
			...
			link.l1 = "Дон Диего после поражения от меня в Форт де Франсе начал строить козни и в итоге напал в открытую у Кубы. Затем он вышел из боя и удрал в сторону Мэйна. Ну, я и решил избавиться от этого подлеца раз и навсегда. Чтобы больше не пакостил французам.";
			link.l1.go = "portroyal_4";
		break;
		
		case "portroyal_4":
			dialog.text = "Да уж, о вашем героизме я уже немало легенд наслушался - теперь увидел и собственными глазами...";
			link.l1 = "Ну, я тоже кое-что слыхал о героизме Вильяма Патерсона. Повезло вам с капитаном.";
			link.l1.go = "portroyal_5";
		break;
		
		case "portroyal_5":
			dialog.text = "Повезло, согласен. Только в последнее время он такой важный стал, прямо весь из высшего света, все на приемы да парады, балы и закрытые вечеринки... Как прибудет в Порт-Рояль - не выгнать из губернаторского дворца. Как и сейчас, впрочем\nКапитан, не откажите в любезности выпивохе-шотландцу: составьте компанию для беседы! Так уже осточертели все эти морды, смотреть тошно, а с вами есть о чем поговорить. Пойдемте ко мне в гости, разопьем бочоночек чудесного виски, отдохнете. Я угощаю!";
		...
		case "portroyal_10":
			dialog.text = "С удовольствием!.. Эх! А вот вы давно прибыли на Карибы, а, месье?";
