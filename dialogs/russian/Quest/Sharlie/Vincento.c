...
pchar.GenQuest.Piratekill = sti(pchar.GenQuest.Piratekill)+10;
		...
		case "utensil_14":
			...
			link.l1 = "Я так понимаю, дон Мендоса тоже так считает, раз организовал нападение на Форт де Франс с целью отыскать Дичозо?";
		...
		case "guardoftruth_11":
			...
			link.l1 = "Ключ именно в том, что фрегат скрылся в направлении Мартиники. А совсем недавно славный кабальеро по имени Диего де Монтойя, человек самого дона Рамона де Мендосы, атаковал Форт де Франс, и целью его было найти Мигеля Дичозо, якобы скрывающегося там.";
			link.l1.go = "guardoftruth_12";
		break;
		
		case "guardoftruth_12":
			dialog.text = "Значит, барон считает, что Дичозо укрылся у французов...";
			link.l1 = "Я неплохо знаю Форт де Франс и губернатора Жак дил ду Парке, Ваше Преосвященство. И ни про какого испанца по имени Мигель Дичозо в Форт де Франсе не слышали. Скажите, как мне найти Диего де Монтойю? Я бы хотел побеседовать с ним по поводу Дичозо.";
