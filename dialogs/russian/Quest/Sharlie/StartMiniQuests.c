void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Storehelper":
			...
			link.l1 = "Хм. Ведь это вы - Гралам Лавуа, правильно?";
			link.l1.go = "Storehelper_1";
		break;
		
		case "Storehelper_1":
			dialog.text = "Да, я, а вам-то чего надо? Не мешайте мне пить ром, сударь, я не в настроении общаться.";
			link.l1 = "Я не отниму у вас много времени. Меня послал купец Форт де Франса. Вы ведь работали у него на складе, так? Он разыскивает вас и...";
			link.l1.go = "Storehelper_2";
		break;
		
		case "Storehelper_2":
			dialog.text = "Ха! Он разыскивает меня! Чертов скряга! Он думал, что я всю жизнь буду работать за его жалкие гроши? Да нет на всех Карибах жаднее купца! Я трудился на него пять лет без роздыху, а он ни разу не выдал даже маленькой премии, даже кружки рома не поставил!\nВот пусть теперь сам свои товары считает, а с меня довольно. Никто в Форт де Франсае не пойдет работать к этому сквалыге, я-то знаю. У него только одна забота - потуже набить свой бездонный кошель и поменьше заплатить работникам.";
		...
		case "Storehelper_3":
			...
			link.l1 = "Все понятно. Большего мне знать и не нужно. Удачи, Гралам!";
			link.l1.go = "Storehelper_12";
		break;
		
		case "Storehelper_4":
			dialog.text = "Сударь, отойдите в сторону, вы загораживаете дорогу!";
			link.l1 = "Один вопрос, месье. Ведь это вы - Гралам Лавуа?";
			link.l1.go = "Storehelper_5";
		break;
		
		case "Storehelper_5":
			dialog.text = "Ха! Ну, я. А в чем дело-то?";
			link.l1 = "Вас разыскивает купец из Форт де Франса. Вы ведь работали у него, так?";
		...
		case "Storehelper_7":
			dialog.text = "Почему я у него не появляюсь? Да потому что он чертов сквалыга! Жадина, каких свет не видел! Пускай сам на своем складе возится, а я теперь вхожу в Береговое братство, и мне это, черт побери, очень нравится!\nСкоро я выйду в море и буду пересчитывать песо и дублоны, добытые у испанцев, а не ящики с бананами! А что до этого скряги - пусть попробует найти мне замену. Ни один дурак в Форт де Франсае не пойдет к нему на службу, слишком дурная у него репутация, ха-ха!";
			link.l1 = "Все понятно. Большего мне знать и не нужно. Удачи, Гралам!";
			link.l1.go = "Storehelper_12";
		break;
		...
		case "Storehelper_8":
			...
			link.l1 = "Добрый день. Как я понимаю, вы - Гралам Лавуа?";
			link.l1.go = "Storehelper_9";
		break;
		
		case "Storehelper_9":
			dialog.text = "Да, это я. Чем обязан, месье?";
			link.l1 = "Вас разыскивает купец из Форт де Франса. Вы работали у него на складе...";
		...
		case "Newstorehelper_1_2":
			...
			link.l1 = "Я принял решение в вашу пользу. Собирайтесь, мы отправляемся в Форт де Франс.";
		...
		case "Newstorehelper_regard":
			dialog.text = "Ну, как я понимаю, это и есть мое новое место работы? Спасибо, месье, что выбрали именно меня. Вот ваши пятьсот песо и дополнительная награда, как я и обещал. Вижу, что Вы много странствуете, поэтому я решил дать Вам в качестве особой признательности небольшой презент: холщовый мешочек. В него вы сможете положить много разного добра.";
		...
		case "Rum_Carrier_1":
			dialog.text = "Отлично. Теперь это наша забота, а вы отправляйтесь в Форт де Франса в таверну за расчетом.";
		...
		case "GigoloMan_4":
			dialog.text = "Я очень рад. Теперь слушайте: девушку, которая мне нужна, зовут Люсиль. Я прошу вас привести ее ко мне домой когда стемнеет, не раньше одиннадцати вечера, чтобы никто не увидел. Постучитесь в дверь и я вам открою\nМой дом находится слева от резиденции губернатора - двухэтажный особняк с красной крышей. Вы легко его найдете. Вот, возьмите шесть тысяч песо. И вот эту бутылку хорошего вина в качестве презента. Мало ли сами захотите расслабиться в компании прекрасной дамы. Не забывайте - я жду вас!";
		...
		case "GigoloMan_5":
			...
			Log_Info ("Вы получили бутылку вина");
		...
		case "CaptiveSpain_4":
			...
			link.l1 = "Нет никаких солдат. Я попытался напугать негодяев, но, как видишь, ничего не вышло. Я действовал в одиночку, по просьбе твоего старого друга. Его зовут "+pchar.questTemp.Sharlie.Captive.Name+", он ростовщик в Форт де Франсае.";
		...
		case "CaptiveSpain_6":
			...
			link.l1 = "Ты наконец-то стал разумно рассуждать. А теперь довольно болтовни - мы отправляемся в Форт де Франса. Держись ко мне поближе и не вздумай бежать - все равно догоню!";
		...
		case "Prosper_20":
			dialog.text = "Еще раз огромное спасибо, "+pchar.name+"! Давайте теперь все вместе вернемся в город. Жизнь моей дочери бесценна, и никакими деньгами это не измерить, но я все же хочу отблагодарить вас, подарив остатки своих сбережений. Как только мы придем в Форт де Франса - я с радостью отдам вам их. И не вздумайте отказываться!";
		...
		case "Prosper_23":
		SelectPresentAmulet();
		dialog.text = "Вот мы и пришли. "+pchar.name+", я еще раз благодарю вас за помощь и предлагаю вам на выбор деньги или инструмент, который может оказаться полезным, если Вы любите мастерить своими руками. Также возьмите вот этот амулет - "+pchar.questTemp.SMQ.Text+"";
			link.l1 = "Выбираю инструмент. Люблю действительно мастерить своими руками.";
			link.l1.go = "Prosper_24_1";
			link.l2 = "Инструмент - это хорошо, конечно, но деньги мне сейчас нужнее.";
		...
		TakeNItems(pchar, pchar.questTemp.SMQ.Amulet, 1);
			Log_Info("Вы получили ремонтный комплект");
			Log_Info("Вы получили амулет");
			PlaySound("interface\important_item.wav");
			dialog.text = "Ей бы мужа такого, как вы, а то бегают за ней всякие тонконогие хлыщи, а как беда пришла - так все и исчезли куда-то... Эх, ладно. Удачи, "+pchar.name+"!";
...
void SelectPresentAmulet()
{
	...
	{        
		...
		case "Merchant":
			...
			pchar.questTemp.SMQ.Text = "он поможет Вам в торговых делах.";
		break;
		...
		case "SecretAgent":
			...
			pchar.questTemp.SMQ.Text = "он сделает Ваше оружие отравленным, что даст некоторое преимущество в бою.";
		break;

		case "Inquisitor":
			pchar.questTemp.SMQ.Amulet = "obereg_11";
			pchar.questTemp.SMQ.Text = "он позволит вести Ваш будущий корабль круче к ветру.";
		break;
