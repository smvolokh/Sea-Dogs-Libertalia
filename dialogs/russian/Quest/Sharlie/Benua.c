...
PlaySound("VOICE\Russian\GOTHIC\GG_HALLO_M\GG_HALLO_M_" + rand(15) + ".wav");
			...
			if (CheckAttribute(pchar, "questTemp.Sharlie") && pchar.questTemp.Sharlie == "benua_final")
			{
				...
				link.l1 = "Да, отче. Я хочу увидеть своего друга, Мишеля де Монпе. Он сказал, что...";
				link.l1.go = "escape";
				break;
			}
			dialog.text = "Ты что-то хотел, сын мой?";
			...
			{
				link.l1 = "Да, отче. Мне нужна ваша помощь. Меня зовут "+GetFullName(pchar)+". Мне порекомендовал обратиться к вам мой друг, Мишель де Монпе.";
			...
			{
				link.l1 = "Да, отче. Для того, чтобы помочь Мишелю, мне нужен корабль. Но я только недавно прибыл на Карибы, и почти без гроша в кармане. Мой друг сказал мне, что вы можете ссудить мне некоторую сумму денег...";
		...
		case "Benua_meeting":
			...
			link.l1 = "Здравствуйте, отче. Мне посоветовали обратиться к вам. Мое имя - "+GetFullName(pchar)+". Я разыскиваю Мишеля де Монпе. Как мне известно, он должен быть где-то здесь, на Мартинике. Я... его друг.";
			link.l1.go = "Benua_meeting_1";			
		break;
		
		case "Benua_meeting_1":
			dialog.text = "Друг Мишеля де Монпе? И зачем Вам понадобился Мишель?";
			link.l1 = "Я понимаю ваши сомнения, отче. Но я должен сообщить ему очень важную новость. Дело в том, что его брат, Шарль де Мор, был убит и так получилось, что я взял на себя обязательства передать лично в руки Мишелю личные вещи его покойного брата и сообщить ему о его гибели...";
			link.l1.go = "Benua_meeting_2";			
		break;
		
		case "Benua_meeting_2":
			dialog.text = "Я понял тебя, сын мой. Я слышал о гибель Шарля... Такая потеря и такой удар для Мишеля и всей семьи де Монпе...\n Хорошо, я устрою тебе встречу с Мишелем. Приходи завтра утром, сын мой, я познакомлю тебя с одним человеком - думаю, он сможет проводить тебя к Мишелю.";
		...
		case "Benua_maltie":
		dialog.text = "Здравствуй, сын мой. Как я и обещал - нужный человек уже здесь и ждет тебя. Он готов провести тебя к несчастному Мишелю, да смилуется Господь над его судьбой... Я рад, что ты решил помочь Мишелю, прошу тебя принять в благодарность этот крестик.";
		link.l1 = "Благодарю, отче. Но где же этот нужный  человек?";
		link.l1.go = "exit";
		...
		case "escape":
			dialog.text = "Да, "+pchar.name+", я в курсе. Но вынужден тебя огорчить. Мишеля здесь нет.";
			link.l1 = "Как нет?! Он же сказал, что будет ждать меня в церкви у вас! Отче, что случилось? Где мой друг?!";
			link.l1.go = "escape_1";
		break;
		
		case "escape_1":
			dialog.text = "Сын мой, твой друг был здесь и покинул мою скромную обитель глубокой ночью. Куда он отправился - мне неведомо. Но он оставил для тебя письмо.";
			link.l1 = "Невероятно... и это после того, что я сделал для него! Дайте же мне это письмо!";
			link.l1.go = "escape_2";
		break;
		
		case "escape_2":
			dialog.text = "Не горячись, "+pchar.name+". Вот это письмо. Прочти его, а потом... потом я хочу поговорить с тобой. Но сначала прочитай послание своего друга.";
		...
		case "escape_4":
			...
			{
				dialog.text = "Я вижу, ты прочел письмо. Теперь я хочу сказать тебе кое-что, "+pchar.name+"...";
				link.l1 = "Но... как же так? Что за ахинею он несет? Я знаю, что у моего друга есть странности, но на сумасшедшего он не похож!";
				link.l1.go = "escape_5";
			}
			else
			{
		...
		case "escape_5":
			dialog.text = "Меня тоже удивил поступок твоего друга, "+pchar.name+". Более - я до сих пор пребываю в растерянности. Верный слуга Ордена и Отечества - и поступает как дезертир...";
		...
		case "escape_7":
			dialog.text = "Сын мой, священник видит не глазами, а сердцем. Я не могу объяснить тебе словами, но... твой друг задумал что-то скверное. Я никогда не думал, что мои уста смогут произнести такое, однако...";
			link.l1 = "Ну, в том, что мой друг что-то задумал - я не сомневаюсь. Я даже догадываюсь, что именно. Это 'что-то' лежит где-то, имеет желтый цвет и приятно позвякивает.";
			link.l1.go = "escape_8";
		break;
		
		case "escape_8":
			dialog.text = "Я не думаю, что жажда золота движет твоим другом. Сдается мне, что ему нужно нечто большее.";
		...
		case "meet":
			dialog.text = "Друг Мишеля де Монпе?";
			link.l1 = "Я понимаю ваши сомнения, отче. Но я помогаю Мишелю выбраться из той ситуации в которую он угодил.. И мне нужна Ваша помощь...";
			link.l1.go = "meet_1";			
		break;
		
		case "meet_1":
			dialog.text = "Я уже слышал, что Мишеля посещал некий человек. Надеюсь, что ты сможешь помочь Мишелю, у него сейчас трудные дни. Так что я могу сделать для тебя?";
		...
		case "FastStart_1":
			dialog.text = "А-а, это все проясняет. Надеюсь, что ты сможешь помочь Мишелю, у него сейчас трудные дни. Так что я могу сделать для тебя?";
			link.l1 = "Для того, чтобы помочь Мишелю, мне нужен корабль. Но я только недавно прибыл на Карибы, и почти без гроша в кармане. Мишель сказал мне, что вы можете ссудить мне некоторую сумму денег...";
			link.l1.go = "FastStart_2";	
			npchar.quest.meet = true;
		break;
		...
		case "FastStart_2":
			...
			link.l1 = "Отче, я понимаю ваши сомнения, но это действительно так. Чем быстрее я стану владельцем и капитаном судна, тем быстрее смогу выполнить задачу, поставленную де Пуанси и освободить Мишеля из темницы.";
			link.l1.go = "FastStart_3";
		break;
		
		case "FastStart_3":
			dialog.text = "Я понял, сын мой. И слышу, что ты говоришь мне правду. Что же, ради Мишеля я, конечно, помогу тебе. У меня есть личные сбережения, которые я завещал монастырю Форт де Франса. Я готов передать их тебе на время, если это действительно поможет Мишелю. Пятьдесят тысяч песо и сто золотых дублонов - этого должно тебе хватить с лихвой.";
		...
		case "LH_abbat":
			dialog.text = ""+pchar.name+", не верю глазам своим! Какими судьбами?!";
		...
		case "LH_abbat_1":
			dialog.text = "Сын мой, это прекрасно! Искренне рад за тебя! Но, боюсь, я не смогу тебе помочь, разве что ты решишь венчаться в этой самой церкви.";
		...
		case "LH_abbat_2":
			dialog.text = "Жаль, сын мой, но весь твой авторитет ничто перед твердолобостью высших иерархов католической церкви, тем более в Испанских колониях. Мы не сошлись в вопросе раздела влияния католических миссий наших стран, и теперь я тут нечто среднее между почетным гостем и почетным же заложником. Испанцы ждут более выгодного предложения с нашей стороны. Я отправил послание в Европу, месяца через два придет ответ, и мы возобновим переговоры. Максимум - через полгода\nДа, Папа Римский и Мазарини пошли навстречу друг другу, но о настоящей оттепели говорить еще рано. Честно сказать, я не уверен, что мы вообще придем здесь к какому-то соглашению. Мне кажется, Палотти просто держит у себя французского аббата как некий аргумент в своей собственной политике. Впрочем, кофе у отца инквизитора отменный - грех жаловаться.";
			link.l1 = "Но я не вижу никого кроме Вас священником на своей свадьбе, святой отец!";
			link.l1.go = "LH_abbat_3";
		break;
		
		case "LH_abbat_3":
			dialog.text = "Боюсь, тебе придется подыскать другого священника на свою свадьбу, сын мой. Увы, но я здесь надолго.";
		...
		case "LH_abbat_5":
			dialog.text = "Это рискованно. Очень. На выходе меня ждет эскорт, чтобы сопроводить в особняк, и город полон солдат.";
		...
		case "LH_abbat_9":
			dialog.text = "Конечно! Так перейдем же к делам приятным - "+pchar.name+", как продвигаются ваши приготовления к столь важному дню?";
		...
		case "LH_abbat_15":
			...
			if (CheckAttribute(pchar, "questTemp.Saga.Helena_officer"))
			{
				...
				link.l1 = "Ян Свенсон, из Блювельда. Он англичанин, но уважаемый человек и привязан к Элизе как к родной дочери, и ее приемная мать Глэдис Мак Артур.";
			}
			else
			{
		...
		case "LH_abbat_19":
			dialog.text = "И вот, этот день настал! У нас все готово - через пару часов можем начинать. Ты выглядишь бледновато!";
		...
		case "LH_abbat_25":
			...
			dialog.text = "Мы все собрались здесь в этот прекрасный день, чтобы засвидетельствовать перед Господом нашим союз двух любящих душ. Возлюбленные "+sld.name+" и "+pchar.name+", вы слушали слово Божие, напомнившее вам о значении человеческой любви и супружества. Теперь от имени святой Церкви я желаю испытать ваши намерения\n"+sld.name+" и "+pchar.name+", имеете ли вы добровольное и искреннее желание соединиться друг с другом узами супружества, перед лицом Господа нашего?";
			link.l1 = "Да.";
		...
		case "LH_abbat_35":
			string sTemp;
			if (sti(pchar.questTemp.LongHappy.Mistake) > 1) sTemp = "(шепчет) "+pchar.name+", сын мой, просто открывай рот, умоляю - ни звука...";
			else sTemp = "";
		...
		case "LH_abbat_37":
			dialog.text = "Мои поздравления, сын мой. Будьте счастливы и берегите друг друга в наше непростое время.";
