...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		// --> матрос на кладбище в Форт де Франсе
		case "Startsailor":
PlaySound("VOICE\Russian\GOTHIC\GG_HALLO_M\GG_HALLO_M_" + rand(15) + ".wav");
			dialog.text = "Эх, как жаль, совсем ещё молодой парень в расвете сил и вот на тебе!";
			link.l1 = "Что произошло...";
			link.l1.go = "Startsailor_1";			
		break;
		
		case "Startsailor_1":
			dialog.text = "Эх, месье, убили его, а ведь я его знал он был сыном французского дворянина. Он прибыл на Карибы, чтобы найти без вести пропавшего брата, а тут такое несчастье. Эх, бедняга Шарль де Мор.";
			link.l1 = "Да уж, куда этот мир катится. Прими мои соболезнования!";
			link.l1.go = "Startsailor_2";			
		break;
		
		case "Startsailor_2":
			dialog.text = "Я вижу ты парень крепкий, у меня остались его документы, может быть ты найдешь его брата и передашь ему бумаги, заодно и сообщишь о гибели, что скажешь?";
			link.l1 = "А почему бы тебе самому...";
			link.l1.go = "Startsailor_3";			
		break;
		case "Startsailor_3":
			dialog.text = "Я завтра отбываю в Европу, сам понимаешь, нет времени?";
			link.l1 = "В Европу? а мы где?...";
			link.l1.go = "Startsailor_3_1";			
		break;
		
		case "Startsailor_3_1":
			dialog.text = "Ты, что с луны свалился. Тут вам, ха, не Европа... Будьте осторожны, месье. Здесь в последнее время не любят тех, кто задает слишком много вопросов. Времена нынче, знаете ли, неспокойные. Говорят, что остров продали каким-то фанатикам веры. Я до сих пор не замечал каких-то перемен в привычном укладе жителей Мартиники. Но за время моего отсутствия многое могло измениться.";
		...
		case "Startsailor_4":
			...
			link.l1 = "Ну, началось... Страсти-то какие. Пока единственные напасти, которые я встретил - это жара и москиты, проклятые... Ладно, давай бумаги?";
			link.l1.go = "Startsailor_5";			
		break;
		
		case "Startsailor_5":
			dialog.text = "Убийца должен быть в городе, будь осторожен и запомни его звали Шарль де Мор!";
			link.l1 = "";
		...
		case "Maltie_officer":
			...
			{
				dialog.text = "Рад вас видеть, месье "+ GetFullName(Pchar)+". По какому вопросу пожаловали?";
				link.l1 = TimeGreeting()+", офицер. Я хочу поговорить о моем друге, Мишеле де Монпе. Причем неофициально. Мне хотелось бы немного больше узнать о его службе здесь.";
				link.l1.go = "spanish";
				break;
			}
			...
			if (!CheckAttribute(location, "first_meeting"))
			{
				...
				link.l1 = "Я пришел, чтобы увидеть своего друга, Мишеля де Монпе.";
		...
		case "Sharlie_maltie_3":
			dialog.text = "Вот мы и пришли. Это наша база - Ордена Мальтийских рыцарей. Казематы находятся внизу. Пройдите мимо столовой и комнаты для молитв и спуститесь по лестнице вниз. Там вы найдете коридор с зарешеченными камерами. В одной из них и содержится ваш несчастный друг\nСтупайте, "+pchar.name+", и помогите нашему Мишелю! Он ни в чем не виноват, здесь все готовы подтвердить это под присягой...";
			link.l1 = "Я затем и прибыл в эту глушь, чтобы помочь своему другу. Надеюсь, мне удасться хоть что-то сделать.";
		...
		case "Sharlie_sailor_3":
			dialog.text = "Нас двадцать пять человек. Моряки мы опытные, не крысы сухопутные, да и пороху понюхать тоже приходилось не раз. И с парусами управимся, и у орудий встанем, коль нужда придет, и за сабли возьмемся, если потребуется.";
		...
		case "skipertalker_3":
			dialog.text = "Алехандро Пистолето его зовут. Спросите у коменданта в тюрьме. Но только не думаю, что его отпустят так просто, разве что вы заплатите за него долг, ха-ха!";
		...
		case "Folke":
			...
			link.l1 = "Приветствую, Алехандро. Все очень просто - у меня есть корабль, но нет штурмана, а он мне очень нужен. Поэтому я и выкупил тебя из долговой ямы...";
			link.l1.go = "Folke_1";
		break;
		...
		case "Folke_2":
			...
			link.l1 = "Я рад, что мы поняли друг друга, Алехандро. Да, еще: у тебя есть еще какие-то познания в морском деле, кроме как управлении кораблем?";
			link.l1.go = "Folke_3";
		break;
		...
		case "Folke_6":
			...
			dialog.text = "Отличный гафельный шлюп, капитан! Весьма и весьма достойный корабль. На таком можно без опаски не то что на Гваделупу отправляться, но хоть через все Карибское море.";
			link.l1 = "Очень хорошо. По крайней мере, деньги не пропали даром... Какие-нибудь советы перед тем как отправиться в путь будут, Алехандро?";
			link.l1.go = "Folke_8";
		break;
		...
		case "Folke_7":
			...
			link.l1 = "У меня не было выбора - на верфи предложили только эту посудину. Да еще и содрали приличную сумму, а чинить ее, понимаешь ли, времени у них нет... Какие-нибудь советы перед тем как отправиться в путь будут, Алехандро?";
			link.l1.go = "Folke_8";
		break;
		...
		case "Seabattle_pirate_1":
			dialog.text = "Позвольте представиться - "+GetFullName(npchar)+". Меня послал к вам Снейкман Янг. Вы, должны его знать - это хозяин таверны в Ле Франсуа. Насколько ему известно, вы собираетесь на Гваделупу, и он хочет предложить вам неплохо подзаработать.";
			link.l1 = "Хм... Забавно! Интересно, и откуда же Снейкман Янг так осведомлен о моих планах?";
			link.l1.go = "Seabattle_pirate_2";
		break;
		
		case "Seabattle_pirate_2":
			dialog.text = "Капитан, это же просто. Ваш корабль в порту Форт де Франс сейчас - единственный, так что про вас уже всем практически все известно: и кто вы, и куда идете. В наших краях слухи разносятся молниеносно. Так вам интересно послушать мое предложение?";
			link.l1 = "Конечно. Я никогда не прочь заработать.";
			link.l1.go = "Seabattle_pirate_3";
		break;
		
		case "Seabattle_pirate_3":
			dialog.text = "Вот это разговор! Сразу видно деловую хватку. Так вот, Янгу нужно срочно перевезти на Гваделупу тамошнему купцу груз нашего местного вина, двести бочонков. Трюм вашего корабля без труда их вместит\nЗа эту несложную работу вы получите целых десять тысяч песо - Янг очень спешит, а других кораблей, кроме вашего, сейчас у наших берегов нет. Соглашайтесь - такие выгодные предложения не каждый день поступают.";
		...
		case "Seabattle_pirate_4":
			dialog.text = "Отправляйтесь на корабле в порт Ле Франсуа и поговорите с Янгом. Он сам все организует - вам нужно будет только поставить корабль у берега. Не подведите, кэп: Снейкман пообещал мне тысячу песо, если мне удастся уговорить вас...";
		...
		// командир абордажной роты по защите Форт де Франса
		case "rosetti":
		...
		case "spanish":
			...
			link.l1 = "А вы понимаете, что только благодаря моей своевременной помощи Форт де Франс не был разобран испанцами по кирпичику? Мой друг скрылся, оставив службу Ордену. Это неспроста. Я, как представитель интересов Филиппа де Пуанси, обязан разобраться в этом!";
			link.l1.go = "spanish_1";
		break;
		
		case "spanish_1":
			dialog.text = "Хорошо-хорошо, месье. Я отвечу на все ваши вопросы. Только не горячитесь. Спрашивайте.";
		...
		case "spanish_3":
			dialog.text = "Также он готовил военную операцию против испанцев, а именно - захват испанского корабля с очень ценным грузом. Ваш друг должен был каким-то образом вывести испанский транспорт в нужное место прямо под пушки малого фрегата 'Гриффондор'. Мишель отбыл в длительную экспедицию, и некоторое время о нем не было ни слуху, ни духу\nОднако что-то у него пошло не так, поскольку испанского транспорта 'Гриффондор' не дождался, а сам Мишель был обнаружен рыбаками, выброшенный волнами на берег в бухте Ле Марен, контуженный и едва живой. Видимо, операция провалилась\nКазалось бы - на войне, как на войне, хорошо, что вообще жив остался, однако шевалье де Пуанси совершенно неожиданно ополчился против Мишеля, обвинил в растрате и присвоении денежных средств Ордена и заключил под стражу\nКонечно, мы не поверили этим обвинениям: Мишель - честнейший парень, так что одному Богу известно, какая черная кошка пробежала между ним и шевалье. Быть может, сам месье де Пуанси поведает вам об этом?";
			link.l1 = "Возможно. Это все, что вам известно?";
			link.l1.go = "spanish_4";
		break;
		
		case "spanish_4":
			dialog.text = "К сожалению, добавить к сказанному мне нечего. Подробности всех операций, проводимых вашим другом, были известны только ему самому и шевалье де Пуанси. Мы, офицеры и солдаты Ордена, просто выполняли приказы.";
			link.l1 = "Раз шевалье так доверял Мишелю, значит, не все его операции были провальными? Были и успехи?";
			link.l1.go = "spanish_5";
		break;
		
		case "spanish_5":
			dialog.text = "Конечно. Последняя неудача Мишеля де Монпе была также и его первой неудачей, поэтому мы буквально были поражены реакцией шевалье. Еще незадолго до этого при помощи тщательно спланированной операции Мишеля 'Гриффондором' был захвачен испанский галеон, доверху груженый серебром. Одно это могло компенсировать десяток неудач в будущем. И все же ваш друг был арестован.";
			link.l1 = "Ясно. У вас есть какие-то предположения, почему Мишель так спешно скрылся из Форт де Франс?";
			link.l1.go = "spanish_6";
		break;
		
		case "spanish_6":
			dialog.text = "Я подозреваю, что причины его ареста - в межличностном конфликте с Филиппом де Пуанси. Ваш друг, очевидно, опасается, что преследования со стороны шевалье продолжатся и после освобождения, поэтому принял превентивные меры. И знаете что, месье - здесь никто не осуждает его решение!\nЧеловек мужественно и доблестно работал на благо Ордена, а его при первой же неудаче, которую он бы компенсировал в дальнейшем сторицей, раненого и больного, бросают в камеру, обвиняя в какой-то совершенной нелепице!\nДа, если что: разговор наш неофициальный, и под присягой повторять свои слова я не буду. Мы поняли друг друга, месье?";
			link.l1 = "Безусловно, офицер. Мы договорились об этом с самого начала. Скажите, а нападение испанцев на Форт де Франс не могло быть спровоцировано военными операциями Ордена против испанских кораблей? Ну, тот же галеон с серебром, о котором вы упомянули? Уж больно рьяно кастильцы орудовали на вашей базе...";
			link.l1.go = "spanish_7";
		break;
		
		case "spanish_7":
			dialog.text = "Навряд ли. О нашей базе на Мартинике вообще мало кому известно, да и все наши действия против испанцев были точечными и аккуратно спланированными. Но вы можете сами спросить об этом у пленного испанского офицера, который в данный момент содержится в наших казематах. Мы уже допросили его\nАтака Форт де Франс - обычный грабительский налет, организованный испанским грандом, бароном Рамоном де-Мендосой-и-Риба, с целью личной наживы и устрашения гражданского населения французких колоний, а также чтобы выслужиться перед Эскориалом.";
			link.l1 = "Я побеседую с вашим пленным. Где мне его найти?";
			link.l1.go = "spanish_8";
		break;
		
		case "spanish_8":
			dialog.text = "Внизу, в камере, где содержался ваш друг.";
		...
		case "spanish_10":
			dialog.text = "Вот это новость! Но я не могу отпустить пленника, он участвовал в набеге на Форт де Франс...";
			link.l1 = "Офицер, это важный свидетель. Нападение на Форт де Франс было совершено не для грабежа. Дону Рамону Мендосе нужно было другое. Мы должны разобраться с этим окончательно. Так вы выдадите мне этого испанца, или мне затребовать разрешение у де Пуанси?";
			link.l1.go = "spanish_11";
		break;
		
		case "spanish_11":
			dialog.text = "Ладно, забирайте его, раз уж он так важен вам. Все равно я собирался казнить мерзавца публично на площади Форт де Франс... Но строго под вашу личную ответственность!";
		...
		case "spanish_13":
			...
			link.l1 = "Точно нет? То есть ни на вашей базе, ни в губернаторском дворце, ни вообще в Форт де Франс вы не встречали человека с таким именем?";
		...
		case "spanish_15":
			dialog.text = "Да не за что... Как вы думаете, месье: где же сейчас ваш друг?";
		...
		case "Dichoso_agent_5":
			dialog.text = "Дон Дичозо разыскивал вас на Исла-Тесоро, потом здесь, а теперь отбыл на Сент-Кристофер, в надежде найти вас там. Ведь вы же офицер самого Филиппа де Пуанси, я не прав? А я должен был ожидать тут, на случай, если вы прибудете в Блуфилдс.";
