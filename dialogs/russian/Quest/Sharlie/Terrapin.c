...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "rober_10":
			...
			FantomMakeCoolFighter(sld, 35, 100, 100, "blade_17", "pistol6", "bullet", 250);
		...
		case "tibo_12":
			dialog.text = "Что?!";
			link.l1 = "Что-то вы побледнели, сударь. Так вот, слушай меня внимательно, Анри, и вникай: ты и твой дружок Робер по уши в дерьме. С недели на неделю на Карибы прибывает королевская военная эскадра англичан. Только ее флагман способен разнести ваш хваленый Ля-Рош за пару часов. Как ты думаешь, нападение на английский бриг и пленение дочери Фокса - достаточный повод для этого?";
			link.l1.go = "tibo_13";
		break;
		...
		case "tibo_23":
			dialog.text = "Дело касается моего бывшего друга и компаньона, небезызсвестного вам Робера Мартэна, бывшего капитана лёгкого галеона 'Вольтижер'...";
		...
		case "kathy_1":
			dialog.text = "Как мило! Вы знаете, кто я? Вы - пират, и тем не менее пришли сюда, чтобы вытащить меня из лап своих подельников? Вы рисковали жизнью из-за дочери полковника Фокса?";
		...
		case "tibo_sailor_4":
			dialog.text = "Месье Тибо просил вас не затягивать с визитом. 'Через тридцать дней рыбка может уплыть из сетей', так он сказал...";
		...
		case "tibo_sailor_5":
			...
			SetFunctionTimerCondition("Terrapin_TiboCallOver", 0, 0, 30, false);
