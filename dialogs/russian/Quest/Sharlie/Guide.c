...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "guide_0":
			...
			dialog.text = "Рад приветсвовать вас в колониях, сударь! Позвольте представиться: "+GetFullName(npchar)+". Впервые на Мартинике?";
			link.l1 = "Здравствуйте, месье. Мое имя - "+GetFullName(pchar)+". Да, я впервые на Мартинике. А вот вас, правда, что-то не припомню... Мы знакомы?";
			link.l1.go = "guide_1";			
		break;
		
		case "guide_1":
			dialog.text = "Нет, сударь, к сожалению, я не имел чести быть знакомым с вами раньше. Однако увидев благородного человека, впервые ступившего на землю Мартиники, я счел просто обязанным подойти и познакомиться с вами\nЯ хорошо помню свой первый день, когда и я, подобно вам, прибыл на Карибы. Здесь все не так, как в старушке Европе, и местные порядки могут изрядно навредить здоровью и кошельку незнакомого с ними человека\nПоэтому я и подошел поприветсвовать вас и предложить свою скромную и абсолютно безвозмездную помощь в ознакомлении с нашей колонией и архипелагом в целом - дабы вы имели хотя бы поверхностное представление о месте, куда приехали.";
		...
		case "guide_exit_1":
			...
			LAi_CharacterDisableDialog(npchar);
		                  AddDialogExitQuest("Sharlie_Start_1");
			npchar.lifeday = 0;
		break;
		...
		case "guide_12":
			...
			link.l1 = "Ну... наверное, так. Месье, я прибыл сюда для того, чтобы найти своего друга, который, как мне сообщили, должен быть где-то тут, в Форт де Франсе. Он важная птица, и наверняка известен губернатору...";
			link.l1.go = "guide_13";
		break;
		...
		case "guide_13":
			...
			link.l1 = "Скажите, а у кого я еще могу поспрашивать о моем друге? Может, не стоит беспокоить Его Светлость?";
			link.l1.go = "guide_14";
		break;
		
		case "guide_14":
			dialog.text = "Если, как вы сказали, ваш друг хорошо известен на Мартинике, поспрашивайте на улицах города у прохожих. Может, кто-то вам поможет. Кстати, как зовут вашего друга?";
			link.l1 = "Мишель де Монпе.";
			link.l1.go = "guide_15";
		break;
		
		case "guide_15":
			dialog.text = "Мишель де Монпе... да-да, я уже не раз слышал это имя, но, к сожалению, не имел чести быть представленным вашему другу лично, так что помочь не смогу. Но я уверен, что вы отыщете своего товарища. Удачи, месье, мы с вами еще обязательно увидимся и поболтаем! Я буду тут, в городе.";
		...
		case "guide_21":
				PlaySound("VOICE\Russian\GOTHIC\GG_HALLO_M\GG_HALLO_M_" + rand(15) + ".wav");
			dialog.text = "О, это снова вы, мой друг! Вижу, вас допустили в святая святых Форт де Франса - твердыню мальтийских рыцарей. По всему видать вы - птица высокого полета. Нашли своего дркга?";
			link.l1 = "Да, нашел...";
			link.l1.go = "guide_22";
		break;
		...
		case "guide_22":
			...
			link.l1 = "Это так, сударь. Дела у моего друга идут не очень хорошо и скорее всего я ввязался в какую-то авантюру. И вы представляете - впридачу я должен буду стать капитаном собственного корабля, пхе!";
			link.l1.go = "guide_23";
		break;
		...
		case "guide_55a":
			...
			link.l1 = "Один напыщенный индюк конфисковал его у меня в счет уплаты долга друга... А у вас нет еще одного клинка? После урока я сразу верну...";
