...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "lecrua_3":
			...
			dialog.text = "Вы должны доставить небольшую партию пороха и бомб в форт Порт-о-Пренса, это на французской Эспаньоле. Комендант уже заждался этот груз, так что вам не следует терять времени - у вас в распоряжении не более двадцати дней\nУважаемый "+GetFullName(sld)+" позаботится о погрузке указанного груза на борт вашего судна. Оплату за фрахт получите у коменданта форта - пять тысяч песо.";
		...
		case "lecrua_6":
			...
			SetFunctionTimerCondition("Trial_FrahtFail", 0, 0, 20, false); // таймер
		...
		case "florian_13":
			...
			link.l1 = "Да. Он уже давно готов к выходу в море, но губернатор Порто Белло намеренно держит его в доках. Сейчас он ждет прибытия из Картахены каравеллы-латины 'Нинья' с грузом пороха для 'Алькантары'. Судя по словам матроса с галеона, у них нехватка пороха.";
			link.l1.go = "florian_14";
		break;
		
		case "florian_14":
			dialog.text = "Очень интересно!";
			link.l1 = "Но если 'Нинья' не придет за ближайшие три дня - то 'Алькантара' не будет ее ждать и отправится в путь.";
		...
		case "florian_16":
			...
			PlaySound("interface\important_item.wav");
			dialog.text = "Вы читаете мои мысли, капитан! Да, есть, черт возьми! Раз на 'Алькантаре' недостаточно пороха, то я могу ее отпустить подальше в море и затем принудить вести затяжной морской бой, в котором они израсходуют свои запасы раньше нас. Это весьма облегчит мою задачу\nВам нужно сделать так, чтобы эта каравелла, 'Нинья', не дошла до Порто Белло. Я не могу расхаживать на фрегате вдоль побережья - береговая охрана легко заметит мой корабль, и тогда я вообще могу не дождаться 'Алькантары'\nА вы вполне справитесь с этой каравеллой. Каравелла-латина - это устаревший тип кораблей, судно очень компактное, формой носа напоминает большую шлюпку, имеет три мачты с 'латинским' парусным вооружением. Такие корабли нынче редкость, так что вы вряд ли её упустите. Народу на ней будет немного, но экипаж наверняка будет из морских волков. У испанцев тяжко сейчас с кораблями, но не с людьми. Отыщите 'Нинью' и уничтожьте: потопите, абордируйте - мне все равно. Лишь бы это корыто не добралось до Порто Белло!\nЕсли вы успешно выполните эту задачу - отправляйтесь на Гваделупу и идите к Жерару Лекруа - ведь вы знаете его, так? Он выдаст вам заслуженный гонорар.";
			link.l1 = "Договорились! Отправляюсь на перехват 'Ниньи'!";
		...
		case "florian_18":
			dialog.text = "'Алькантара' готова к выходу в море, однако капитан галеона ждет прибытия каравеллы-латины 'Нинья' из Картахены с грузом боеприпасов. Дело в том, что на 'Алькантаре' недостаточно пороха, и испанец не решается отправиться в путь. Однако терпение его не безгранично, и если 'Нинья' не прибудет через три дня, галеон покинет Порто Белло\nНа нем будет нехватка пороха, и я смогу навязать ему затяжной морской бой, в котором буду иметь преимущество. Ваша задача - перехватить 'Нинью' и уничтожить ее. Вы вполне справитесь с этой каравеллой. Каравелла-латина - это устаревший тип кораблей, судно очень компактное, формой носа напоминает большую шлюпку, имеет три мачты с 'латинским' парусным вооружением. Такие корабли нынче редкость, так что вы вряд ли её упустите. Народу на ней будет немного, но экипаж наверняка будет из морских волков. У испанцев тяжко сейчас с кораблями, но не с людьми. Потопите, абордируйте её - мне все равно. Лишь бы это корыто не добралось до Порто Белло!\nЕсли вы успешно выполните эту работу - отправляйтесь на Гваделупу и идите к Жерару Лекруа - ведь вы знаете его, так? Он выдаст вам заслуженный гонорар.";
			link.l1 = "Договорились! Отправляюсь на перехват 'Ниньи'!";
			link.l1.go = "florian_19";
		break;
