...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "guardmask_11":
			...
			Log_Info("Вы получили 'Меч Стража'");
			RemoveCharacterEquip(pchar, BLADE_ITEM_TYPE);
			dialog.text = "Как долго я ждал этого момента! Теперь я могу уходить... Но на прощание я хочу передать тебе свой меч и частицу своей силы. Это будет последний подарок, который когда-либо делал Альберто Каскос.";
			link.l1 = "...";
