...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "spa_prisoner_4":
			...
			link.l1 = "Кто и зачем организовал столь масштабное нападение на Форт де Франс?";
		...
		case "spa_prisoner_9":
			...
			link.l1 = "Я вам скажу следующее: в форте Форт де Франса никогда не было серебра, а на складах - бакаута и шелка. А вот теперь хорошо подумайте, офицер, перед тем как отвечать, ибо если ваш ответ мне не понравится, я развернусь и уйду, оставив вас своей судьбе... весьма печальной судьбе.";
			link.l1.go = "spa_prisoner_10";			
		break;
		
		case "spa_prisoner_10":
			dialog.text = "Я вас внимательно слушаю.";
			link.l1 = "Я не верю, что единственной целью налета был банальный грабеж. Форт де Франс - далеко не такая богатая колония, чтобы присылать сюда эскадру во главе с линейным кораблем. Наверняка вы, или ваш командир, или кто-то еще, имел дополнительные приказы или указания. Какие именно? Хорошенько подумайте, прежде чем отвечать...";
		...
		case "spa_prisoner_14":
			dialog.text = "Хорошо. Дон Диего де Монтойя инструктировал штурмовые роты, что нужно в обязательном порядке найти и взять в плен человека по имени Мигель Дичозо, который находится где-то в Форт де Франсе под защитой властей.";
		...
		case "spa_prisoner_23":
			dialog.text = "Барон в запале как-то утверждал, что уверен в том, что Дичозо его предал. Подробностей я не знаю. Потом появился дон Диего де Монтойя, который, как я понимаю, и сообщил барону, что Мигель Дичозо может быть в Форт де Франсе.";
		...
		case "spa_prisoner_46":
			...
			link.l1 = "Согласен. Расскажите, не сильно вы поплатились на службе за свое пленение в Форт де Франсе?";
		...
		case "boatsvandega_1":
			dialog.text = "Да кто же во французских колониях не слышал про капитана по имени "+GetFullName(pchar)+", разгромившего наголову испанскую эскадру во главе с линейным кораблем, напавшую на Форт де Франс, и перебившего весь вражеский десант! Вы, можно сказать, национальный герой!";
