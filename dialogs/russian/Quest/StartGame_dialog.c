...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			AddDialogExitQuest("Sharlie_onLand");
		...
		case "Node_5":
			...
			link.l1.go  = "Teach_1";
			link.l2     = "Не волнуйся, у меня же с головой проблемы были, а не с руками. Сойду-ка я на берег, а то одичал"+ GetSexPhrase("","а") +" совсем.";
			link.l2.go  = "Finish_1";
		break;
		...
		case "Finish_1":
			if (pchar.name == "Джессика")
			{
				dialog.text = "Мы сейчас у берегов Мартиники. Нужно как-то начинать новую жизнь без всех этих Масок и Белтропов, будь они неладны... То есть, пусть земля им будет пухом, я хотел сказать... А мы уж вас не подведём, капитан. Ваша команда останется с вами до конца.";
			...
			{
				dialog.text = "Мы сейчас у берегов Мартиники, прогуляйтесь, да возвращайтесь. Мы уж соскучились по настоящему делу - старый корабль продать пришлось, а на этом много не навоюешь. Так, перебивались в ожидании вашего выздоровления. А парни в вас верят, иначе бы разбежались давно...";
		...
		case "Advice_10":
			dialog.text = "Знайте, что казематы находятся в городах, в фортах их не ищите.";
