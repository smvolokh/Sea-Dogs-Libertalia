void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "monk_caleuche_2":
			if (CheckAttribute(pchar, "questTemp.Caleuche.Skul"))
			{
				dialog.text = "Потому что вы много сделали для Республики Соединённых Провинций. Вы на хорошем счету в Компании, дружны с губернатором. Я уже обращался во все инстанции и получил пренебрежительный отказ, но надеюсь, что столь благородный человек, как вы, прислушается к скромной просьбе служителя Господа.";
			}
			else
			{
