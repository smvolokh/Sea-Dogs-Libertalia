...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "shadows_15":
			dialog.text = "На счет Элизы Мак Артур ни в бумагах Ледбиттера, ни в архивах Блейза ничего не было. Все-таки странно, что Беатрисс ничего не сказала Блейзу о рождении племянницы. Это на нее не похоже.";
		...
		case "terrapin_14":
			dialog.text = "Не горячись, "+pchar.name+"! Во-первых, то, что пресловутая Молли Джонс на самом деле - Кэтрин Фокс, конечно, возможно, но не доказано. Может, Кати сейчас спокойно сидит в Лондоне и ждет отбытия эскадры Кромвеля\nВо-вторых, англичане пока не рискуют ломать зубы о стены Ля-Роша. У них хватает других проблем. Но если наша догадка верна, и полковник Фокс узнает, что его дочь в плену, он устроит Левассеру морскую блокаду и, дождавшись линейной эскадры, пойдет на штурм. Мало кто сравнится с морскими лисами в ближнем бою\nА калибры флагмана эскадры смогут легко поспорить с пушками Левассера. Если этот еретик не выдаст Кэтрин и голову Мартэна впридачу, уверен, не пройдет и трех дней, как полковник Фокс, не считаясь с потерями, сравняет Ля-Рош с землей, а на развалинах водрузит английский флаг. Оно нам надо?";
		...
		case "patria_18":
			...
			dialog.text = "Ха-ха-ха! А ты молодец! Забирай свое высокопреосвященство. И передай Пуанси, пусть готовит денежки: вы будете теперь долго и дорого платить за то, что сделали с Левассером и Тортугой. И ваши торгаши будут нам платить, товарами и кораблями. Ха-ха-ха! Привозите нам на Архипелаг еще баронов, за них хорошо платят! Ха-ха-ха!";
		...
		case "patria_31":
			...
			dialog.text = "И я тоже этому чертовски рад, "+pchar.name+". Заходи в гости, как время будет!";
			link.l1 = "Обязательно!";
