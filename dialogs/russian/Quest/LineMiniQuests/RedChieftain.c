	...
	switch(Dialog.CurrentNode)
	{
		...
		case "RedChieftain_5":
			...
			else
			{
				...
				pchar.questTemp.RedChieftain.Add2 = "у мыса Перлас, что недалеко от Блуфилдс";
				dialog.text = "Они находиться в лагерь на берегу моря на мыс Перлас, что близко поселения англичан Блуфилдс. Каждый день они выходить на лодках в море и нырять вода, глубоко-глубоко...";
		...
		case "RedChieftain_9":
			...
			link.l1 = "Ясно. Для этой операции нужен корабль пятого класса... Люггер или шлюп желательно. Хм. На одном шлюпе против двух шхун... а, ладно, справимся как-нибудь!";
