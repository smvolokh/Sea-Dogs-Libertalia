...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "carpenter_1":
			sTemp = "гафельный шлюп 'Аделина'";
			if (pchar.questTemp.Sharlie.Ship == "sloop") sTemp = "лёгкий шлюп 'Черный пес'";
			dialog.text = "На нашей верфи. Не так давно вы приобрели у нас корабль, "+sTemp+". Припоминаете? Я плотник с верфи Форт де Франса.";
		...
		case "carpenter_3":
			...
			SetFunctionTimerCondition("FMQG_Activation", 0, 0, 5, false);
		break;
		...
		case "officer_5":
			...
			dialog.text = "Эта смола, дорогой 'мастер-корабел', является стратегическим товаром, и ее оборот находится под строгим контролем губернатора! Но раз вы утверждаете, что это ваша смола - будь по-вашему. Вы арестованы, месье "+GetFullName(npchar)+", и сейчас отправитесь за решетку, а завтра дадите объяснения, откуда у вас взялись эти бочки! И не беспокойтесь, мы во всем разберемся! А вы, капитан, можете быть свободны. Сегодня вам повезло.";
			link.l1 = "";
		...
		case "officer_9":
			dialog.text = "Хорошо. Я отдам вам вашу смолу. Но у меня ее ровно половина от того количества, которое вы привезли в Форт де Франс. Надеюсь, вас это удовлетворит, ибо большего предложить я не могу.";
		...
		case "officer_11":
			dialog.text = "Капитан, забирайте какую есть смолу и свою жизнь впридачу, и убирайтесь прочь. К этой сделке я добавляю свое обещание не чинить вам козней в Форт де Франсе. Большего вы не получите.";
