	...
	switch(Dialog.CurrentNode)
	{
		...
		case "greguar":
			...
			if (CheckAttribute(pchar, "questTemp.HWIC") || pchar.Ship.Type == SHIP_NOTUSED)
			{
				...
				link.l1 = "Месье Валинье, какая встреча! Мои скромные успехи - такая же ваша заслуга, как и моя. Мне тоже очень приятно видеть вас в Форт де Франсе. Удачи!";
		...
		case "greguar_2":
			dialog.text = "Правильное решение, мой друг! Вперед, деньги вам не помешают, верно? Кстати, как поживает ваш друг?";
			link.l1 = "Деньги никогда не помешают, это верно. Мишель? Мой друг здоров, но скучает. Завидую ему иногда... Отплываем!";
			link.l1.go = "exit";
