...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "noble_13":
			...
			link.l1 = "Так вот в чем дело! Ох уж эти родственнички! Продолжайте.";
			link.l1.go = "noble_14";
		break;
		...
		case "noble_15":
			dialog.text = "Деньги?! О! Да, конечно, но... и титул маркиза! Конечно! А моя кузина станет таким образом достойной парой своему будущему мужу! О, Небеса! Как же я был глуп!";
		...
		case "noble_17":
			...
			link.l1 = "Как я вас понимаю! Знали бы вы, сеньор, сколько у меня в Европе было... неприятностей из-за милых и юных девиц! Но вам надо что-то предпринять, дон Доминго. Может, тайком отплыть в Испанию и навестить вашу кузину?";
			link.l1.go = "noble_18";
		break;
		...
		case "noble_43":
			...
			dialog.text = "Ну и, наконец, в знак моей высочайшей признательности к вам и во имя нашей дружбы я дарю вам свою саблю. Она хорошо служила мне - пусть теперь послужит и вам. И вы, глядя на нее, всегда будете вспоминать своего испанского друга - маркиза Доминго Альбалате!";
			link.l1 = "Благодарствую, сеньор! Не ожидал...";
			link.l1.go = "noble_44";
		break;
		
		case "noble_44":
			Log_Info("Вы получили испанскую саблю");
			PlaySound("interface\important_item.wav");
		...
		case "noble_47":
			dialog.text = "Ну, а Вам, капитан, я хочу сказать огромное спасибо! Был очень рад нашему знакомству! И в знак моей признательности я дарю вам свою саблю. Она хорошо служила мне - пусть теперь послужит и вам. И вы, глядя на нее, всегда будете вспоминать своего испанского друга - маркиза Доминго Альбалате!";
			link.l1 = "Благодарствую, сеньор! Не ожидал...";
			link.l1.go = "noble_48";
		break;
		...
		case "noble_48":
			...
			PlaySound("interface\important_item.wav");
			RemoveCharacterEquip(npchar, BLADE_ITEM_TYPE);
			GiveItem2Character(pchar, "newblade25");
		...
		case "ugo_1":
			dialog.text = "Да, это особняк Альбалате, весьма скормный, но очень уютный. Мое имя Уго, и я слуга молодого сеньора. Вы к дону Доминго?";
