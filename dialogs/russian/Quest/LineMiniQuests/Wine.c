void ProcessDialogEvent()
{
	...
	break;
		...
		case "Wine_take_1":
			...
			dialog.text = "Благодарю вас от всей души, " + GetAddress_Form(NPChar) + "! Возьмите этот кинжал в качестве дополнительной благодарности, может пригодиться когда-нибудь, а мне он всё равно без надобности. А теперь мне пора идти. Всего доброго!";
