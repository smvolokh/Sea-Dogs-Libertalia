...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Sergio_1":
			dialog.text = "Я слышал, как вы расспрашивали о человеке по имени Хуан, и болезнях в нашей тюрьме...";
		...
		case "Sergio_24":
			dialog.text = "Капитан, вы показались мне честным человеком, которому можно доверять. Также немоважное значение имеет то, что вы - француз, и у вас есть свой корабль. Я предлагаю заключить торговое соглашение.";
