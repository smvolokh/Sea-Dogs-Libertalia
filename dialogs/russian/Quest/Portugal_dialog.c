void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Portugal_doctor_2":
			...
			link.l1 = "Вам не зачем более беспокоится об этих людях, доктор. Мои ребята присмотрят за домом на всякий случай, а мне пора к губернатору. Полагаю, он будет рад. Не отлучайтесь, пока я не вернусь, док.";
		...
		case "Avendel_LeFransua_2":
			...
			link.l1 = "Прекрасно! Теперь ты еще и торгуешься? Нет, друг мой – твое участие в этом деле закончилось! Свои деньги ты упустил в таверне Форт де Франса. Ты бросил их там и сбежал, так что говорить более не о чем.";
