...
PlaySound("VOICE\Russian\GOTHIC\GG_HALLO_M\GG_HALLO_M_" + rand(15) + ".wav");
		...
		case "rudnik_soldier":
PlaySound("VOICE\Russian\GOTHIC\GG_HALLO_M\GG_HALLO_M_" + rand(15) + ".wav");
            dialog.text = RandPhraseSimple(RandPhraseSimple("Все вопросы - к управляющему рудника.", "Только не отвлекай рабов и заключенных от работы своими разговорами, приятель."), RandPhraseSimple("Моя задача - гонять этих бездельников.", "Ну и жарища же сегодня... впрочем, как и всегда."));
			link.l1 = RandPhraseSimple("Понятно...", "Ясно...");
			link.l1.go = "exit";
		break;
		// охрана - протектор
