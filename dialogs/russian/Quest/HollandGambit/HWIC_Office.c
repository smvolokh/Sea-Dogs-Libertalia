...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "HWIC_headclerk":
			...
			{
				link.l4 = "У меня есть один занятный документ, минхер. Прочтите его начало. Тут кое-что интересное про Голландию. Если он вас заинтересует - то я его вам отдам, там указаны точные координаты места встречи. Но, конечно, не бесплатно.";
				link.l4.go = "depeshe";	
			}
			// калеуче
