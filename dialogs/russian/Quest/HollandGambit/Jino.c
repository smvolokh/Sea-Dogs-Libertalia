...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "meeting_5":
			...
			link.l1 = "Хм. Как говорил мой друг - не стоит брезговать научиться делать что-либо собственными руками. Конечно, хочу. А что ты можешь мне показать?";
		...
		case "rome_2":
			...
			link.l1 = "Вот-вот. Я хочу выучить их и при случае утереть нос заносчивому... знакомому.";
			link.l1.go = "rome_3";
		break;
	...
	// ----------------------------------------- Португалец ----------------------------------------------------
		...
		case "guardoftruth_21":
			...
			link.l1 = "Как ты сейчас сказал? 'Коготь вождя'? Черт возьми, но эта дага у меня! Мне ее отдал Фадей в уплату долга моего друга! Смотри!";
		...
		case "guardoftruth_27":
			...
			link.l1 = "Можно попробовать... Джино, как заставить Стража Истины показать, где находится остров? Ты сказал, что знаешь!";
		...
		case "guardoftruth_31":
			...
			link.l1 = "Я понимаю. Ладно, Джино, давай свой альманах и постарайся вспомнить, что тебе говорил индеец по поводу Стража Истины, ибо я намерен собрать его полностью. Я должен найти Ксочитэм, ибо уверен, что там отыщутся не только сокровища и артефакт майя, но и мой дорогой друг.";
