...
//---------------------------------------------против всех----------------------------------------------
		...
		case "Sailor_deck_7":
			...
			link.l1 = "Наденьте на него кандалы и глаз не спускать, ни днем, ни ночью, пока не прибудем на Доминику. Всем троим неотступно находится здесь. Отвечаете за него.";
		...
		case "Stivesant_2":
			...
			link.l1 = "Здравствуйте, минхер Стайвесант. Я получил доказательства его связи с английской разведкой и непосредственно с капитаном Флитвудом. По его наводке проклятый англичанин напал на нашу курьерскую бригантину с целью завладеть секретной перепиской компании.";
		...
		else
		{
			...
			dialog.text = "И я прошу вас зайти завтра в резиденцию - вы будете награждены от лица Республики Соединённых Провинций за ваши деяния в ее благо. Прошу вас не покидать город.";
		...
		case "Stivesant_14":
			dialog.text = "" + GetFullName(pchar) + ", именем Республики Соединённых Провинций, за проявленную инициативу в уничтожении врага голландской нации, государственного преступника Ричарда Флитвуда, вы награждаетесь именным оружием и денежной суммой в размере 100 000 песо. Поздравляю!";
	...
	ChangeCharacterNationReputation(pchar, HOLLAND, 25);
		...
		case "Stivesant_22":
			...
			link.l1 = "У западного побережья Эспаньолы вблизи Порт-о-Пренса, минхер. А осада Сан-Хосе преследовала целью получить материальное возмещение от испанцев за предшествовавшее нападение на Форт де Франс. Наши отношения с Испанией уже давно не отличаются теплотой и дружелюбием... Когда мне зайти за ответом?";
		...
		case "Stivesant_28":
			...
			{
				dialog.text = "И поэтому вы здесь, капитан. Не буду вдаваться в дипломатические дискуссы: ваш шеф чрезмерно зажрался на Синт-Маартене, поэтому настало время умерить его ненасытные аппетиты. И он это, я думаю, прекрасно понял. К вам, капитан " + GetFullName(pchar) + ", у нас тоже есть вопросы по недавним событиям, связанным с английским разбойником Ричардом Флитвудом, поэтому вы здесь задерживаетесь\nСержант! Примите оружие у капитана и проводите в комендатуру!";
		...
		case "Stivesant_29":
			dialog.text = "Слово в слово, капитан. Ваш командир все поймет, а вам вникать необязательно, это ничего не изменит. Всего доброго. Сержант, проводите месье " + GetFullName(pchar) + " к выходу!";
			link.l1 = "...";
		...
		case "Stivesant_33":
			dialog.text = "Немного странно видеть вас, капитан "+GetFullName(pchar)+", в этой роли... Надеюсь, вы сможете гарантировать неприкосновенность лиц, пришедших к вам на переговоры.";
		...
		case "Stivesant_42":
			dialog.text = "Итак, это вы - барон Ноэль Форже? Ба, да тут еще и наш вице-адмирал собственной персоной! Здравствуйте, здравствуйте, уважаемый месье вице-адмирал! Недаром про вас идет слава самого ловкого интригана архипелага - никогда не знаешь, на чьей вы стороне в данный момент...";
		...
		case "Stivesant_47":
			dialog.text = "Конечно, понимаю. Поэтому сразу указал вам человека, у которого этот миллион есть. Если же месье вице-адмирал откажет вам, то лучше всего для вас, барон, будет уплыть отсюда в Европу раньше, чем шевалье получит мое письмо, иначе вы рискуете остаться здесь навсегда. Ну а наш вице-адмирал.... конечно, он лишится своего адмиральского чина, но выкрутится... и, возможно, даже ликвидирует Пуанси своими методами, что меня вполне устроит\nНу, господа, вы меня услышали. Жду вас с миллионом в течение месяца у себя в резиденции. Свободный вход и выход гарантирую. Всего доброго!";
			link.l1 = "...";
		...
		case "Stivesant_49":
			...
			{
				dialog.text = "Я даже не сомневался, вице-адмирал "+GetFullName(pchar)+", что вы принесете мне эти деньги. Пожалуй, я даже маловато с вас запросил, ну да ладно... Барон - лишь пешка в вашей очередной игре, так? Чина и денег вам недостаточно, теперь вы желаете занять место де Пуанси, я прав? Согласитесь, миллион - невелика плата за должность генерал-губернатора французских колоний! Вы отобьете их за считаные месяцы, учитывая вашу железную хватку.";
