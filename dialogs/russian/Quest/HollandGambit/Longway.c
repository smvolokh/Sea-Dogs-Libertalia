...
//---------------------------------------------против всех-------------------------------------------------
		...
		case "Longway_prisoner_7":
			dialog.text = "Восточнее Мартиники есть маленький остров, с портовым городком Шарлотт-Таун. Высадите Лонгвэя там на берег и дайте ему оружие. На берегу Лонгвэй расскажет вам все, что знает о Лукасе Роденбурге.";
		...
		case "Longway_prisoner_0":
			dialog.text = "Мы уже прибыли на Доминику, английский капитан?";
		...
		case "Longway_prisoner_20":
			dialog.text = "Да, капитан. В течение недели вы сможете обнаружить его пинас у берегов этого острова.";
		...
		case "Longway_prisoner_21":
			dialog.text = "Последний совет, английский капитан. Если вы хотите подойти к пинасу Стайвесанта и не быть атакованным - у вас должен быть корабль, который не вызовет у него подозрений. А именно - 'Мейфенг'.";
