		...
		case "First time":
			if (CheckAttribute(pchar, "questTemp.HWIC.Holl"))
			{
				if (pchar.questTemp.HWIC.Holl == "AbbyInHouse")
				{
					...
					link.l1 = "Добрый день, Абигайль. Меня зовут " + GetFullName(pchar) + ". Я капитан, и служу на благо Республики Соединённых Провинций в целом и Голландской Вест-Индской Компании в частности.";
