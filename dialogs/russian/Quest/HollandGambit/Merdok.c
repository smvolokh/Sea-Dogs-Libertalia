...
//----------------------------------------против всех-------------------------------------------------------
		...
		case "Lucas_7":
			dialog.text = "Хм... Подобной информацией я не располагаю. Хотя подожди! Я точно знаю, что раз в месяц одно военное судно компании совершает скоростной переход между Филипсбургом и Виллемстадом, и обратно. На нем перевозится деловая корреспонденция Компании. Это боевая бригантина, называется 'Хооп'\nОбычно она выходит из Филипсбурга где-то в эти дни каждого месяца, возможно, даже сегодня, или завтра.";
