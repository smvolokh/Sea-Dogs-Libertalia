...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				Link.l1 = "Я выполнил ваше поручение. Мне удалось отыскать Гралама Лавуа.";
		...
		case "Sharlie_storehelper_1":
			dialog.text = "Зовут его Гралам Лавуа. Как выглядит? Тридцати пяти лет от роду, носит усы и бороду, обычно на нем длинный коричневый жилет и белая рубаха, и обязательно - треуголка, адмирал этакий, якорь ему в корму\nГде может быть? Ну уж точно не в Форт де Франсе - его нет в городе, я уже все ноги сбил, искавши и расспрашивавши горожан, так что можете не тратить тут время понапрасну. А шляться за городом у меня нет ни времени, ни желания.";
		...
		case "Sharlie_storehelper_3":
			...
			link.l1 = "Наймите другого. Или это действительно такая проблема, как сказал Гралам?";
		...
		case "Sharlie_storehelper_4":
			...
			link.l1 = "Ну, допустим, сейчас он явно не бездельничает, хе-хе. А сказал он, что никто во всем Форт де Франсе не пойдет к вам на службу, потому что... вы недостаточно платите своим работникам. Да, кстати, "+npchar.name+", с вас тысяча песо, как вы и обещали.";
		...
		case "Sharlie_storehelper_13":
			switch (sti(pchar.questTemp.Sharlie.Storehelper.Quality))
			{
				...
				case 1:
					...
					dialog.text = "Вам удалось найти действительно ценного работника! Он даже лучше, чем этот негодяй Гралам. Я очень и очень вами доволен, сударь. Возьмите вашу награду - пять тысяч песо. И вдовесок этот сундук с дублонами за ваше умение подбирать кадры. ";
					link.l1 = "Неождианно, зря Вас скрягой называют. Премного благодарен. Всего доброго, месье!";
					link.l1.go = "Sharlie_storehelper_14";
				break;
