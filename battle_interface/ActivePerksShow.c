...
void InitActivePerkShower()
{
	...
	objActivePerkShower.ShowParam.PosRect.top		= RecalculateVIcon(455);
...
int GetPerkPictureIndex(string perkName)
{
	switch(perkName)
	{
		...
		case "PoisonPerkA":	        return 31;	break;
		// boal <--
	}
...
string GetPerkTextureName(string perkName)
{
	switch(perkName)
	{
		...
		case "PoisonPerkA":			return "battle_interface\LandCommands.tga";	break;
	}
