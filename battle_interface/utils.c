...
void procTimerTimeOut()
{
	...
	StartlineQuestComplete(objTimerInterface.questtype, objTimerInterface.questname);
	GothicFQuestComplete(objTimerInterface.questtype, objTimerInterface.questname);
	GothicRQuestComplete(objTimerInterface.questtype, objTimerInterface.questname);
	GothicDQuestComplete(objTimerInterface.questtype, objTimerInterface.questname);
}