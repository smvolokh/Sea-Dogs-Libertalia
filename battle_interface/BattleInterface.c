...
#define 	FLAG_ADM		0	// Административные флаги
#define 	FLAG_HOL		1	// Голландские флаги
#define 	FLAG_ENG		2	// Английские флаги
#define 	FLAG_FRA		3	// Французские флаги
#define 	FLAG_SPA		4	// Испанские флаги
#define 	FLAG_ALT		5	// Альтернативные флаги 
#define 	FLAG_WHT		6	// Белые флаги
...
void BI_LaunchCommand()
{
	...
	case "BI_SailTo":
	    ...
	    if (!CheckEnemyCompanionDistance2GoAway(false) && !bBettaTestMode && !CheckAttribute(pchar, "CSM.FreeSailing")) // --> CheatSurfMenu // компаньон в беде
	    {
           PlaySound("interface\knock.wav");
	       break;
	    }
...
void SetShipPictureDataByShipTypeName(string sType)
{
	switch(sType)
	{
		...
		case "Gunboat": 		// Канонерская лодка
			BI_intNRetValue[0] = 0+0*16;
			BI_intNRetValue[1] = 0+0*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
		...
		case "GafelSloop": 		// Гафельный шлюп
			BI_intNRetValue[0] = 0+0*16;
			BI_intNRetValue[1] = 0+0*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
		...
		case "Contraband":	// Контрабандитский корабль
		...
		case "Warsloop":			// Боевой шлюп
			BI_intNRetValue[0] = 12+1*16;
			BI_intNRetValue[1] = 12+1*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "Tradesloop":			// Торговый шлюп
			BI_intNRetValue[0] = 12+1*16;
			BI_intNRetValue[1] = 12+1*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "Lightsloop":			// Лёгкий шлюп
			BI_intNRetValue[0] = 12+1*16;
			BI_intNRetValue[1] = 12+1*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "Latina":		// Каравелла-латина
			BI_intNRetValue[0] = 8+2*16;
			BI_intNRetValue[1] = 8+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "Redonda":			// Каравелла-редонда
		...
		case "Lightschooner":		// Лёгкая шхуна
			BI_intNRetValue[0] = 2+2*16;
			BI_intNRetValue[1] = 2+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "GafelSchooner": // Гафельная шхуна
			BI_intNRetValue[0] = 6+0*16;
			BI_intNRetValue[1] = 6+0*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "PatrolSchooner": // Патрульная шхуна
			BI_intNRetValue[0] = 6+0*16;
			BI_intNRetValue[1] = 6+0*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
		...
		case "TradeFleut":	// Торговый флейт
			BI_intNRetValue[0] = 12+0*16;
			BI_intNRetValue[1] = 12+0*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
		...
		case "ArmedBrigantine":	// Военная Бригантина
			BI_intNRetValue[0] = 14+1*16;
			BI_intNRetValue[1] = 14+1*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
		...
		case "BattleBrigantine":	// Боевая Бригантина
			BI_intNRetValue[0] = 14+1*16;
			BI_intNRetValue[1] = 14+1*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
		...
		case "Warbrig": // Усиленный бриг
			BI_intNRetValue[0] = 0+2*16;
			BI_intNRetValue[1] = 0+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "Fastbrig": // Лёгкий бриг
			BI_intNRetValue[0] = 0+2*16;
			BI_intNRetValue[1] = 0+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "Tradebrig": // Торговый бриг
			BI_intNRetValue[0] = 0+2*16;
			BI_intNRetValue[1] = 0+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "Armedbrig": // Военный бриг
			BI_intNRetValue[0] = 0+2*16;
			BI_intNRetValue[1] = 0+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "Battlebrig": // Боевой бриг
			BI_intNRetValue[0] = 0+2*16;
			BI_intNRetValue[1] = 0+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "TradeShip": // Торговый корабль
		...
		case "WarSchooner":		// Боевая шхуна
			BI_intNRetValue[0] = 2+2*16;
			BI_intNRetValue[1] = 2+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "FastSchooner":		// Быстрая шхуна
			BI_intNRetValue[0] = 2+2*16;
			BI_intNRetValue[1] = 2+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "LightCorvette":		// Лёгкий корвет
			BI_intNRetValue[0] = 6+2*16;
			BI_intNRetValue[1] = 6+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "LightPinnace":		// Лёгкий пинас
			BI_intNRetValue[0] = 0+1*16;
			BI_intNRetValue[1] = 0+1*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
		...
		case "SmallGaleon":		// Галеон
			BI_intNRetValue[0] = 4+2*16;
			BI_intNRetValue[1] = 4+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

         case "Polacca":                // Полакка
			BI_intNRetValue[0] = 10+2*16;
			BI_intNRetValue[1] = 10+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "Galeon_l":		// Лёгкий галеон
			BI_intNRetValue[0] = 4+2*16;
			BI_intNRetValue[1] = 4+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "SpaGaleon":		// Испанский галеон
			BI_intNRetValue[0] = 4+2*16;
			BI_intNRetValue[1] = 4+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "EngGaleon":		// Английский галеон
			BI_intNRetValue[0] = 4+2*16;
			BI_intNRetValue[1] = 4+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
		...
		case "BattleCorvette":		// Боевой Корвет
			BI_intNRetValue[0] = 6+2*16;
			BI_intNRetValue[1] = 6+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
		...
		case "WarCorvette":		// Военный Корвет
			BI_intNRetValue[0] = 6+2*16;
			BI_intNRetValue[1] = 6+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
		...
		case "FastCorvette":		// Быстрый Корвет
			BI_intNRetValue[0] = 6+2*16;
			BI_intNRetValue[1] = 6+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "FrenchCorvette":	// Французский корвет
			BI_intNRetValue[0] = 6+2*16;
			BI_intNRetValue[1] = 6+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "HeavyCorvette":		// Тяжёлый корвет
			BI_intNRetValue[0] = 6+2*16;
			BI_intNRetValue[1] = 6+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "CorsairCorvette":	// Корсарский корвет
			BI_intNRetValue[0] = 6+2*16;
			BI_intNRetValue[1] = 6+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "LightFrigate":	// Лёгкий фрегат
			BI_intNRetValue[0] = 6+2*16;
			BI_intNRetValue[1] = 6+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "EngFrigate":	// Английский Фрегат
			BI_intNRetValue[0] = 0+3*16;
			BI_intNRetValue[1] = 0+3*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "SpaFrigate":	// Испанский Фрегат
			BI_intNRetValue[0] = 4+4*16;
			BI_intNRetValue[1] = 4+4*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "SmallEastIndiaMan":	// Малый Ост-Индец
			BI_intNRetValue[0] = 0+1*16;
			BI_intNRetValue[1] = 0+1*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "MerchantShip":	// Купеческий корабль
			BI_intNRetValue[0] = 4+4*16;
			BI_intNRetValue[1] = 4+4*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "HeavyPinnace":		// Тяжёлый пинас
			BI_intNRetValue[0] = 0+3*16;
			BI_intNRetValue[1] = 0+3*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "TradePinnace":		// Торговый пинас
			BI_intNRetValue[0] = 0+1*16;
			BI_intNRetValue[1] = 0+1*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "HeavyGaleon":		// Тяжёлый галеон
			BI_intNRetValue[0] = 4+2*16;
			BI_intNRetValue[1] = 4+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "ArmedCorvette":	 // Усиленный корвет
			BI_intNRetValue[0] = 6+2*16;
			BI_intNRetValue[1] = 6+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
		...
		case "WarXebec":		// Военная шебека
			BI_intNRetValue[0] = 8+2*16;
			BI_intNRetValue[1] = 8+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "BattleXebec":		// Боевая шебека
			BI_intNRetValue[0] = 8+2*16;
			BI_intNRetValue[1] = 8+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "ArmedXebec":			// Усиленная шебека
		...
		case "HeavyGaleon":		// Тяжелый галеон
			BI_intNRetValue[0] = 12+2*16;
			BI_intNRetValue[1] = 12+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;              
                                   case "La_Marianna":		// Галеон Гроза морей
			BI_intNRetValue[0] = 12+2*16;
			BI_intNRetValue[1] = 12+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
		...
		case "WarFrigate":	// Военный фрегат
			BI_intNRetValue[0] = 4+4*16;
			BI_intNRetValue[1] = 4+4*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
                                  
		case "Frigate_H":		// Тяжёлый Фрегат
			BI_intNRetValue[0] = 0+3*16;
			BI_intNRetValue[1] = 0+3*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "LineFrigate":		// Линейный фрегат
			BI_intNRetValue[0] = 0+3*16;
			BI_intNRetValue[1] = 0+3*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "ArmedFrigate":		// Усиленный фрегат
			BI_intNRetValue[0] = 0+3*16;
			BI_intNRetValue[1] = 0+3*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "BattleFrigate":		// Боевой фрегат
			BI_intNRetValue[0] = 6+2*16;
			BI_intNRetValue[1] = 6+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "Privateer":		// Приватир
			BI_intNRetValue[0] = 4+4*16;
			BI_intNRetValue[1] = 4+4*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "PatrolFrigate":		// Патрульный фрегат
			BI_intNRetValue[0] = 6+2*16;
			BI_intNRetValue[1] = 6+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "CorsairFrigate":		// Корсарский фрегат
			BI_intNRetValue[0] = 6+2*16;
			BI_intNRetValue[1] = 6+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "WarGaleon":		// Военный галеон
			BI_intNRetValue[0] = 4+2*16;
			BI_intNRetValue[1] = 4+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "BattleGaleon":		// Боевой галеон
			BI_intNRetValue[0] = 4+2*16;
			BI_intNRetValue[1] = 4+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "BattleShip":		// Боевой корабль
		     	BI_intNRetValue[0] = 0+3*16;
		     	BI_intNRetValue[1] = 0+3*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "WarShip":		// Военный корабль
			BI_intNRetValue[0] = 2+3*16;
			BI_intNRetValue[1] = 2+3*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "LightLineship":		// Лёгкий линкор
			BI_intNRetValue[0] = 6+2*16;
			BI_intNRetValue[1] = 6+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "Lineship":		// Линейный корабль
			BI_intNRetValue[0] = 6+2*16;
			BI_intNRetValue[1] = 6+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "HeavyLineship":		// Тяжёлый линкор
			BI_intNRetValue[0] = 6+2*16;
			BI_intNRetValue[1] = 6+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "WarLineship":	// Военный линкор
			BI_intNRetValue[0] = 6+3*16;
			BI_intNRetValue[1] = 6+3*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "BattleLineship":  // Боевой линкор
			BI_intNRetValue[0] = 10+3*16;
			BI_intNRetValue[1] = 10+3*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "LSHIP_FRA":	// Французский линкор
			BI_intNRetValue[0] = 4+3*16;
			BI_intNRetValue[1] = 4+3*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
		
		case "LSHIP_HOL":	// Голландский линкор
			BI_intNRetValue[0] = 0+3*16;
			BI_intNRetValue[1] = 0+3*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "LSHIP_SPA":	// Испанский линкор
			BI_intNRetValue[0] = 8+3*16;
			BI_intNRetValue[1] = 8+3*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
		
		case "LSHIP_ENG":	// Английский линкор
			BI_intNRetValue[0] = 10+3*16;
			BI_intNRetValue[1] = 10+3*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
                                     case "LineShipHeavy":          // Тяжёлый линейный корабль
		...
		case "Valciria_quest":		// патрульный бриг "Черная Горгулья"
			BI_intNRetValue[0] = 0+4*16;
			BI_intNRetValue[1] = 0+4*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
		...
		case "ArabellaShip":	// быстрый фрегат "Фортуна"
			BI_intNRetValue[0] = 4+4*16;
			BI_intNRetValue[1] = 4+4*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

                                      case "ArabellaShipG":  // Фрегат Арабелла
			BI_intNRetValue[0] = 4+4*16;
			BI_intNRetValue[1] = 4+4*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
		...
		case "Flyingdutchman_h"://  "Летучий Голландец"
			BI_intNRetValue[0] = 8+4*16;
			BI_intNRetValue[1] = 8+4*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
		...
		case "FRIGATEQVEENT":	// фрегат "Месть королевы Анны"
			BI_intNRetValue[0] = 4+4*16;
			BI_intNRetValue[1] = 4+4*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "CORVETTE_QUESTT":	// тяжелый корвет "Зебра"
			BI_intNRetValue[0] = 4+4*16;
			BI_intNRetValue[1] = 4+4*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "FRIGATE_QUEST":	// фрегат "Черная Жемчужина"
			BI_intNRetValue[0] = 4+4*16;
			BI_intNRetValue[1] = 4+4*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "SOLEYRU":		// Линейный корабль "Солей Руаяль"
			BI_intNRetValue[0] = 10+4*16;
			BI_intNRetValue[1] = 10+4*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

	case "SOLEYPIR":		//Проклятый Линейный корабль "Солей Руаяль"
			BI_intNRetValue[0] = 6+4*16;
			BI_intNRetValue[1] = 6+4*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "BrigMirageSW":			// бриг
			BI_intNRetValue[0] = 0+2*16;
			BI_intNRetValue[1] = 0+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
		...
		case "Surprise":	// тяжелый корвет "Сюрприз"
			BI_intNRetValue[0] = 4+4*16;
			BI_intNRetValue[1] = 4+4*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "WaterFort":	// Плавучая Крепость "Исполин"
			BI_intNRetValue[0] = 4+4*16;
			BI_intNRetValue[1] = 4+4*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;

		case "Rossiya":	// фрегат "Россия"
			BI_intNRetValue[0] = 4+4*16;
			BI_intNRetValue[1] = 4+4*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
...
// CheatSurfMenu by Cheatsurfer -->
		// Лень делать для новых кораблей уникальные иконки, пусть юзаются по дефолту
		case "BlackPearl":      // ЧЖ
			BI_intNRetValue[0] = 8+4*16;
			BI_intNRetValue[1] = 8+4*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		...
		case "ManowarV":  		// Виктори
			BI_intNRetValue[0] = 2+3*16;
			BI_intNRetValue[1] = 2+3*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
		
		case "QAR": // "Месть Королевы Анны"
			BI_intNRetValue[0] = 4+4*16;
			BI_intNRetValue[1] = 4+4*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
				
		case "Constitution":	// фрегат "Конституция"
			BI_intNRetValue[0] = 4+4*16;
			BI_intNRetValue[1] = 4+4*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
		
		case "Speedy":			// бриг "Спиди"
			BI_intNRetValue[0] = 0+2*16;
			BI_intNRetValue[1] = 0+2*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
		
		case "Corvette_questCoAS":	// корвет "Пёс войны"
			BI_intNRetValue[0] = 2+4*16;
			BI_intNRetValue[1] = 2+4*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
		
		case "ArabellaShipCoAS":	// фрегат "Арабелла"
			BI_intNRetValue[0] = 4+4*16;
			BI_intNRetValue[1] = 4+4*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
		
		case "FrigateQueen":	// фрегат "Королева"
			BI_intNRetValue[0] = 4+4*16;
			BI_intNRetValue[1] = 4+4*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
		
		case "BrigSW":			// бриг "Морской волк"
			BI_intNRetValue[0] = 0+4*16;
			BI_intNRetValue[1] = 0+4*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
		
		case "BrigQueen":		// бриг "Королева"
			BI_intNRetValue[0] = 0+4*16;
			BI_intNRetValue[1] = 0+4*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
		
		case "LuggerQuestCoAS":	// джонка "Императрица"
			BI_intNRetValue[0] = 12+3*16;
			BI_intNRetValue[1] = 12+3*16 + 1;
			BI_intNRetValue[2] = BI_ICONS_TEXTURE_SHIP1;
		break;
...
void SetParameterData()
{
	...
	*/
	...
	///korsar328 собственно добавляем саму строку, но при этом пока я не разберусь с иконкой ускорения времени мы коментим линию которая под Ammunition ---->
...
ref procGetRiggingData()
{
	...
	{				
		...
		{	
			...
			else	   BI_intNRetValue[1] = FLAG_ADM; 	// приходится вот так вот изгаляться, тк не все модели тулом читаются :( 
		}				
	}	
	return &BI_intNRetValue;
}
