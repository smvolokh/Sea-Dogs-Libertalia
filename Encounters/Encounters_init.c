...
void InitEncounters()
{
	...
	Enc_AddClasses(rEnc, 1, 4, 5, 0, 0);
	Enc_AddClasses(rEnc, 1000,4, 5, 0, 0);
	...
	Enc_AddClasses(rEnc, 1, 3, 4, 0, 0);
	Enc_AddClasses(rEnc, 1000,3, 4, 0, 0);
	...
	Enc_AddClasses(rEnc, 1000,5, 6, 5, 6);
	...
	///////////////////////////////////////////////////////////////////////////////////////
	/// 3-5 торговца 2-3 класса плюс 2-4 корабля охраны 1-3 класса 
	///////////////////////////////////////////////////////////////////////////////////////
	...
	Enc_AddClasses(rEnc, 4, 2, 3, 1, 3);
	Enc_AddClasses(rEnc, 1000,2, 3, 1, 3);
	...
	///////////////////////////////////////////////////////////////////////////////////////
	/// 2-4 военных корабля 2-4 класса
	///////////////////////////////////////////////////////////////////////////////////////
	...
	Enc_AddClasses(rEnc, 2, 0, 0, 3, 4);
	Enc_AddClasses(rEnc, 1000,0, 0, 3, 4);
	
	///////////////////////////////////////////////////////////////////////////////////////
	/// 2-6 пирата 2-4 класса
	///////////////////////////////////////////////////////////////////////////////////////
	...
	///////////////////////////////////////////////////////////////////////////////////////
	/// 3-9 военных корабля 1-3 класса
	/////////////////////////////////////////////////////////////////////////////////////// 
	...
	///////////////////////////////////////////////////////////////////////////////////////
	/// 3-5 военных корабля 1-3 класса
	/////////////////////////////////////////////////////////////////////////////////////// 
	...
	///////////////////////////////////////////////////////////////////////////////////////
	/// 1-2 военных корабля 2-3 класса
	/////////////////////////////////////////////////////////////////////////////////////// 
	makeref(rEnc, EncountersTypes[ENCOUNTER_TYPE_WAR_KAPER]);
	rEnc.Type = ENCOUNTER_WAR;
	rEnc.MinRank = 4;
	rEnc.MaxRank = 1000;
	rEnc.Chance = 45;
	...
	///////////////////////////////////////////////////////////////////////////////////////
	/// 1-3 торговых корабля 3-4 класса (коронный торговец) + 1-3 корабля охранения 3-4 класса
	/////////////////////////////////////////////////////////////////////////////////////// 
	...
	Enc_AddClasses(rEnc, 4, 3, 4, 3, 4);
	Enc_AddClasses(rEnc, 1000,3, 4, 3, 4);
	
	///////////////////////////////////////////////////////////////////////////////////////
	/// 1 торговый корабля 2-3 класса  + 1 корабль охранения 1-3 класса (экспедиция)
	/////////////////////////////////////////////////////////////////////////////////////// 	
