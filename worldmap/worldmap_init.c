...
void wdmInitWorldMap()
{
	...
	ResetSound();
	PlaySound("MUSIC\Load_"+rand(5)+".mp3");
	...
	worldMap.labeltype.Town.heightView = 10000.0;
	...
	worldMap.labeltype.Shore.heightView = 10000.0;
	...
	*/
	...
	worldMap.labels.DestinyGiftPearl.type = "Island";
	worldMap.labels.DestinyGiftPearl.id = "DestinyGiftPearl";
	worldMap.labels.DestinyGiftPearl.locator = "DestinyGiftPearl";
	worldMap.labels.DestinyGiftPearl.text = CheckingTranslate(idLngFile,"DestinyGiftPearl");
	...
	worldMap.labels.Tenotchitlan_1.type = "Island";
	worldMap.labels.Tenotchitlan_1.id = "Tenotchitlan_1";
	worldMap.labels.Tenotchitlan_1.locator = "Tenotchitlan_1";
	worldMap.labels.Tenotchitlan_1.text = CheckingTranslate(idLngFile,"Tenotchitlan_1");
...
*/		
	...
	worldMap.labels.Tenotchitlann_1_town.type = "Town";
	worldMap.labels.Tenotchitlann_1_town.id = "Tenotchitlann_1_town";
	worldMap.labels.Tenotchitlann_1_town.locator = "Tenotchitlann_1_town";
	worldMap.labels.Tenotchitlann_1_town.text = CheckingTranslate(idLngFile,"Tenotchitlann_1_town");
	...
	worldMap.labels.Roseau_town.type = "Town";
	worldMap.labels.Roseau_town.id = "Roseau_town";
	worldMap.labels.Roseau_town.locator = "Roseau_town";
	worldMap.labels.Roseau_town.text = CheckingTranslate(idLngFile,"Roseau_town");
	worldMap.labels.Roseau_town.icon = PIRATE;

	worldMap.labels.VillaAlegria_town.type = "Town";
	worldMap.labels.VillaAlegria_town.id = "VillaAlegria_town";
	worldMap.labels.VillaAlegria_town.locator = "VillaAlegria_town";
	worldMap.labels.VillaAlegria_town.text = CheckingTranslate(idLngFile,"VillaAlegria_town");
	worldMap.labels.VillaAlegria_town.icon = SPAIN;

	worldMap.labels.Vestpunt_town.type = "Town";
	worldMap.labels.Vestpunt_town.id = "Vestpunt_town";
	worldMap.labels.Vestpunt_town.locator = "Vestpunt_town";
	worldMap.labels.Vestpunt_town.text = CheckingTranslate(idLngFile,"Vestpunt_town");
	worldMap.labels.Vestpunt_town.icon = PIRATE;

	worldMap.labels.SantLous_town.type = "Town";
	worldMap.labels.SantLous_town.id = "SantLous_town";
	worldMap.labels.SantLous_town.locator = "SantLous_town";
	worldMap.labels.SantLous_town.text = CheckingTranslate(idLngFile,"SantLous_town");
	worldMap.labels.SantLous_town.icon = PIRATE;

	worldMap.labels.PortAntonio_town.type = "Town";
	worldMap.labels.PortAntonio_town.id = "PortAntonio_town";
	worldMap.labels.PortAntonio_town.locator = "PortAntonio_town";
	worldMap.labels.PortAntonio_town.text = CheckingTranslate(idLngFile,"PortAntonio_town");
	worldMap.labels.PortAntonio_town.icon = HOLLAND;

	worldMap.labels.LeKe_town.type = "Town";
	worldMap.labels.LeKe_town.id = "LeKe_town";
	worldMap.labels.LeKe_town.locator = "LeKe_town";
	worldMap.labels.LeKe_town.text = CheckingTranslate(idLngFile,"LeKe_town");
	worldMap.labels.LeKe_town.icon = PIRATE;
...
*/
	...
	worldMap.labels.Shore80.type = "Shore";
	worldMap.labels.Shore80.id = "Shore80";
	worldMap.labels.Shore80.locator = "Shore80";
	worldMap.labels.Shore80.text = CheckingTranslate(idLngFile,"Shore80");

	worldMap.labels.Shore81.type = "Shore";
	worldMap.labels.Shore81.id = "Shore81";
	worldMap.labels.Shore81.locator = "Shore81";
	worldMap.labels.Shore81.text = CheckingTranslate(idLngFile,"Shore81");

	worldMap.labels.Shore82.type = "Shore";
	worldMap.labels.Shore82.id = "Shore82";
	worldMap.labels.Shore82.locator = "Shore82";
	worldMap.labels.Shore82.text = CheckingTranslate(idLngFile,"Shore82");

	worldMap.labels.Shore83.type = "Shore";
	worldMap.labels.Shore83.id = "Shore83";
	worldMap.labels.Shore83.locator = "Shore83";
	worldMap.labels.Shore83.text = CheckingTranslate(idLngFile,"Shore83");

	worldMap.labels.Shore84.type = "Shore";
	worldMap.labels.Shore84.id = "Shore84";
	worldMap.labels.Shore84.locator = "Shore84";
	worldMap.labels.Shore84.text = CheckingTranslate(idLngFile,"Shore84");

	worldMap.labels.Shore85.type = "Shore";
	worldMap.labels.Shore85.id = "Shore85";
	worldMap.labels.Shore85.locator = "Shore85";
	worldMap.labels.Shore85.text = CheckingTranslate(idLngFile,"Shore85");

	worldMap.labels.Shore86.type = "Shore";
	worldMap.labels.Shore86.id = "Shore86";
	worldMap.labels.Shore86.locator = "Shore86";
	worldMap.labels.Shore86.text = CheckingTranslate(idLngFile,"Shore86");

	worldMap.labels.Shore87.type = "Shore";
	worldMap.labels.Shore87.id = "Shore87";
	worldMap.labels.Shore87.locator = "Shore87";
	worldMap.labels.Shore87.text = CheckingTranslate(idLngFile,"Shore87");

	worldMap.labels.Shore88.type = "Shore";
	worldMap.labels.Shore88.id = "Shore88";
	worldMap.labels.Shore88.locator = "Shore88";
	worldMap.labels.Shore88.text = CheckingTranslate(idLngFile,"Shore88");

	worldMap.labels.Shore89.type = "Shore";
	worldMap.labels.Shore89.id = "Shore89";
	worldMap.labels.Shore89.locator = "Shore89";
	worldMap.labels.Shore89.text = CheckingTranslate(idLngFile,"Shore89");

	worldMap.labels.Shore90.type = "Shore";
	worldMap.labels.Shore90.id = "Shore90";
	worldMap.labels.Shore90.locator = "Shore90";
	worldMap.labels.Shore90.text = CheckingTranslate(idLngFile,"Shore90");

	worldMap.labels.Shore91.type = "Shore";
	worldMap.labels.Shore91.id = "Shore91";
	worldMap.labels.Shore91.locator = "Shore91";
	worldMap.labels.Shore91.text = CheckingTranslate(idLngFile,"Shore91");

	worldMap.labels.Shore92.type = "Shore";
	worldMap.labels.Shore92.id = "Shore92";
	worldMap.labels.Shore92.locator = "Shore92";
	worldMap.labels.Shore92.text = CheckingTranslate(idLngFile,"Shore92");

	worldMap.labels.Shore93.type = "Shore";
	worldMap.labels.Shore93.id = "Shore93";
	worldMap.labels.Shore93.locator = "Shore93";
	worldMap.labels.Shore93.text = CheckingTranslate(idLngFile,"Shore93");

	worldMap.labels.Shore94.type = "Shore";
	worldMap.labels.Shore94.id = "Shore94";
	worldMap.labels.Shore94.locator = "Shore94";
	worldMap.labels.Shore94.text = CheckingTranslate(idLngFile,"Shore94");

	worldMap.labels.Shore95.type = "Shore";
	worldMap.labels.Shore95.id = "Shore95";
	worldMap.labels.Shore95.locator = "Shore95";
	worldMap.labels.Shore95.text = CheckingTranslate(idLngFile,"Shore95");

	worldMap.labels.Shore96.type = "Shore";
	worldMap.labels.Shore96.id = "Shore96";
	worldMap.labels.Shore96.locator = "Shore96";
	worldMap.labels.Shore96.text = CheckingTranslate(idLngFile,"Shore96");

	worldMap.labels.Shore97.type = "Shore";
	worldMap.labels.Shore97.id = "Shore97";
	worldMap.labels.Shore97.locator = "Shore97";
	worldMap.labels.Shore97.text = CheckingTranslate(idLngFile,"Shore97");

	worldMap.labels.Shore98.type = "Shore";
	worldMap.labels.Shore98.id = "Shore98";
	worldMap.labels.Shore98.locator = "Shore98";
	worldMap.labels.Shore98.text = CheckingTranslate(idLngFile,"Shore98");

	worldMap.labels.Shore99.type = "Shore";
	worldMap.labels.Shore99.id = "Shore99";
	worldMap.labels.Shore99.locator = "Shore99";
	worldMap.labels.Shore99.text = CheckingTranslate(idLngFile,"Shore99");

	worldMap.labels.Shore100.type = "Shore";
	worldMap.labels.Shore100.id = "Shore100";
	worldMap.labels.Shore100.locator = "Shore100";
	worldMap.labels.Shore100.text = CheckingTranslate(idLngFile,"Shore100");

	worldMap.labels.Shore101.type = "Shore";
	worldMap.labels.Shore101.id = "Shore101";
	worldMap.labels.Shore101.locator = "Shore101";
	worldMap.labels.Shore101.text = CheckingTranslate(idLngFile,"Shore101");

	worldMap.labels.Shore102.type = "Shore";
	worldMap.labels.Shore102.id = "Shore102";
	worldMap.labels.Shore102.locator = "Shore102";
	worldMap.labels.Shore102.text = CheckingTranslate(idLngFile,"Shore102");

	worldMap.labels.Shore103.type = "Shore";
	worldMap.labels.Shore103.id = "Shore103";
	worldMap.labels.Shore103.locator = "Shore103";
	worldMap.labels.Shore103.text = CheckingTranslate(idLngFile,"Shore103");

	worldMap.labels.Shore104.type = "Shore";
	worldMap.labels.Shore104.id = "Shore104";
	worldMap.labels.Shore104.locator = "Shore104";
	worldMap.labels.Shore104.text = CheckingTranslate(idLngFile,"Shore104");

	worldMap.labels.Shore105.type = "Shore";
	worldMap.labels.Shore105.id = "Shore105";
	worldMap.labels.Shore105.locator = "Shore105";
	worldMap.labels.Shore105.text = CheckingTranslate(idLngFile,"Shore105");

	worldMap.labels.Shore106.type = "Shore";
	worldMap.labels.Shore106.id = "Shore106";
	worldMap.labels.Shore106.locator = "Shore106";
	worldMap.labels.Shore106.text = CheckingTranslate(idLngFile,"Shore106");

	worldMap.labels.Shore107.type = "Shore";
	worldMap.labels.Shore107.id = "Shore107";
	worldMap.labels.Shore107.locator = "Shore107";
	worldMap.labels.Shore107.text = CheckingTranslate(idLngFile,"Shore107");

	worldMap.labels.Shore108.type = "Shore";
	worldMap.labels.Shore108.id = "Shore108";
	worldMap.labels.Shore108.locator = "Shore108";
	worldMap.labels.Shore108.text = CheckingTranslate(idLngFile,"Shore108");

	worldMap.labels.Shore109.type = "Shore";
	worldMap.labels.Shore109.id = "Shore109";
	worldMap.labels.Shore109.locator = "Shore109";
	worldMap.labels.Shore109.text = CheckingTranslate(idLngFile,"Shore109");

	worldMap.labels.Shore114.type = "Shore";
	worldMap.labels.Shore114.id = "Shore114";
	worldMap.labels.Shore114.locator = "Shore114";
	worldMap.labels.Shore114.text = CheckingTranslate(idLngFile,"Shore114");

	worldMap.labels.Shore115.type = "Shore";
	worldMap.labels.Shore115.id = "Shore115";
	worldMap.labels.Shore115.locator = "Shore115";
	worldMap.labels.Shore115.text = CheckingTranslate(idLngFile,"Shore115");

	worldMap.labels.Shore116.type = "Shore";
	worldMap.labels.Shore116.id = "Shore116";
	worldMap.labels.Shore116.locator = "Shore116";
	worldMap.labels.Shore116.text = CheckingTranslate(idLngFile,"Shore116");

	worldMap.labels.Shore117.type = "Shore";
	worldMap.labels.Shore117.id = "Shore117";
	worldMap.labels.Shore117.locator = "Shore117";
	worldMap.labels.Shore117.text = CheckingTranslate(idLngFile,"Shore117");

	worldMap.labels.Shore118.type = "Shore";
	worldMap.labels.Shore118.id = "Shore118";
	worldMap.labels.Shore118.locator = "Shore118";
	worldMap.labels.Shore118.text = CheckingTranslate(idLngFile,"Shore118");

	worldMap.labels.Shore123.type = "Shore";
	worldMap.labels.Shore123.id = "Shore123";
	worldMap.labels.Shore123.locator = "Shore123";
	worldMap.labels.Shore123.text = CheckingTranslate(idLngFile,"Shore123");

	worldMap.labels.Shore124.type = "Shore";
	worldMap.labels.Shore124.id = "Shore124";
	worldMap.labels.Shore124.locator = "Shore124";
	worldMap.labels.Shore124.text = CheckingTranslate(idLngFile,"Shore124");

	worldMap.labels.Shore125.type = "Shore";
	worldMap.labels.Shore125.id = "Shore125";
	worldMap.labels.Shore125.locator = "Shore125";
	worldMap.labels.Shore125.text = CheckingTranslate(idLngFile,"Shore125");

	worldMap.labels.Shore126.type = "Shore";
	worldMap.labels.Shore126.id = "Shore126";
	worldMap.labels.Shore126.locator = "Shore126";
	worldMap.labels.Shore126.text = CheckingTranslate(idLngFile,"Shore126");

	worldMap.labels.Shore127.type = "Shore";
	worldMap.labels.Shore127.id = "Shore127";
	worldMap.labels.Shore127.locator = "Shore127";
	worldMap.labels.Shore127.text = CheckingTranslate(idLngFile,"Shore127");

	worldMap.labels.Shore128.type = "Shore";
	worldMap.labels.Shore128.id = "Shore128";
	worldMap.labels.Shore128.locator = "Shore128";
	worldMap.labels.Shore128.text = CheckingTranslate(idLngFile,"Shore128");

	worldMap.labels.Shore129.type = "Shore";
	worldMap.labels.Shore129.id = "Shore129";
	worldMap.labels.Shore129.locator = "Shore129";
	worldMap.labels.Shore129.text = CheckingTranslate(idLngFile,"Shore129");

	worldMap.labels.Shore130.type = "Shore";
	worldMap.labels.Shore130.id = "Shore130";
	worldMap.labels.Shore130.locator = "Shore130";
	worldMap.labels.Shore130.text = CheckingTranslate(idLngFile,"Shore130");

	worldMap.labels.Shore131.type = "Shore";
	worldMap.labels.Shore131.id = "Shore131";
	worldMap.labels.Shore131.locator = "Shore131";
	worldMap.labels.Shore131.text = CheckingTranslate(idLngFile,"Shore131");
	...
	worldMap.WindF = 0.1;//Нормализованая сила ветра 0..1
	//=========================================================================
	...
	worldMap.islands.Antigua.Shore91.position.x = 932.911;
	worldMap.islands.Antigua.Shore91.position.z = 139.498;
	worldMap.islands.Antigua.Shore92.position.x = 899.583;
	worldMap.islands.Antigua.Shore92.position.z = 63.5302;
	worldMap.islands.Antigua.Shore93.position.x = 853.093;
	worldMap.islands.Antigua.Shore93.position.z = 98.8799;
	...
	worldMap.islands.Curacao.Vestpunt_port.position.x = 347.313;
	worldMap.islands.Curacao.Vestpunt_port.position.z = -705.112;
	worldMap.islands.Curacao.Shore24.position.x = 455.427;
	worldMap.islands.Curacao.Shore24.position.z = -740.655;
	worldMap.islands.Curacao.Shore23.position.x = 260.755;
	worldMap.islands.Curacao.Shore23.position.z = -618.715;
	...
	worldMap.islands.SentMartin.Shore103.position.x = 919.765;
	worldMap.islands.SentMartin.Shore103.position.z = 472.331;
	worldMap.islands.SentMartin.Shore104.position.x = 943.784;
	worldMap.islands.SentMartin.Shore104.position.z = 492.408;
	worldMap.islands.SentMartin.Shore105.position.x = 947.41;
	worldMap.islands.SentMartin.Shore105.position.z = 526.58;
	...
	worldMap.islands.Guadeloupe.Shore30.position.x = 546.505;
	worldMap.islands.Guadeloupe.Shore30.position.z = -70.4683;
	worldMap.islands.Guadeloupe.SantLous_Port.position.x = 596.108;
	worldMap.islands.Guadeloupe.SantLous_Port.position.z = -64.8827;
	worldMap.islands.Guadeloupe.Shore31.position.x = 555.749;
	worldMap.islands.Guadeloupe.Shore31.position.z = -91.4099;
	worldMap.islands.Guadeloupe.Shore83.position.x = 527.794;
	worldMap.islands.Guadeloupe.Shore83.position.z = -17.8862;
	worldMap.islands.Guadeloupe.Shore80.position.x = 584.749;
	worldMap.islands.Guadeloupe.Shore80.position.z = 27.088;
	...
	worldMap.islands.Martinique.Shore89.position.x = 544.468;
	worldMap.islands.Martinique.Shore89.position.z = -338.818;
	...
	worldMap.islands.Bermudes.Shore131.position.x = 1018.48;
	worldMap.islands.Bermudes.Shore131.position.z = 1007.09;
	...
	worldMap.islands.Maracaibo.Shore106.position.x = 209.124;
	worldMap.islands.Maracaibo.Shore106.position.z = -957.927;
	worldMap.islands.Maracaibo.Shore107.position.x = 219.093;
	worldMap.islands.Maracaibo.Shore107.position.z = -867.788;
	...
	worldMap.islands.Beliz.Shore117.position.x = -967.48;
	worldMap.islands.Beliz.Shore117.position.z = -96.936;
	worldMap.islands.Beliz.Shore118.position.x = -885.887;
	worldMap.islands.Beliz.Shore118.position.z = -543.16;
	//  не сделано -->
	...
	worldMap.islands.Jamaica.Shore35.position.x = -418.877;
	worldMap.islands.Jamaica.Shore35.position.z = -111.693;
	worldMap.islands.Jamaica.Mayak3.position.x = -224.127;
	worldMap.islands.Jamaica.Mayak3.position.z = -163.435;
	worldMap.islands.Jamaica.Shore84.position.x = -462.332;
	worldMap.islands.Jamaica.Shore84.position.z = -90.2574;
	worldMap.islands.Jamaica.Shore85.position.x = -432.584;
	worldMap.islands.Jamaica.Shore85.position.z = -61.3437;
	worldMap.islands.Jamaica.Shore86.position.x = -401.783;
	worldMap.islands.Jamaica.Shore86.position.z = -57.3384;
	worldMap.islands.Jamaica.Shore87.position.x = -211.188;
	worldMap.islands.Jamaica.Shore87.position.z = -93.6436;
	worldMap.islands.Jamaica.Shore88.position.x = -270.137;
	worldMap.islands.Jamaica.Shore88.position.z = -69.6396;
	worldMap.islands.Jamaica.Shore90.position.x = -152.439;
	worldMap.islands.Jamaica.Shore90.position.z = -160.916;
	worldMap.islands.Jamaica.Antonio_port.position.x = -158.585;
	worldMap.islands.Jamaica.Antonio_port.position.z = -118.477;
	...
	worldMap.islands.PuertoRico.VillaAlegria_port.position.x = 392.82;
	worldMap.islands.PuertoRico.VillaAlegria_port.position.z = 501.808;
	worldMap.islands.PuertoRico.Shore44.position.x = 381.083;
	worldMap.islands.PuertoRico.Shore44.position.z = 447.538;
	worldMap.islands.PuertoRico.Shore45.position.x = 602.049;
	worldMap.islands.PuertoRico.Shore45.position.z = 458.322;
	worldMap.islands.PuertoRico.Shore81.position.x = 449.547;
	worldMap.islands.PuertoRico.Shore81.position.z = 424.37;
	worldMap.islands.PuertoRico.Shore82.position.x = 454.396;
	worldMap.islands.PuertoRico.Shore82.position.z = 509.846;
	worldMap.islands.PuertoRico.Shore94.position.x = 406.107;
	worldMap.islands.PuertoRico.Shore94.position.z = 517.714;
	worldMap.islands.PuertoRico.Shore95.position.x = 521.497;
	worldMap.islands.PuertoRico.Shore95.position.z = 413.641;
	...
	worldMap.islands.Cuba1.Shore125.position.x = -242.198;
	worldMap.islands.Cuba1.Shore125.position.z = 784.498;
	...
	worldMap.islands.Cuba2.Shore123.position.x = -616.065;
	worldMap.islands.Cuba2.Shore123.position.z = 854.219;
	worldMap.islands.Cuba2.Shore124.position.x = -540.192;
	worldMap.islands.Cuba2.Shore124.position.z = 843.269;
	...
	worldMap.islands.Tortuga.Shore126.position.x = 72.9146;
	worldMap.islands.Tortuga.Shore126.position.z = 889.649;
	...
	worldMap.islands.Trinidad.Shore127.position.x = 890.341;
	worldMap.islands.Trinidad.Shore127.position.z = -848.948;
	worldMap.islands.Trinidad.Shore128.position.x = 941.306;
	worldMap.islands.Trinidad.Shore128.position.z = -822.883;
	worldMap.islands.Trinidad.Shore129.position.x = 832.338;
	worldMap.islands.Trinidad.Shore129.position.z = -764.32;
	worldMap.islands.Trinidad.Shore130.position.x = 931.557;
	worldMap.islands.Trinidad.Shore130.position.z = -704.765;
	...
	worldMap.islands.Hispaniola1.Shore100.position.x = 278.905;
	worldMap.islands.Hispaniola1.Shore100.position.z = 588.696;
	worldMap.islands.Hispaniola1.Shore101.position.x = 117.579;
	worldMap.islands.Hispaniola1.Shore101.position.z = 535.305;
	worldMap.islands.Hispaniola1.Shore102.position.x = 223.595;
	worldMap.islands.Hispaniola1.Shore102.position.z = 616.891;
	...
	worldMap.islands.Hispaniola2.Shore96.position.x = -154.483;
	worldMap.islands.Hispaniola2.Shore96.position.z = 618.662;
	worldMap.islands.Hispaniola2.Shore97.position.x = -101.015;
	worldMap.islands.Hispaniola2.Shore97.position.z = 561.493;
	worldMap.islands.Hispaniola2.Shore98.position.x = 72.8103;
	worldMap.islands.Hispaniola2.Shore98.position.z = 490.696;
	worldMap.islands.Hispaniola2.Shore99.position.x = -48.2268;
	worldMap.islands.Hispaniola2.Shore99.position.z = 703.264;
	worldMap.islands.Hispaniola2.LeKe_town.position.x = -71.3135;
	worldMap.islands.Hispaniola2.LeKe_town.position.z = 570.688;
	...
	worldMap.islands.Dominica.Roseau_port.position.x = 806.778;
	worldMap.islands.Dominica.Roseau_port.position.z = -247.06;
	worldMap.islands.Dominica.Shore26.position.x = 810.894;
	worldMap.islands.Dominica.Shore26.position.z = -247.646;
	...
	worldMap.islands.PortoBello.Shore114.position.x = -570.056;
	worldMap.islands.PortoBello.Shore114.position.z = -957.361;
	worldMap.islands.PortoBello.Shore115.position.x = -664.356;
	worldMap.islands.PortoBello.Shore115.position.z = -908.161;
	...
	worldMap.islands.Cartahena.Shore108.position.x = 63.1393;
	worldMap.islands.Cartahena.Shore108.position.z = -764.193;
	worldMap.islands.Cartahena.Shore109.position.x = -7.8008;
	worldMap.islands.Cartahena.Shore109.position.z = -804.915;
	...
	worldMap.islands.SantaCatalina.Shore116.position.x = -737.646;
	worldMap.islands.SantaCatalina.Shore116.position.z = -750.14;

	worldMap.islands.LostShipsCity.position.x = -938.667;
	worldMap.islands.LostShipsCity.position.z = 938.654;
	worldMap.islands.LostShipsCityy.position.x = 616.753;
	worldMap.islands.LostShipsCityy.position.z = 1010.55;

	//worldMap.islands.Nassau.position.x = -295.237;
	//worldMap.islands.Nassau.position.z = -1024.0;
	...
	worldMap.islands.Providence.SanAndres_town.position.x = -512.0;
	worldMap.islands.Providence.SanAndres_town.position.z = -426.6667;
