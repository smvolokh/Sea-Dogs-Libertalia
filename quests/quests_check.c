...
void OnQuestComplete(aref quest, string sQuestname)
{
	if(!CheckAttribute(quest,"over") && CheckAttribute(quest,"win_condition"))
	{
		...
		StartlineQuestComplete(quest.win_condition, sQuestName);
		GothicFQuestComplete(quest.win_condition, sQuestName);
		GothicRQuestComplete(quest.win_condition, sQuestName);
		GothicDQuestComplete(quest.win_condition, sQuestName);
	}
}
