...
*/
	...
	if (CheckAttribute(pchar, "Netotjig_v_taverne_1")) rTown.Ship.crew.quantity = sti(rTown.Ship.crew.quantity)*1.5;	//Пират Либерталии
	if (CheckAttribute(pchar, "Netotjig_v_taverne_2")) rTown.Ship.crew.quantity = sti(rTown.Ship.crew.quantity)*2.0;	//Пират Либерталии
	if (CheckAttribute(pchar, "Netotjig_v_taverne_3")) rTown.Ship.crew.quantity = sti(rTown.Ship.crew.quantity)*2.5;	//Пират Либерталии
	if (CheckAttribute(pchar, "Netotjig_v_taverne_4")) rTown.Ship.crew.quantity = sti(rTown.Ship.crew.quantity)*3.0;	//Пират Либерталии
	if (CheckAttribute(pchar, "Netotjig_v_taverne_5")) rTown.Ship.crew.quantity = sti(rTown.Ship.crew.quantity)*3.5;	//Пират Либерталии
	if (CheckAttribute(pchar, "GenQuest.Shipshine")) rTown.Ship.crew.quantity = sti(rTown.Ship.crew.quantity)*2;	//Jason
			...
			switch (sti(rTown.nation))       // не забыть поменять от патента
			{
				case ENGLAND:
