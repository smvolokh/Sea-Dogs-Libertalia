...
int SetSiegeShip(ref rChar)
{
    ...
    else
    {
		switch (Nation)
		{	
			case PIRATE   :	SiegeShips = RandFromThreeDight(SHIP_CORVETTE, SHIP_HEAVYGALEON, SHIP_FRIGATE); 	break; 
			...
			case SPAIN	  : SiegeShips = RandFromThreeDight(SHIP_POLACRE,  SHIP_HEAVYGALEON, SHIP_FRIGATE_H);  break; 					
