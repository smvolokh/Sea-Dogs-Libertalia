...
bool MerchantPrepare(int Mnation)
{
    ...
    switch (rand(20))
    {
        ...
        break;
	case 12 :
            MerPrm.QuestGoodsIdx = GOOD_TEA;
        break;
	case 13 :
            MerPrm.QuestGoodsIdx = GOOD_SALT;
        break;
	case 14 :
            MerPrm.QuestGoodsIdx = GOOD_CHOCOLATE;
        break;
	case 15 :
            MerPrm.QuestGoodsIdx = GOOD_PAPER;
        break;
	case 16 :
            MerPrm.QuestGoodsIdx = GOOD_HEMP;
        break;
	case 17 :
            MerPrm.QuestGoodsIdx = GOOD_TOOLS;
        break;
	case 18 :
            MerPrm.QuestGoodsIdx = GOOD_TIMBERS;
        break;
	case 18 :
            MerPrm.QuestGoodsIdx = GOOD_EBONY;
        break;
        case 20 :
    ...
    switch (sti(Cap.nation))
    {
        ...
        case PIRATE:
	        switch (irank)
	        {
	            ...
	            case 4: iShip = SHIP_HEAVYGALEON;  	break;
