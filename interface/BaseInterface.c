...
ref GetQuestTextFileName()
{
	...
	questTextFileName[4] = "PROGRAM\QuestBook\QuestBook_Part4.txt"; //отдельный квестбук на макроквесты
	questTextFileName[5] = "PROGRAM\QuestBook\QuestBook_Part5.txt"; //отдельный квестбук на макроквесты
	questTextFileName[6] = "PROGRAM\QuestBook\QuestBook_Part6.txt"; //отдельный квестбук на макроквесты
...
void InitInterfaceTables()
{
	...
	Interfaces[INTERFACE_BALLOON].SectionName = "interface\Balloon.c";
	Interfaces[INTERFACE_BALLOON].IniFile = "RESOURCE\INI\INTERFACES\Balloon.ini";
	...
	Interfaces[INTERFACE_CSMCHARS].SectionName = "interface\CheatSurfMenu\CheatSurfMenu_chars.c";
	Interfaces[INTERFACE_CSMCHARS].IniFile = "RESOURCE\INI\INTERFACES\CheatSurfMenu\CheatSurfMenu_chars.ini";
	
	Interfaces[INTERFACE_CSMGOODS].SectionName = "interface\CheatSurfMenu\CheatSurfMenu_goods.c";
	Interfaces[INTERFACE_CSMGOODS].IniFile = "RESOURCE\INI\INTERFACES\CheatSurfMenu\CheatSurfMenu_goods.ini";
	
	Interfaces[INTERFACE_CSMITEMS].SectionName = "interface\CheatSurfMenu\CheatSurfMenu_items.c";
	Interfaces[INTERFACE_CSMITEMS].IniFile = "RESOURCE\INI\INTERFACES\CheatSurfMenu\CheatSurfMenu_items.ini";
	
	Interfaces[INTERFACE_CSMMISC].SectionName = "interface\CheatSurfMenu\CheatSurfMenu_misc.c";
	Interfaces[INTERFACE_CSMMISC].IniFile = "RESOURCE\INI\INTERFACES\CheatSurfMenu\CheatSurfMenu_misc.ini";
	
	Interfaces[INTERFACE_CSMSHIPS].SectionName = "interface\CheatSurfMenu\CheatSurfMenu_ships.c";
	Interfaces[INTERFACE_CSMSHIPS].IniFile = "RESOURCE\INI\INTERFACES\CheatSurfMenu\CheatSurfMenu_ships.ini";
	
	Interfaces[INTERFACE_CSMSKILLS].SectionName = "interface\CheatSurfMenu\CheatSurfMenu_skills.c";
	Interfaces[INTERFACE_CSMSKILLS].IniFile = "RESOURCE\INI\INTERFACES\CheatSurfMenu\CheatSurfMenu_skills.ini";
	
	Interfaces[INTERFACE_CSMTOWNS].SectionName = "interface\CheatSurfMenu\CheatSurfMenu_towns.c";
	Interfaces[INTERFACE_CSMTOWNS].IniFile = "RESOURCE\INI\INTERFACES\CheatSurfMenu\CheatSurfMenu_towns.ini";
	
	Interfaces[INTERFACE_CSMOFFICERS].SectionName = "interface\CheatSurfMenu\CheatSurfMenu_officers.c";
	Interfaces[INTERFACE_CSMOFFICERS].IniFile = "RESOURCE\INI\INTERFACES\CheatSurfMenu\CheatSurfMenu_officers.ini";
	
	Interfaces[INTERFACE_CSMSHIPSTUNING].SectionName = "interface\CheatSurfMenu\CheatSurfMenu_shipstuning.c";
	Interfaces[INTERFACE_CSMSHIPSTUNING].IniFile = "RESOURCE\INI\INTERFACES\CheatSurfMenu\CheatSurfMenu_shipstuning.ini";
	
	Interfaces[INTERFACE_CSMNAME].SectionName = "interface\CheatSurfMenu\CheatSurfMenu_name.c";
	Interfaces[INTERFACE_CSMNAME].IniFile = "RESOURCE\INI\INTERFACES\CheatSurfMenu\CheatSurfMenu_name.ini";
	// <-- CheatSurfMenu by Cheatsurfer
}