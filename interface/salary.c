...
void SkipSailorPayment()
{
    ...
    {
		if (IsEntity(worldMap) && GetCrewQuantity(mchref) > 0 && !IsCharacterEquippedArtefact(mchref, "totem_02") && !CheckAttribute(pchar, "CSM.NoShipMutinies")) // --> CheatSurfMenu by Cheatsurfer
    	{
