...
#define	INTERFACE_BALLOON			50
// Warship -->
#define INTERFACE_BEST_MAP			51	// Интерфейс отличной карты
#define INTERFACE_TAVERN_WAIT			52	// Интерфейс отдыха
#define INTERFACE_GOODS_TRANSFER		53	// Интерфейс закупки товара казначеем
// <-- Warship
// Ugeen -->
#define INTERFACE_MAPVIEW				54 // Интерфейс атласа карт 
#define INTERFACE_STORAGE				55 // Интерфейс склада
#define INTERFACE_ALCHEMY				56 // Интерфейс мультиобъектов
#define INTERFACE_CONTRATRADE	      57 // Интерфейс торговли с контрабандистами
#define INTERFACE_REPAIR			58 // Интерфейс ремонта

// --> CheatSurfMenu by Cheatsurfer
#define INTERFACE_CSMCHARS              59
#define INTERFACE_CSMGOODS              60
#define INTERFACE_CSMITEMS              61
#define INTERFACE_CSMMISC               62
#define INTERFACE_CSMSHIPS              63
#define INTERFACE_CSMSKILLS             64
#define INTERFACE_CSMTOWNS              65
#define INTERFACE_CSMOFFICERS           66
#define INTERFACE_CSMSHIPSTUNING        67
#define INTERFACE_CSMNAME               68
// <-- CheatSurfMenu by Cheatsurfer
...
// CheatSurfMenu by Cheatsurfer -->
#define RC_INTERFACE_RUN_CSM_CHARS              46051
#define RC_INTERFACE_RUN_CSM_SHIPS              46052
#define RC_INTERFACE_RUN_CSM_TOWNS              46053
#define RC_INTERFACE_RUN_CSM_ITEMS              46054
#define RC_INTERFACE_RUN_CSM_SKILLS             46055
#define RC_INTERFACE_RUN_CSM_GOODS              46056
#define RC_INTERFACE_RUN_CSM_MISC               46057
#define RC_INTERFACE_RUN_CSM_OFFICERS           46058
#define RC_INTERFACE_RUN_CSM_SHIPSTUNING        46059
#define RC_INTERFACE_RUN_CSM_NAME               46060
// CheatSurfMenu by Cheatsurfer <--
