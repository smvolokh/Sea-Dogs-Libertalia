...
#define LOC_FANTOM_CHARACTERS		1999	//32 max
#define FANTOM_CHARACTERS           2997
#define TOTAL_CHARACTERS			4000  // прописать в BOAT_CHARACTER  TOTAL_CHARACTERS - 1
#define BOAT_CHARACTER               3999

#define MAX_LOCATIONS		15916 // boal //15700
#define MAX_ISLANDS   40
#define MAX_COLONIES  48
...
#define NAME_MEXICO "Mexico" // для имён ацтеков
