...
// ====================================================================
	...
	Weathers[n].Lightning.Texture = "resource\textures\weather\lightning\lightning_storm.tga";
	...
	Weathers[n].Lightning.Flash.Texture = "resource\textures\weather\lightning\flash.tga";

	Weathers[n].Sky.Dir = "resource\textures\weather\skies\Storm01\\";
	Weathers[n].Sky.Color = argb(0,64,64,64);
	Weathers[n].Sky.Rotate.Min = 0.0;
	Weathers[n].Sky.Rotate.Max = 0.0;
	Weathers[n].Sky.Size = 1024;
	...
	Weathers[n].Sea2.Harmonics.h1 = " 90.0,  1.5, 8.0,  90.0, 130.0";
	Weathers[n].Sea2.Harmonics.h2 = "  0.0,  3.0, 5.0,  45.0, 160.0";
	Weathers[n].Sea2.Harmonics.h3 = " 45.0,  6.0, 2.5,   0.0, 120.0";
	Weathers[n].Sea2.Harmonics.h4 = "180.0, 24.0, 0.8, 360.0, 240.0";
	Weathers[n].Sea2.Harmonics.h5 = "  0.0, 18.0, 0.6, 240.0, 180.0";
//---------------------------------------------------------------------
	...
	Weathers[n].Sea2.MoveSpeed2 = "0.0, 0.0, 2.0";
...
// ====================================================================
	...
	Weathers[n].Sky.Dir = "resource\textures\weather\skies\Storm02\\";
	Weathers[n].Sky.Color = argb(0,64,64,64);
	Weathers[n].Sky.Rotate.Min = 0.0;
	Weathers[n].Sky.Rotate.Max = 0.0;
	Weathers[n].Sky.Size = 1024;
	...
	Weathers[n].Sea2.Harmonics.h1 = "  0.0,  0.5, 7.0,   0.0, 100.0";
	Weathers[n].Sea2.Harmonics.h2 = " 90.0,  3.0, 4.0,  45.0, 220.0";
	Weathers[n].Sea2.Harmonics.h3 = " 35.0,  6.0, 1.5,   0.0, 260.0";
	Weathers[n].Sea2.Harmonics.h4 = "160.0, 14.0, 0.8, 360.0, 320.0";
	Weathers[n].Sea2.Harmonics.h5 = " 20.0, 18.0, 0.6, 240.0, 260.0";
	Weathers[n].Sea2.Harmonics.h6 = "  0.0, 50.0, 0.2,   0.0, 460.0";
//---------------------------------------------------------------------
	Weathers[n].Sea.Harmonics.h1  =" 0.0,  40.0, 0.8, 80.87, -48.00";
	Weathers[n].Sea.Harmonics.h2  = "0.57, 22.0, 0.4, 82.28,  48.00";
	Weathers[n].Sea.Harmonics.h3  = "1.57, 27.0, 0.9, 82.28,  48.00";
...
// ====================================================================
	...
	Weathers[n].Sky.Dir = "resource\textures\weather\skies\Storm03\\";
	Weathers[n].Sky.Color = argb(0,64,64,64);
	Weathers[n].Sky.Rotate.Min = 0.0;
	Weathers[n].Sky.Rotate.Max = 0.0;
	Weathers[n].Sky.Size = 1024;
	...
	Weathers[n].Sea2.Harmonics.h1 = "  0.0,  0.5, 5.0,  0.0, 20.0";
	Weathers[n].Sea2.Harmonics.h2 = " 45.0,  1.5, 2.0,  0.0, 35.0";
	Weathers[n].Sea2.Harmonics.h3 = " 90.0,  2.0, 3.5,  0.0, 50.0";
	Weathers[n].Sea2.Harmonics.h4 = "135.0, 10.0, 0.4,  0.0, 80.0";
	Weathers[n].Sea2.Harmonics.h5 = "270.0,  8.0, 0.45, 0.0, 40.0";
//---------------------------------------------------------------------
	Weathers[n].Sea.Harmonics.h1  =" 0.0,  40.0, 0.8, 80.87, -48.00";
	Weathers[n].Sea.Harmonics.h2  = "0.57, 22.0, 0.4, 82.28,  48.00";
	Weathers[n].Sea.Harmonics.h3  = "1.57, 27.0, 0.9, 82.28,  48.00";
...
// ====================================================================
	...
	Weathers[n].Sky.Dir = "resource\textures\weather\skies\Storm04\\";
	Weathers[n].Sky.Color = argb(0,64,64,64);
	Weathers[n].Sky.Rotate.Min = 0.0;
	Weathers[n].Sky.Rotate.Max = 0.0;
	Weathers[n].Sky.Size = 1024;
...
//---------------------------------------------------------------------
	...
	Weathers[n].Sea2.MoveSpeed1 = "1.0, 0.0, 0.0";
...
// ====================================================================
// добавочные штормы для локций с низкоуровневым волнением
// ====================================================================
	...
	Weathers[n].Sea.Harmonics.h1 = " 90.0,  1.5, 8.0,  90.0, 130.0";
	Weathers[n].Sea.Harmonics.h2 = "  0.0,  3.0, 5.0,  45.0, 160.0";
	Weathers[n].Sea.Harmonics.h3 = " 45.0,  6.0, 2.5,  10.0, 120.0";
	Weathers[n].Sea.Harmonics.h4 = "180.0, 24.0, 0.8, 360.0, 240.0";
	Weathers[n].Sea.Harmonics.h5 = "  0.0, 18.0, 0.6, 240.0, 180.0";

	Weathers[n].Sea2.Harmonics.h1 = " 90.0,  1.5, 8.0,  90.0, 130.0";
	Weathers[n].Sea2.Harmonics.h2 = "  0.0,  3.0, 5.0,  45.0, 160.0";
	Weathers[n].Sea2.Harmonics.h3 = " 45.0,  6.0, 2.5,  10.0, 120.0";
	Weathers[n].Sea2.Harmonics.h4 = "180.0, 24.0, 0.8, 360.0, 240.0";
	Weathers[n].Sea2.Harmonics.h5 = "  0.0, 18.0, 0.6, 240.0, 180.0";
//---------------------------------------------------------------------
	Weathers[n].Sea.Harmonics.h1  =" 0.0,  40.0, 0.8, 80.87, -48.00";
...
// ====================================================================
	...
	Weathers[n].Sea.Harmonics.h1 = "  0.0,  0.5, 7.0,  20.0, 100.0";
	Weathers[n].Sea.Harmonics.h2 = " 90.0,  3.0, 4.0,  45.0, 220.0";
	Weathers[n].Sea.Harmonics.h3 = " 35.0,  6.0, 1.5,  10.0, 260.0";
	Weathers[n].Sea.Harmonics.h4 = "160.0, 14.0, 0.8, 360.0, 320.0";
	Weathers[n].Sea.Harmonics.h5 = " 20.0, 18.0, 0.6, 240.0, 260.0";
	Weathers[n].Sea.Harmonics.h6 = "  0.0, 50.0, 0.2,   0.0, 460.0";

	Weathers[n].Sea2.Harmonics.h1 = "  0.0,  0.5, 7.0,  20.0, 100.0";
	Weathers[n].Sea2.Harmonics.h2 = " 90.0,  3.0, 4.0,  45.0, 220.0";
	Weathers[n].Sea2.Harmonics.h3 = " 35.0,  6.0, 1.5,  10.0, 260.0";
	Weathers[n].Sea2.Harmonics.h4 = "160.0, 14.0, 0.8, 360.0, 320.0";
	Weathers[n].Sea2.Harmonics.h5 = " 20.0, 18.0, 0.6, 240.0, 260.0";
	Weathers[n].Sea2.Harmonics.h6 = "  0.0, 50.0, 0.2,   0.0, 460.0";
//---------------------------------------------------------------------
...
//---------------------------------------------------------------------
	...
	Weathers[n].Sea2.AnimSpeed2 = 2.0;
	Weathers[n].Sea2.Scale2 = 1.0;
	Weathers[n].Sea2.MoveSpeed2 = "1.0, 0.0, 3.0";
