void InitIslands()
{
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].Trade.Export.id6 = GOOD_PAPER;
		Islands[n].Trade.Export.id7 = GOOD_SOAP;
		Islands[n].Trade.Export.id8 = GOOD_VEGETABLES;
		Islands[n].Trade.Export.id9 = GOOD_TOOLS;
		Islands[n].Trade.Export.id10 = GOOD_PITCH;
		...
		Islands[n].Trade.Import.id6 = GOOD_COPPER;
		Islands[n].Trade.Import.id7 = GOOD_SALT;
		Islands[n].Trade.Import.id8 = GOOD_IVORY;
		Islands[n].Trade.Import.id9 = GOOD_POTTERY;
		Islands[n].Trade.Import.id10 = GOOD_TIMBERS;
		...
		Islands[n].Trade.Contraband.id7 = GOOD_TEA;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].reload.l4.emerge = "reload1_back";
		Islands[n].reload.l4.radius = 300.0;
		...
		Islands[n].reload.l6.label = "Shore35";
		Islands[n].reload.l6.name = "reload_5";
		Islands[n].reload.l6.go = "Shore35";
		Islands[n].reload.l6.emerge = "sea";
		Islands[n].reload.l6.radius = 300.0;
		Islands[n].reload.l6.pic = 1;
		Islands[n].reload.l6.tex = "t1";

		Islands[n].reload.l7.label = "Shore84";
		Islands[n].reload.l7.name = "reload_6";
		Islands[n].reload.l7.go = "Shore84";
		Islands[n].reload.l7.emerge = "sea";
		Islands[n].reload.l7.radius = 300.0;
		Islands[n].reload.l7.pic = 1;
		Islands[n].reload.l7.tex = "t1";

		Islands[n].reload.l8.label = "Shore85";
		Islands[n].reload.l8.name = "reload_7";
		Islands[n].reload.l8.go = "Shore85";
		Islands[n].reload.l8.emerge = "sea";
		Islands[n].reload.l8.radius = 300.0;
		Islands[n].reload.l8.pic = 1;
		Islands[n].reload.l8.tex = "t1";

		Islands[n].reload.l9.label = "Shore86";
		Islands[n].reload.l9.name = "reload_8";
		Islands[n].reload.l9.go = "Shore86";
		Islands[n].reload.l9.emerge = "sea";
		Islands[n].reload.l9.radius = 300.0;
		Islands[n].reload.l9.pic = 1;
		Islands[n].reload.l9.tex = "t1";

		Islands[n].reload.l10.label = "Shore87";
		Islands[n].reload.l10.name = "reload_9";
		Islands[n].reload.l10.go = "Shore87";
		Islands[n].reload.l10.emerge = "sea";
		Islands[n].reload.l10.radius = 300.0;
		Islands[n].reload.l10.pic = 1;
		Islands[n].reload.l10.tex = "t1";

		Islands[n].reload.l11.label = "Shore88";
		Islands[n].reload.l11.name = "reload_10";
		Islands[n].reload.l11.go = "Shore88";
		Islands[n].reload.l11.emerge = "sea";
		Islands[n].reload.l11.radius = 300.0;
		Islands[n].reload.l11.pic = 1;
		Islands[n].reload.l11.tex = "t1";

		Islands[n].reload.l12.label = "Shore90";
		Islands[n].reload.l12.name = "reload_11";
		Islands[n].reload.l12.go = "Shore90";
		Islands[n].reload.l12.emerge = "sea";
		Islands[n].reload.l12.radius = 300.0;
		Islands[n].reload.l12.pic = 1;
		Islands[n].reload.l12.tex = "t1";

		Islands[n].reload.l13.label = "Antonio Port";
		Islands[n].reload.l13.name = "reload_12";
		Islands[n].reload.l13.go = "PortAntonio_town";
		Islands[n].reload.l13.emerge = "reload1_back";
		Islands[n].reload.l13.radius = 300.0;
		Islands[n].reload.l13.pic = 0;
		Islands[n].reload.l13.tex = "t1";
		Islands[n].reload.l13.istown = true;
		...
		Islands[n].Trade.Export.id8 = GOOD_SOAP;
		Islands[n].Trade.Export.id9 = GOOD_IRON;
		Islands[n].Trade.Export.id10 = GOOD_FISH;
		Islands[n].Trade.Export.id11 = GOOD_TOOLS;
		Islands[n].Trade.Export.id12 = GOOD_POTTERY;
		Islands[n].Trade.Export.id13 = GOOD_ALE;
		...
		Islands[n].Trade.Import.id10 = GOOD_PAPER;
		
		Islands[n].Trade.Aggressive.id1 = GOOD_COTTON;
		Islands[n].Trade.Aggressive.id2 = GOOD_LEATHER;
		Islands[n].Trade.Aggressive.id3 = GOOD_TIMBERS;
		Islands[n].Trade.Aggressive.id4 = GOOD_HEMP;
		Islands[n].Trade.Aggressive.id5 = GOOD_VEGETABLES;
		Islands[n].Trade.Aggressive.id6 = GOOD_TEA;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].reload.l4.label = "VillaAlegria Port";
		Islands[n].reload.l4.name = "reload_3";
		Islands[n].reload.l4.go = "VillaAlegria_town";
		Islands[n].reload.l4.emerge = "reload1_back";
		...
		Islands[n].reload.l5.label = "Shore44";
		Islands[n].reload.l5.name = "reload_4";
		Islands[n].reload.l5.go = "Shore44";
		Islands[n].reload.l5.emerge = "sea";
		Islands[n].reload.l5.radius = 600.0;
		Islands[n].reload.l5.pic = 0;
		Islands[n].reload.l5.tex = "t1";

		Islands[n].reload.l6.label = "Shore81";
		Islands[n].reload.l6.name = "reload_5";
		Islands[n].reload.l6.go = "Shore81";
		Islands[n].reload.l6.emerge = "sea";
		Islands[n].reload.l6.radius = 600.0;
		Islands[n].reload.l6.pic = 0;
		Islands[n].reload.l6.tex = "t1";

		Islands[n].reload.l7.label = "Shore82";
		Islands[n].reload.l7.name = "reload_6";
		Islands[n].reload.l7.go = "Shore82";
		Islands[n].reload.l7.emerge = "sea";
		Islands[n].reload.l7.radius = 600.0;
		Islands[n].reload.l7.pic = 0;
		Islands[n].reload.l7.tex = "t1";

		Islands[n].reload.l8.label = "Shore94";
		Islands[n].reload.l8.name = "reload_7";
		Islands[n].reload.l8.go = "Shore94";
		Islands[n].reload.l8.emerge = "sea";
		Islands[n].reload.l8.radius = 600.0;
		Islands[n].reload.l8.pic = 0;
		Islands[n].reload.l8.tex = "t1";

		Islands[n].reload.l9.label = "Shore95";
		Islands[n].reload.l9.name = "reload_8";
		Islands[n].reload.l9.go = "Shore95";
		Islands[n].reload.l9.emerge = "sea";
		Islands[n].reload.l9.radius = 600.0;
		Islands[n].reload.l9.pic = 0;
		Islands[n].reload.l9.tex = "t1";
		...
		Islands[n].Trade.Export.id5 = GOOD_RUM;
		Islands[n].Trade.Export.id6 = GOOD_COPPER;
		Islands[n].Trade.Export.id7 = GOOD_SALT;
		Islands[n].Trade.Export.id8 = GOOD_FISH;
		Islands[n].Trade.Export.id9 = GOOD_VINEGAR;
		Islands[n].Trade.Export.id10 = GOOD_VEGETABLES;
		Islands[n].Trade.Export.id11 = GOOD_TOOLS;
		Islands[n].Trade.Export.id12 = GOOD_POTTERY;
		...
		Islands[n].Trade.Import.id4 = GOOD_WINE;
		Islands[n].Trade.Import.id5 = GOOD_ALE;
		Islands[n].Trade.Import.id6 = GOOD_DYES;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].reload.l7.label = "Shore125";
		Islands[n].reload.l7.name = "reload_6";
		Islands[n].reload.l7.go = "Shore125";
		Islands[n].reload.l7.emerge = "reload1_back";
		Islands[n].reload.l7.radius = 600.0;
		Islands[n].reload.l7.pic = 0;
		Islands[n].reload.l7.tex = "t1";	
		...
		Islands[n].Trade.Export.id9 = GOOD_WINE;
		Islands[n].Trade.Export.id10 = GOOD_RUM;
		Islands[n].Trade.Export.id11 = GOOD_VINEGAR;
		Islands[n].Trade.Export.id12 = GOOD_TIMBERS;
		...
		Islands[n].Trade.Import.id8 = GOOD_TOOLS;
		Islands[n].Trade.Import.id9 = GOOD_PITCH;
		Islands[n].Trade.Import.id10 = GOOD_SILK;
		Islands[n].Trade.Import.id11 = GOOD_IRON;
		Islands[n].Trade.Import.id12 = GOOD_COPPER;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].reload.l7.label = "Shore123";
		Islands[n].reload.l7.name = "reload_6";
		Islands[n].reload.l7.go = "Shore123";
		Islands[n].reload.l7.emerge = "sea";
		Islands[n].reload.l7.radius = 600.0;
		Islands[n].reload.l7.pic = 0;
		Islands[n].reload.l7.tex = "t1";

		Islands[n].reload.l8.label = "Shore124";
		Islands[n].reload.l8.name = "reload_7";
		Islands[n].reload.l8.go = "Shore124";
		Islands[n].reload.l8.emerge = "sea";
		Islands[n].reload.l8.radius = 600.0;
		Islands[n].reload.l8.pic = 0;
		Islands[n].reload.l8.tex = "t1";
		...
		Islands[n].Trade.Aggressive.id3 = GOOD_SALT;
		Islands[n].Trade.Aggressive.id4 = GOOD_FISH;
		Islands[n].Trade.Aggressive.id5 = GOOD_FRUITS;
		Islands[n].Trade.Aggressive.id6 = GOOD_IVORY;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].reload.l3.label = "Vestpunt Port";
		Islands[n].reload.l3.name = "reload_2";
		Islands[n].reload.l3.go = "Vestpunt_Port";
		Islands[n].reload.l3.emerge = "reload1_back";
		Islands[n].reload.l3.radius = 600.0;
		Islands[n].reload.l3.pic = 0;
		Islands[n].reload.l3.tex = "t1";
		...
		Islands[n].reload.l6.label = "Shore23";
		Islands[n].reload.l6.name = "reload_5";
		Islands[n].reload.l6.go = "Shore23";
		Islands[n].reload.l6.emerge = "sea";
		Islands[n].reload.l6.radius = 600.0;
		Islands[n].reload.l6.pic = 0;
		Islands[n].reload.l6.tex = "t1";
		...
		Islands[n].Trade.Export.id4 = GOOD_WEAPON;
		Islands[n].Trade.Export.id5 = GOOD_MEDICAMENT;
		Islands[n].Trade.Export.id6 = GOOD_SAILCLOTH;
		Islands[n].Trade.Export.id7 = GOOD_ALE;
		Islands[n].Trade.Export.id8 = GOOD_SHIPSILK;
		Islands[n].Trade.Export.id9 = GOOD_VINEGAR;
		Islands[n].Trade.Export.id10 = GOOD_PAPER;
		Islands[n].Trade.Export.id11 = GOOD_SOAP;
		Islands[n].Trade.Export.id12 = GOOD_TOOLS;
		Islands[n].Trade.Export.id13 = GOOD_PITCH;
		Islands[n].Trade.Export.id14 = GOOD_IVORY;
		
		Islands[n].Trade.Import.id1 = GOOD_WHEAT;
		Islands[n].Trade.Import.id2 = GOOD_TOBACCO;
		Islands[n].Trade.Import.id3 = GOOD_SUGAR;
		Islands[n].Trade.Import.id4 = GOOD_COTTON;
		Islands[n].Trade.Import.id5 = GOOD_HEMP;
		Islands[n].Trade.Import.id6 = GOOD_VEGETABLES;
		Islands[n].Trade.Import.id7 = GOOD_SALT;
		Islands[n].Trade.Import.id8 = GOOD_TEA;
		...
		Islands[n].Trade.Aggressive.id4 = GOOD_COPRA;
		Islands[n].Trade.Aggressive.id5 = GOOD_PAPRIKA;
		Islands[n].Trade.Aggressive.id6 = GOOD_SILK;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].reload.l5.label = "Shore126";
		Islands[n].reload.l5.name = "reload_4";
		Islands[n].reload.l5.go = "Shore126";
		Islands[n].reload.l5.emerge = "sea";
		Islands[n].reload.l5.radius = 600.0;
		Islands[n].reload.l5.pic = 0;
		Islands[n].reload.l5.tex = "t1";
		...
		Islands[n].Trade.Export.id5 = GOOD_RUM;
		Islands[n].Trade.Export.id6 = GOOD_COPPER;
		Islands[n].Trade.Export.id7 = GOOD_IRON;
		Islands[n].Trade.Export.id8 = GOOD_FISH;
		Islands[n].Trade.Export.id9 = GOOD_HEMP;
		Islands[n].Trade.Export.id10 = GOOD_TOOLS;
		...
		Islands[n].Trade.Import.id4 = GOOD_WINE;
		Islands[n].Trade.Import.id5 = GOOD_ALE;
		Islands[n].Trade.Import.id6 = GOOD_PAPER;
		Islands[n].Trade.Import.id7 = GOOD_VEGETABLES;
		Islands[n].Trade.Import.id8 = GOOD_SILK;
		Islands[n].Trade.Import.id9 = GOOD_DYES;
		...
		Islands[n].reload.l5.label = "Shore103";
		Islands[n].reload.l5.name = "reload_4";
		Islands[n].reload.l5.go = "Shore103";
		Islands[n].reload.l5.emerge = "sea";
		Islands[n].reload.l5.radius = 600.0;
		Islands[n].reload.l5.pic = 0;
		Islands[n].reload.l5.tex = "t1";

		Islands[n].reload.l6.label = "Shore104";
		Islands[n].reload.l6.name = "reload_5";
		Islands[n].reload.l6.go = "Shore104";
		Islands[n].reload.l6.emerge = "sea";
		Islands[n].reload.l6.radius = 600.0;
		Islands[n].reload.l6.pic = 0;
		Islands[n].reload.l6.tex = "t1";

		Islands[n].reload.l7.label = "Shore105";
		Islands[n].reload.l7.name = "reload_6";
		Islands[n].reload.l7.go = "Shore105";
		Islands[n].reload.l7.emerge = "sea";
		Islands[n].reload.l7.radius = 600.0;
		Islands[n].reload.l7.pic = 0;
		Islands[n].reload.l7.tex = "t1";
		...
		Islands[n].Trade.Export.id8 = GOOD_COPPER;
		Islands[n].Trade.Export.id9 = GOOD_SALT;
		Islands[n].Trade.Export.id10 = GOOD_FISH;
		Islands[n].Trade.Export.id11 = GOOD_PAPER;
		Islands[n].Trade.Export.id12 = GOOD_VEGETABLES;
		Islands[n].Trade.Export.id13 = GOOD_DYES;
		Islands[n].Trade.Export.id14 = GOOD_SILK;
		Islands[n].Trade.Export.id14 = GOOD_TIMBERS;
		...
		Islands[n].Trade.Import.id4 = GOOD_WINE;
		Islands[n].Trade.Import.id5 = GOOD_ALE;
		Islands[n].Trade.Import.id6 = GOOD_IRON;
		Islands[n].Trade.Import.id7 = GOOD_POTTERY;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].reload.l6.label = "Shore127";
		Islands[n].reload.l6.name = "reload_5";
		Islands[n].reload.l6.go = "Shore127";
		Islands[n].reload.l6.emerge = "sea";
		Islands[n].reload.l6.radius = 600.0;
		Islands[n].reload.l6.pic = 0;
		Islands[n].reload.l6.tex = "t1";

		Islands[n].reload.l7.label = "Shore128";
		Islands[n].reload.l7.name = "reload_6";
		Islands[n].reload.l7.go = "Shore128";
		Islands[n].reload.l7.emerge = "sea";
		Islands[n].reload.l7.radius = 600.0;
		Islands[n].reload.l7.pic = 0;
		Islands[n].reload.l7.tex = "t1";

		Islands[n].reload.l8.label = "Shore129";
		Islands[n].reload.l8.name = "reload_7";
		Islands[n].reload.l8.go = "Shore129";
		Islands[n].reload.l8.emerge = "sea";
		Islands[n].reload.l8.radius = 600.0;
		Islands[n].reload.l8.pic = 0;
		Islands[n].reload.l8.tex = "t1";

		Islands[n].reload.l9.label = "Shore130";
		Islands[n].reload.l9.name = "reload_8";
		Islands[n].reload.l9.go = "Shore130";
		Islands[n].reload.l9.emerge = "sea";
		Islands[n].reload.l9.radius = 600.0;
		Islands[n].reload.l9.pic = 0;
		Islands[n].reload.l9.tex = "t1";
		...
		Islands[n].Trade.Export.id7 = GOOD_FISH;
		Islands[n].Trade.Export.id8 = GOOD_SOAP;
		Islands[n].Trade.Export.id9 = GOOD_DYES;
		Islands[n].Trade.Export.id10 = GOOD_PITCH;
		Islands[n].Trade.Export.id11 = GOOD_OIL;
		...
		Islands[n].Trade.Import.id6 = GOOD_COPPER;
		Islands[n].Trade.Import.id7 = GOOD_IRON;
		Islands[n].Trade.Import.id8 = GOOD_PAPER;
		Islands[n].Trade.Import.id9 = GOOD_HEMP;
		Islands[n].Trade.Import.id10 = GOOD_TOOLS;
		Islands[n].Trade.Import.id11 = GOOD_POTTERY;
		...
		Islands[n].Trade.Contraband.id6 = GOOD_TEA;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].Trade.Export.id9 = GOOD_SALT;
		Islands[n].Trade.Export.id10 = GOOD_VINEGAR;
		Islands[n].Trade.Export.id11 = GOOD_HEMP;
		Islands[n].Trade.Export.id12 = GOOD_SOAP;
		Islands[n].Trade.Export.id13 = GOOD_TOOLS;
		Islands[n].Trade.Export.id14 = GOOD_POTTERY;
		...
		Islands[n].Trade.Import.id7 = GOOD_TIMBERS;
				
		Islands[n].Trade.Aggressive.id1 = GOOD_EBONY;
		Islands[n].Trade.Aggressive.id2 = GOOD_MAHOGANY;
		Islands[n].Trade.Aggressive.id3 = GOOD_PITCH;
		Islands[n].Trade.Aggressive.id4 = GOOD_IRON;
		Islands[n].Trade.Aggressive.id5 = GOOD_COPPER;
		Islands[n].Trade.Aggressive.id6 = GOOD_DYES;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].reload.l5.label = "Shore91";
		Islands[n].reload.l5.name = "reload_4";
		Islands[n].reload.l5.go = "Shore91";
		Islands[n].reload.l5.emerge = "sea";
		Islands[n].reload.l5.radius = 600.0;
		Islands[n].reload.l5.pic = 0;
		Islands[n].reload.l5.tex = "t1";

		Islands[n].reload.l6.label = "Shore92";
		Islands[n].reload.l6.name = "reload_5";
		Islands[n].reload.l6.go = "Shore92";
		Islands[n].reload.l6.emerge = "sea";
		Islands[n].reload.l6.radius = 600.0;
		Islands[n].reload.l6.pic = 0;
		Islands[n].reload.l6.tex = "t1";

		Islands[n].reload.l7.label = "Shore93";
		Islands[n].reload.l7.name = "reload_6";
		Islands[n].reload.l7.go = "Shore93";
		Islands[n].reload.l7.emerge = "sea";
		Islands[n].reload.l7.radius = 600.0;
		Islands[n].reload.l7.pic = 0;
		Islands[n].reload.l7.tex = "t1";
		...
		Islands[n].Trade.Export.id5 = GOOD_SOAP;
		Islands[n].Trade.Export.id6 = GOOD_POTTERY;
		...
		Islands[n].Trade.Import.id6 = GOOD_COPPER;
		Islands[n].Trade.Import.id7 = GOOD_IRON;
		Islands[n].Trade.Import.id9 = GOOD_VEGETABLES;
		Islands[n].Trade.Import.id10 = GOOD_TOOLS;
		Islands[n].Trade.Import.id11 = GOOD_TIMBERS;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].reload.l5.label = "SantLous Port";
		Islands[n].reload.l5.name = "reload_4";
		Islands[n].reload.l5.go = "SantLous_Port";
		...
		Islands[n].reload.l8.label = "Shore31";
		Islands[n].reload.l8.name = "reload_7";
		Islands[n].reload.l8.go = "Shore31";
		Islands[n].reload.l8.emerge = "sea";
		Islands[n].reload.l8.radius = 600.0;
		Islands[n].reload.l8.pic = 0;
		Islands[n].reload.l8.tex = "t1";

		Islands[n].reload.l9.label = "Shore83";
		Islands[n].reload.l9.name = "reload_8";
		Islands[n].reload.l9.go = "Shore83";
		Islands[n].reload.l9.emerge = "sea";
		Islands[n].reload.l9.radius = 600.0;
		Islands[n].reload.l9.pic = 0;
		Islands[n].reload.l9.tex = "t1";

		Islands[n].reload.l10.label = "Shore80";
		Islands[n].reload.l10.name = "reload_9";
		Islands[n].reload.l10.go = "Shore80";
		Islands[n].reload.l10.emerge = "sea";
		Islands[n].reload.l10.radius = 600.0;
		Islands[n].reload.l10.pic = 0;
		Islands[n].reload.l10.tex = "t1";
		...
		Islands[n].Trade.Export.id7 = GOOD_SUGAR;
		Islands[n].Trade.Export.id8 = GOOD_FOOD;
		Islands[n].Trade.Export.id9 = GOOD_SHIPSILK;
		Islands[n].Trade.Export.id10 = GOOD_CLOTHES;
		Islands[n].Trade.Export.id11 = GOOD_CINNAMON;
		Islands[n].Trade.Export.id12 = GOOD_LEATHER;
		Islands[n].Trade.Export.id13 = GOOD_HEMP;
		Islands[n].Trade.Export.id14 = GOOD_TIMBERS;
		...
		Islands[n].Trade.Import.id8 = GOOD_TOBACCO;
		Islands[n].Trade.Import.id9 = GOOD_VINEGAR;
		Islands[n].Trade.Import.id10 = GOOD_TOOLS;
		Islands[n].Trade.Import.id11 = GOOD_DYES;
		Islands[n].Trade.Import.id12 = GOOD_IVORY;
		Islands[n].Trade.Import.id13 = GOOD_POTTERY;
		Islands[n].Trade.Import.id14 = GOOD_PITCH;
		
		Islands[n].Trade.Contraband.id1 = GOOD_SLAVES;
		Islands[n].Trade.Contraband.id2 = GOOD_SHIPSILK;
		Islands[n].Trade.Contraband.id3 = GOOD_SANDAL;
		Islands[n].Trade.Contraband.id4 = GOOD_OIL;
		Islands[n].Trade.Contraband.id5 = GOOD_TEA;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].reload.l4.emerge = "reload2_back";
		Islands[n].reload.l4.radius = 600.0;
		Islands[n].reload.l4.pic = 0;
		Islands[n].reload.l4.tex = "t1";
		Islands[n].reload.l4.istown = true;
		...
		Islands[n].reload.l6.label = "Shore89";
		Islands[n].reload.l6.name = "reload_5";
		Islands[n].reload.l6.go = "Shore89";
		Islands[n].reload.l6.emerge = "sea";
		Islands[n].reload.l6.radius = 600.0;
		Islands[n].reload.l6.pic = 0;
		Islands[n].reload.l6.tex = "t1";
		...
		Islands[n].Trade.Export.id5 = GOOD_ALE;
		Islands[n].Trade.Export.id6 = GOOD_SALT;
		Islands[n].Trade.Export.id7 = GOOD_SOAP;
		Islands[n].Trade.Export.id8 = GOOD_PITCH;
		Islands[n].Trade.Export.id9 = GOOD_SILK;
		...
		Islands[n].Trade.Import.id5 = GOOD_RUM;
		Islands[n].Trade.Import.id6 = GOOD_COPPER;
		Islands[n].Trade.Import.id7 = GOOD_FISH;
		Islands[n].Trade.Import.id8 = GOOD_PAPER;
		Islands[n].Trade.Import.id9 = GOOD_HEMP;
		Islands[n].Trade.Import.id10 = GOOD_TIMBERS;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].reload.l7.label = "Shore100";
		Islands[n].reload.l7.name = "reload_7";
		Islands[n].reload.l7.go = "Shore100";
		Islands[n].reload.l7.emerge = "sea";
		Islands[n].reload.l7.radius = 600.0;
		Islands[n].reload.l7.pic = 0;
		Islands[n].reload.l7.tex = "t1";  

		Islands[n].reload.l8.label = "Shore101";
		Islands[n].reload.l8.name = "reload_8";
		Islands[n].reload.l8.go = "Shore101";
		Islands[n].reload.l8.emerge = "sea";
		Islands[n].reload.l8.radius = 600.0;
		Islands[n].reload.l8.pic = 0;
		Islands[n].reload.l8.tex = "t1";

		Islands[n].reload.l9.label = "Shore102";
		Islands[n].reload.l9.name = "reload_9";
		Islands[n].reload.l9.go = "Shore102";
		Islands[n].reload.l9.emerge = "sea";
		Islands[n].reload.l9.radius = 600.0;
		Islands[n].reload.l9.pic = 0;
		Islands[n].reload.l9.tex = "t1";        
		...
		Islands[n].Trade.Export.id7 = GOOD_IRON;
		Islands[n].Trade.Export.id8 = GOOD_FISH;
		Islands[n].Trade.Export.id9 = GOOD_PAPER;
		Islands[n].Trade.Export.id10 = GOOD_VEGETABLES;
		Islands[n].Trade.Export.id11 = GOOD_POTTERY;
		Islands[n].Trade.Export.id12 = GOOD_TIMBERS;
		...
		Islands[n].Trade.Import.id5 = GOOD_SALT;
		Islands[n].Trade.Import.id6 = GOOD_VINEGAR;
		Islands[n].Trade.Import.id7 = GOOD_HEMP;
		Islands[n].Trade.Import.id8 = GOOD_TOOLS;
		Islands[n].Trade.Import.id9 = GOOD_DYES;
		Islands[n].Trade.Import.id10 = GOOD_IVORY;
		Islands[n].Trade.Import.id11 = GOOD_SILK;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].reload.l5.label = "Shore99";
		Islands[n].reload.l5.name = "reload_4";
		Islands[n].reload.l5.go = "Shore99";
		Islands[n].reload.l5.emerge = "sea";
		Islands[n].reload.l5.radius = 600.0;
		Islands[n].reload.l5.pic = 0;
		Islands[n].reload.l5.tex = "t1";

		Islands[n].reload.l6.label = "Shore96";
		Islands[n].reload.l6.name = "reload_5";
		Islands[n].reload.l6.go = "Shore96";
		Islands[n].reload.l6.emerge = "sea";
		Islands[n].reload.l6.radius = 600.0;
		Islands[n].reload.l6.pic = 0;
		Islands[n].reload.l6.tex = "t1";

		Islands[n].reload.l7.label = "Shore97";
		Islands[n].reload.l7.name = "reload_6";
		Islands[n].reload.l7.go = "Shore97";
		Islands[n].reload.l7.emerge = "sea";
		Islands[n].reload.l7.radius = 600.0;
		Islands[n].reload.l7.pic = 0;
		Islands[n].reload.l7.tex = "t1";

		Islands[n].reload.l8.label = "Shore98";
		Islands[n].reload.l8.name = "reload_7";
		Islands[n].reload.l8.go = "Shore98";
		Islands[n].reload.l8.emerge = "sea";
		Islands[n].reload.l8.radius = 600.0;
		Islands[n].reload.l8.pic = 0;
		Islands[n].reload.l8.tex = "t1";

		Islands[n].reload.l9.label = "LeKe Port";
		Islands[n].reload.l9.name = "reload_8";
		Islands[n].reload.l9.go = "LeKe_town";
		Islands[n].reload.l9.emerge = "reload2_back";
		Islands[n].reload.l9.radius = 600.0;
		Islands[n].reload.l9.pic = 1;
		Islands[n].reload.l9.tex = "t1";
		Islands[n].reload.l9.istown = true;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].reload.l4.label = "Shore131";
		Islands[n].reload.l4.name = "reload_4";
		Islands[n].reload.l4.go = "Shore131";
		Islands[n].reload.l4.emerge = "sea";
		Islands[n].reload.l4.radius = 600.0;
		Islands[n].reload.l4.pic = 0;
		Islands[n].reload.l4.tex = "t1";
		...
		Islands[n].Trade.Export.id5 = GOOD_COTTON;
		Islands[n].Trade.Export.id6 = GOOD_TOBACCO;
		Islands[n].Trade.Export.id7 = GOOD_FRUITS;
		Islands[n].Trade.Export.id8 = GOOD_FISH;
		Islands[n].Trade.Export.id9 = GOOD_VEGETABLES;
		...
		Islands[n].Trade.Import.id7 = GOOD_BALLS;
		Islands[n].Trade.Import.id8 = GOOD_GRAPES;
		Islands[n].Trade.Import.id9 = GOOD_KNIPPELS;
		Islands[n].Trade.Import.id10 = GOOD_BOMBS;
		Islands[n].Trade.Import.id11 = GOOD_SOAP;
		Islands[n].Trade.Import.id12 = GOOD_TOOLS;
		Islands[n].Trade.Import.id13 = GOOD_DYES;
		Islands[n].Trade.Import.id14 = GOOD_SILK;
		Islands[n].Trade.Import.id16 = GOOD_ROPES;
		Islands[n].Trade.Import.id17 = GOOD_SHIPSILK;
		Islands[n].Trade.Import.id18 = GOOD_SANDAL;
		Islands[n].Trade.Import.id19 = GOOD_OIL;
		Islands[n].Trade.Import.id20 = GOOD_HEMP;
		Islands[n].Trade.Export.id21 = GOOD_PLANKS;
		Islands[n].Trade.Export.id22 = GOOD_SAILCLOTH;
		Islands[n].Trade.Import.id23 = GOOD_TIMBERS;
		Islands[n].Trade.Import.id24 = GOOD_SALT;
		Islands[n].Trade.Import.id25 = GOOD_IVORY;

		Islands[n].Trade.Aggressive.id1 = GOOD_COPPER;
		Islands[n].Trade.Aggressive.id2 = GOOD_IRON;
		Islands[n].Trade.Aggressive.id3 = GOOD_GOLD;
		Islands[n].Trade.Aggressive.id4 = GOOD_SILVER;
		Islands[n].Trade.Aggressive.id5 = GOOD_SLAVES;
		Islands[n].Trade.Aggressive.id6 = GOOD_TEA;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].reload.l2.label = "Roseau port";
		Islands[n].reload.l2.name = "reload_2";
		Islands[n].reload.l2.go = "Roseau_port";
		...
		Islands[n].reload.l3.label = "Shore26";
		Islands[n].reload.l3.name = "reload_3";
		Islands[n].reload.l3.go = "Shore26";
		Islands[n].reload.l3.emerge = "sea";
		Islands[n].reload.l3.radius = 600.0;
		Islands[n].reload.l3.pic = 0;
		Islands[n].reload.l3.tex = "t1";
		...
		Islands[n].Trade.Export.id1 = GOOD_FOOD;
		Islands[n].Trade.Export.id3 = GOOD_MEDICAMENT;
		Islands[n].Trade.Export.id4 = GOOD_WEAPON;
		Islands[n].Trade.Export.id5 = GOOD_BALLS;
		Islands[n].Trade.Export.id6 = GOOD_GRAPES;
		Islands[n].Trade.Export.id7 = GOOD_KNIPPELS;
		Islands[n].Trade.Export.id8 = GOOD_BOMBS;
		Islands[n].Trade.Export.id9 = GOOD_POWDER;
		Islands[n].Trade.Export.id10 = GOOD_TOOLS;
		Islands[n].Trade.Export.id11 = GOOD_RUM;
		Islands[n].Trade.Export.id12 = GOOD_PLANKS;
		Islands[n].Trade.Export.id13 = GOOD_SAILCLOTH;
		
		Islands[n].Trade.Import.id1 = GOOD_WINE;
		Islands[n].Trade.Import.id2 = GOOD_ALE;
		Islands[n].Trade.Import.id3 = GOOD_VINEGAR;
		Islands[n].Trade.Import.id4 = GOOD_DYES;
		Islands[n].Trade.Import.id5 = GOOD_IVORY;
		Islands[n].Trade.Import.id6 = GOOD_SILK;
		Islands[n].Trade.Import.id7 = GOOD_COPPER;
		Islands[n].Trade.Import.id8 = GOOD_IRON;
		Islands[n].Trade.Import.id9 = GOOD_GOLD;
		Islands[n].Trade.Import.id10 = GOOD_SILVER;
		Islands[n].Trade.Import.id11 = GOOD_SLAVES;
		Islands[n].Trade.Import.id12 = GOOD_TEA;
		Islands[n].Trade.Import.id13 = GOOD_SALT;
		Islands[n].Trade.Import.id14 = GOOD_EBONY;
		Islands[n].Trade.Import.id15 = GOOD_MAHOGANY;
		Islands[n].Trade.Import.id16 = GOOD_TOBACCO;
		Islands[n].Trade.Import.id17 = GOOD_FRUITS;
		Islands[n].Trade.Import.id18 = GOOD_COTTON;
		Islands[n].Trade.Import.id19 = GOOD_CLOTHES;

		Islands[n].Trade.Aggressive.id1 = GOOD_ROPES;
		Islands[n].Trade.Aggressive.id2 = GOOD_SHIPSILK;
		Islands[n].Trade.Aggressive.id3 = GOOD_SANDAL;
		Islands[n].Trade.Aggressive.id4 = GOOD_OIL;
		Islands[n].Trade.Aggressive.id5 = GOOD_HEMP;
		Islands[n].Trade.Aggressive.id6 = GOOD_TIMBERS;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].reload.l6.label = "Shore114";
		Islands[n].reload.l6.name = "reload_5";
		Islands[n].reload.l6.go = "Shore114";
		Islands[n].reload.l6.emerge = "sea";
		Islands[n].reload.l6.radius = 600.0;
		Islands[n].reload.l6.pic = 0;
		Islands[n].reload.l6.tex = "t1";

		Islands[n].reload.l7.label = "Shore115";
		Islands[n].reload.l7.name = "reload_6";
		Islands[n].reload.l7.go = "Shore115";
		Islands[n].reload.l7.emerge = "reload1_back";
		Islands[n].reload.l7.radius = 600.0;
		Islands[n].reload.l7.pic = 0;
		Islands[n].reload.l7.tex = "t1";
		...
		Islands[n].Trade.Export.id13 = GOOD_COPPER;
		Islands[n].Trade.Export.id14 = GOOD_VEGETABLES;
		Islands[n].Trade.Export.id15 = GOOD_DYES;
		Islands[n].Trade.Export.id16 = GOOD_IVORY;
		Islands[n].Trade.Export.id17 = GOOD_POTTERY;
		Islands[n].Trade.Export.id18 = GOOD_PITCH;
		Islands[n].Trade.Export.id19 = GOOD_SILK;
		...
		Islands[n].Trade.Import.id7 = GOOD_FISH;
		Islands[n].Trade.Import.id8 = GOOD_PAPER;
		Islands[n].Trade.Import.id9 = GOOD_TOOLS;
		Islands[n].Trade.Import.id10 = GOOD_TIMBERS;
		Islands[n].Trade.Import.id11 = GOOD_EBONY;
		Islands[n].Trade.Import.id12 = GOOD_MAHOGANY;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].reload.l5.label = "Shore109";
		Islands[n].reload.l5.name = "reload_4";
		Islands[n].reload.l5.go = "Shore109";
		Islands[n].reload.l5.emerge = "sea";
		Islands[n].reload.l5.radius = 600.0;
		Islands[n].reload.l5.pic = 0;
		Islands[n].reload.l5.tex = "t1";

		Islands[n].reload.l6.label = "Shore108";
		Islands[n].reload.l6.name = "reload_5";
		Islands[n].reload.l6.go = "Shore108";
		Islands[n].reload.l6.emerge = "sea";
		Islands[n].reload.l6.radius = 600.0;
		Islands[n].reload.l6.pic = 0;
		Islands[n].reload.l6.tex = "t1";
		...
		Islands[n].Trade.Export.id8 = GOOD_RUM;
		Islands[n].Trade.Export.id9 = GOOD_COPPER;
		Islands[n].Trade.Export.id10 = GOOD_PAPER;
		Islands[n].Trade.Export.id11 = GOOD_SOAP;
		Islands[n].Trade.Export.id12 = GOOD_VEGETABLES;
		Islands[n].Trade.Export.id13 = GOOD_POTTERY;
		Islands[n].Trade.Export.id14 = GOOD_PITCH;

		Islands[n].Trade.Import.id1 = GOOD_POWDER;
		Islands[n].Trade.Import.id2 = GOOD_MEDICAMENT;
		Islands[n].Trade.Import.id3 = GOOD_WINE;
		Islands[n].Trade.Import.id4 = GOOD_ALE;
		Islands[n].Trade.Import.id5 = GOOD_IRON;
		Islands[n].Trade.Import.id6 = GOOD_FISH;
		Islands[n].Trade.Import.id7 = GOOD_VINEGAR;
		Islands[n].Trade.Import.id8 = GOOD_TOOLS;
		Islands[n].Trade.Import.id9 = GOOD_TIMBERS;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].reload.l5.label = "Shore106";
		Islands[n].reload.l5.name = "reload_4";
		Islands[n].reload.l5.go = "Shore106";
		Islands[n].reload.l5.emerge = "sea";
		Islands[n].reload.l5.radius = 600.0;
		Islands[n].reload.l5.pic = 0;
		Islands[n].reload.l5.tex = "t1";

		Islands[n].reload.l6.label = "Shore107";
		Islands[n].reload.l6.name = "reload_5";
		Islands[n].reload.l6.go = "Shore107";
		Islands[n].reload.l6.emerge = "sea";
		Islands[n].reload.l6.radius = 600.0;
		Islands[n].reload.l6.pic = 0;
		Islands[n].reload.l6.tex = "t1";
		...
		Islands[n].Trade.Export.id4 = GOOD_SUGAR;
		Islands[n].Trade.Export.id5 = GOOD_ALE;
		Islands[n].Trade.Export.id6 = GOOD_FISH;
		Islands[n].Trade.Export.id7 = GOOD_PAPER;
		Islands[n].Trade.Export.id8 = GOOD_POTTERY;
		Islands[n].Trade.Export.id9 = GOOD_VEGETABLES;
		...
		Islands[n].Trade.Import.id3 = GOOD_WINE;
		Islands[n].Trade.Import.id4 = GOOD_RUM;
		Islands[n].Trade.Import.id5 = GOOD_COPPER;
		Islands[n].Trade.Import.id6 = GOOD_IRON;
		Islands[n].Trade.Import.id7 = GOOD_VINEGAR;
		Islands[n].Trade.Import.id8 = GOOD_HEMP;
		Islands[n].Trade.Import.id9 = GOOD_SOAP;
		Islands[n].Trade.Import.id10 = GOOD_TOOLS;
		Islands[n].Trade.Import.id11 = GOOD_TIMBERS;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].Trade.Export.id6 = GOOD_ALE;
		Islands[n].Trade.Export.id7 = GOOD_FISH;
		Islands[n].Trade.Export.id8 = GOOD_HEMP;
		Islands[n].Trade.Export.id9 = GOOD_TOOLS;
		Islands[n].Trade.Export.id10 = GOOD_DYES;
		Islands[n].Trade.Export.id11 = GOOD_IVORY;
		...
		Islands[n].Trade.Import.id4 = GOOD_RUM;
		Islands[n].Trade.Import.id5 = GOOD_COPPER;
		Islands[n].Trade.Import.id8 = GOOD_VINEGAR;
		Islands[n].Trade.Import.id9 = GOOD_SOAP;
		Islands[n].Trade.Import.id10 = GOOD_POTTERY;
		Islands[n].Trade.Import.id11 = GOOD_TIMBERS;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].Trade.Export.id5 = GOOD_RUM;
		Islands[n].Trade.Export.id6 = GOOD_SALT;
		Islands[n].Trade.Export.id7 = GOOD_HEMP;
		Islands[n].Trade.Export.id8 = GOOD_PITCH;
		...
		Islands[n].Trade.Import.id3 = GOOD_WINE;
		Islands[n].Trade.Import.id4 = GOOD_ALE;
		Islands[n].Trade.Import.id5 = GOOD_TOOLS;
		Islands[n].Trade.Import.id6 = GOOD_POTTERY;
		Islands[n].Trade.Import.id7 = GOOD_TIMBERS;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].reload.l6.label = "Shore116";
		Islands[n].reload.l6.name = "reload_5";
		Islands[n].reload.l6.go = "Shore116";
		Islands[n].reload.l6.emerge = "sea";
		Islands[n].reload.l6.radius = 600.0;
		Islands[n].reload.l6.pic = 0;
		Islands[n].reload.l6.tex = "t1";
		...
		Islands[n].Trade.Export.id7 = GOOD_IRON;
		Islands[n].Trade.Export.id8 = GOOD_DYES;
		Islands[n].Trade.Export.id9 = GOOD_PITCH;
		...
		Islands[n].Trade.Import.id6 = GOOD_COPPER;
		Islands[n].Trade.Import.id7 = GOOD_FISH;
		Islands[n].Trade.Import.id8 = GOOD_SOAP;
		Islands[n].Trade.Import.id9 = GOOD_SILK;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].reload.l9.label = "Shore117";
		Islands[n].reload.l9.name = "reload_8";
		Islands[n].reload.l9.go = "Shore117";
		Islands[n].reload.l9.emerge = "sea";
		Islands[n].reload.l9.radius = 600.0;
		Islands[n].reload.l9.pic = 0;
		Islands[n].reload.l9.tex = "t1";

		Islands[n].reload.l10.label = "Shore118";
		Islands[n].reload.l10.name = "reload_9";
		Islands[n].reload.l10.go = "Shore118";
		Islands[n].reload.l10.emerge = "reload1_back";
		Islands[n].reload.l10.radius = 600.0;
		Islands[n].reload.l10.pic = 0;
		Islands[n].reload.l10.tex = "t1";
		...
		Islands[n].Trade.Export.id8 = GOOD_IRON;
		Islands[n].Trade.Export.id9 = GOOD_COPPER;
		Islands[n].Trade.Export.id10 = GOOD_PITCH;
		...
		Islands[n].Trade.Import.id7 = GOOD_HEMP;
		Islands[n].Trade.Import.id9 = GOOD_SOAP;
		Islands[n].Trade.Import.id10 = GOOD_DYES;
		Islands[n].Trade.Import.id11 = GOOD_TIMBERS;
		Islands[n].Trade.Import.id12 = GOOD_TOOLS;
	...
	/////////////////////////////////////////////////////////////////////////
		n = n + 1;
		Islands[n].id = "Nassau";
		Islands[n].model = "Nassau";
		Islands[n].filespath.models = "islands\Nassau";
		Islands[n].refl_model = "Nassau_refl";
		Islands[n].locators = "Nassau_locators";
		Islands[n].visible = false;
		Islands[n].reload_enable = false;
		Islands[n].hidden = true;
		Islands[n].colonyquantity = 1;
		Islands[n].LoadGroup.g1 = "IslandShips1";
		Islands[n].jungle.patch = "Nassau_jungle";
		Islands[n].jungle.texture = "junglesprites";
		Islands[n].jungle.scale = 12.5;
		Islands[n].TexturePath = "Nassau";

		Islands[n].reload.l1.label = "NewProvidence Port";
		Islands[n].reload.l1.name = "reload_1";
		Islands[n].reload.l1.go = "NewProvidence_town";
		Islands[n].reload.l1.emerge = "reload1";
		Islands[n].reload.l1.radius = 600.0;
		Islands[n].reload.l1.istown = true;
		Islands[n].reload.l1.pic = 0;
		...
		Islands[n].reload.l2.label = "NewProvidence Fort";
		Islands[n].reload.l2.name = "reload_fort1";
		Islands[n].reload.l2.go = "NewProvidence_fort";
		Islands[n].reload.l2.GoAfterBoard.location = "reload_1";
		Islands[n].reload.l2.emerge = "see";
		Islands[n].reload.l2.radius = 600.0;
		Islands[n].reload.l2.fortname = "fort_NewProvidence";
		Islands[n].reload.l2.colonyname = "NewProvidence";
		Islands[n].reload.l2.fort.model = "Nassau_fort1";
		Islands[n].reload.l2.fort.locators = "Nassau_fort1_locators";
		Islands[n].reload.l2.pic = 1;
		Islands[n].reload.l2.tex = "t1";
				
		Islands[n].reload.l3.label = "";
		Islands[n].reload.l3.name = "reload_2";
		Islands[n].reload.l3.go = "";
		Islands[n].reload.l3.emerge = "sea";
		Islands[n].reload.l3.radius = 600.0;
		Islands[n].reload.l3.pic = 0;
		Islands[n].reload.l3.tex = "t1";

		Islands[n].reload.l4.label = "";
		Islands[n].reload.l4.name = "reload_3";
		Islands[n].reload.l4.go = "";
		Islands[n].reload.l4.emerge = "sea";
		Islands[n].reload.l4.radius = 600.0;
		Islands[n].reload.l4.pic = 0;
		Islands[n].reload.l4.tex = "t1";
	...
	/////////////////////////////////////////////////////////////////////////
		...
		n = n + 1;
		Islands[n].id = "LostShipsCityy";
		Islands[n].model = "LostShipsCityy";
		Islands[n].filespath.models = "islands\LostShipsCityy";
		Islands[n].refl_model = "LostShipsCityy_refl";
		Islands[n].locators = "LostShipsCityy_locators";
		Islands[n].visible = false;
		Islands[n].reload_enable = false;
		//Islands[n].LoadGroup.g1 = "IslandShips1";
		Islands[n].TexturePath = "LostShipsCityy";

		Islands[n].reload.l1.label = "LSC North";
		Islands[n].reload.l1.name = "reload_1";
		Islands[n].reload.l1.go = "LostShipsCityy_town";
		Islands[n].reload.l1.emerge = "reload1_back";
		Islands[n].reload.l1.radius = 600.0;
		Islands[n].reload.l1.pic = 0;
		Islands[n].reload.l1.tex = "t1";
		...
		Islands[n].reload.l2.label = "LSC South";
		Islands[n].reload.l2.name = "reload_2";
		Islands[n].reload.l2.go = "LostShipsCityy_town";
		Islands[n].reload.l2.emerge = "reload1_back";
		Islands[n].reload.l2.radius = 600.0;
		Islands[n].reload.l2.pic = 0;
		Islands[n].reload.l2.tex = "t1";
